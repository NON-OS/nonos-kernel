...
use super::collector::collect_boot_entropy_64_with_st;
...
use super::util::is_weak_entropy;

pub fn collect_boot_entropy_64(
    st: &uefi::prelude::SystemTable<uefi::prelude::Boot>,
