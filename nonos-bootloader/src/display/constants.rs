...
pub const COLOR_PROGRESS_BG: u32 = 0xFF1A1A1A;

pub const COLOR_BORDER: u32 = 0xFF2E5C5C;
...
pub const COLOR_TEXT_PRIMARY: u32 = 0xFFE6EDF3;
pub const COLOR_TEXT_WHITE: u32 = 0xFFFFFFFF;
pub const COLOR_TEXT_DIM: u32 = 0xFF6B7280;

pub const COLOR_HASH_BYTE: u32 = 0xFF66FFFF;
pub const COLOR_CRYPTO_CYAN: u32 = 0xFF66FFFF;
pub const COLOR_ZK_PURPLE: u32 = 0xFFCC88FF;

pub const COLOR_LOGO_PRIMARY: u32 = 0xFF66FFFF;
pub const COLOR_LOGO_SECONDARY: u32 = 0xFF2E5C5C;

pub const COLOR_GLASS_BG: u32 = 0xFF0A0A0A;
pub const COLOR_GLASS_BORDER: u32 = 0xFF2E5C5C;
pub const COLOR_ERROR_BG: u32 = 0xFF200000;
