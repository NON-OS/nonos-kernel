...
pub struct DmaAllocator {
    /// Coherent DMA regions indexed by virtual address
    coherent_regions: BTreeMap<VirtAddr, DmaRegion>,
    /// Streaming mappings indexed by mapping ID
...
impl DmaAllocator {
    ...
    /// Allocates a coherent DMA region.
    ...
    /// Creates a streaming DMA mapping.
    ...
    /// Removes a streaming DMA mapping.
    ...
    /// Syncs a streaming mapping for device access.
    ...
    /// Syncs a streaming mapping for CPU access.
    ...
    fn map_dma_page(
        ...
        // Mapping DMA page with proper flags
    ...
    fn translate_to_physical(&self, virt_addr: VirtAddr) -> DmaResult<PhysAddr> {
        // Translating valid virtual address
    ...
    /// Finds a region by physical address.
