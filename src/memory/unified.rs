...
use super::{
    heap, kaslr, layout, paging, phys, safety, virt, virtual_memory,
    hardening::{verify_kernel_data_integrity, verify_kernel_page_tables},
    secure_memory as memory,
...
pub fn init_all_memory_subsystems() -> Result<(), &'static str> {
    ...
    super::frame_alloc::init().map_err(|_| "Frame allocator init failed")?;
    ...
    super::hardening::init_module_memory_protection();
