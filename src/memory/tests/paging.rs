...
pub(crate) fn test_page_permissions_remove() -> TestResult {
    ...
    if removed.contains(PagePermissions::WRITE) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_page_permissions_bitand() -> TestResult {
    ...
    let result = p1 & p2;
    if !result.contains(PagePermissions::READ) { return TestResult::Fail; }
    if result.contains(PagePermissions::WRITE) { return TestResult::Fail; }
    if result.contains(PagePermissions::EXECUTE) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_page_mapping_new() -> TestResult {
    ...
    if mapping.virtual_addr != va { return TestResult::Fail; }
    if mapping.physical_addr != pa { return TestResult::Fail; }
    if mapping.size != PageSize::Size4KiB { return TestResult::Fail; }
    if mapping.reference_count != 1 { return TestResult::Fail; }
    if mapping.process_id.is_some() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_page_mapping_kernel() -> TestResult {
    ...
    if !mapping.is_kernel() { return TestResult::Fail; }
    if mapping.is_user() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_page_mapping_user() -> TestResult {
    ...
    if !mapping.is_user() { return TestResult::Fail; }
    if mapping.is_kernel() { return TestResult::Fail; }
    if mapping.process_id != Some(42) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_page_mapping_is_huge_4k() -> TestResult {
    ...
    if mapping.is_huge() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_page_mapping_is_shared_by_refcount() -> TestResult {
    ...
    if !mapping.is_shared() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_page_mapping_touch() -> TestResult {
    ...
    mapping.touch();
    if mapping.last_accessed < old_time { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_page_fault_info_from_fault() -> TestResult {
    ...
    if !info.is_write { return TestResult::Fail; }
    if !info.is_user { return TestResult::Fail; }
    if !info.page_was_present { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_page_fault_info_is_write() -> TestResult {
    ...
    if read_fault.is_write { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_page_fault_info_is_user() -> TestResult {
    ...
    if kernel_fault.is_user { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_page_fault_info_is_instruction_fetch() -> TestResult {
    ...
    if data_fault.is_instruction_fetch { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_page_fault_info_page_was_present() -> TestResult {
    ...
    if not_present.page_was_present { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_page_fault_info_is_cow_fault() -> TestResult {
    ...
    if not_cow.is_cow_fault() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_page_fault_info_is_demand_fault() -> TestResult {
    ...
    if not_demand.is_demand_fault() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_pte_flags() -> TestResult {
    ...
    if PTE_WRITE_THROUGH != 1 << 3 { return TestResult::Fail; }
    if PTE_CACHE_DISABLE != 1 << 4 { return TestResult::Fail; }
    if PTE_ACCESSED != 1 << 5 { return TestResult::Fail; }
    if PTE_DIRTY != 1 << 6 { return TestResult::Fail; }
    if PTE_HUGE_PAGE != 1 << 7 { return TestResult::Fail; }
    if PTE_GLOBAL != 1 << 8 { return TestResult::Fail; }
    if PTE_NO_EXECUTE != 1u64 << 63 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_index_shifts() -> TestResult {
    ...
    if PT_SHIFT != 12 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_permission_constants() -> TestResult {
    ...
    if PERM_USER != 1 << 3 { return TestResult::Fail; }
    if PERM_GLOBAL != 1 << 4 { return TestResult::Fail; }
    if PERM_NO_CACHE != 1 << 5 { return TestResult::Fail; }
    if PERM_WRITE_THROUGH != 1 << 6 { return TestResult::Fail; }
    if PERM_COW != 1 << 7 { return TestResult::Fail; }
    if PERM_DEMAND != 1 << 8 { return TestResult::Fail; }
    if PERM_ZERO_FILL != 1 << 9 { return TestResult::Fail; }
    if PERM_SHARED != 1 << 10 { return TestResult::Fail; }
    if PERM_LOCKED != 1 << 11 { return TestResult::Fail; }
    if PERM_DEVICE != 1 << 12 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_paging_error_variants() -> TestResult {
    ...
    if PagingError::PageNotMapped != PagingError::PageNotMapped { return TestResult::Fail; }
    if PagingError::Pml4NotPresent != PagingError::Pml4NotPresent { return TestResult::Fail; }
    if PagingError::PdptNotPresent != PagingError::PdptNotPresent { return TestResult::Fail; }
    if PagingError::PdNotPresent != PagingError::PdNotPresent { return TestResult::Fail; }
    if PagingError::PtNotPresent != PagingError::PtNotPresent { return TestResult::Fail; }
    if PagingError::AddressSpaceNotFound != PagingError::AddressSpaceNotFound { return TestResult::Fail; }
    if PagingError::InvalidAddress != PagingError::InvalidAddress { return TestResult::Fail; }
    if PagingError::WXViolation != PagingError::WXViolation { return TestResult::Fail; }
    if PagingError::AlreadyMapped != PagingError::AlreadyMapped { return TestResult::Fail; }
    if PagingError::PermissionDenied != PagingError::PermissionDenied { return TestResult::Fail; }
    if PagingError::UnhandledPageFault != PagingError::UnhandledPageFault { return TestResult::Fail; }
    if PagingError::CowFaultFailed != PagingError::CowFaultFailed { return TestResult::Fail; }
    if PagingError::DemandFaultFailed != PagingError::DemandFaultFailed { return TestResult::Fail; }
    if PagingError::InvalidPageSize != PagingError::InvalidPageSize { return TestResult::Fail; }
    if PagingError::NotAligned != PagingError::NotAligned { return TestResult::Fail; }
    if PagingError::KernelSpaceViolation != PagingError::KernelSpaceViolation { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_page_mapping_clone() -> TestResult {
    ...
    if mapping.virtual_addr != cloned.virtual_addr { return TestResult::Fail; }
    if mapping.physical_addr != cloned.physical_addr { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_page_fault_info_clone() -> TestResult {
    ...
    if info.error_code != cloned.error_code { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_all_permission_flags() -> TestResult {
    ...
    if !PagePermissions::USER.contains(PagePermissions::USER) { return TestResult::Fail; }
    if !PagePermissions::GLOBAL.contains(PagePermissions::GLOBAL) { return TestResult::Fail; }
    if !PagePermissions::NO_CACHE.contains(PagePermissions::NO_CACHE) { return TestResult::Fail; }
    if !PagePermissions::WRITE_THROUGH.contains(PagePermissions::WRITE_THROUGH) { return TestResult::Fail; }
    if !PagePermissions::COW.contains(PagePermissions::COW) { return TestResult::Fail; }
    if !PagePermissions::DEMAND.contains(PagePermissions::DEMAND) { return TestResult::Fail; }
    if !PagePermissions::ZERO_FILL.contains(PagePermissions::ZERO_FILL) { return TestResult::Fail; }
    if !PagePermissions::SHARED.contains(PagePermissions::SHARED) { return TestResult::Fail; }
    if !PagePermissions::LOCKED.contains(PagePermissions::LOCKED) { return TestResult::Fail; }
    if !PagePermissions::DEVICE.contains(PagePermissions::DEVICE) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_combined_pte_flags() -> TestResult {
    ...
    if combined & PTE_USER != PTE_USER { return TestResult::Fail; }
    if combined & PTE_NO_EXECUTE != PTE_NO_EXECUTE { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_index_boundary_values() -> TestResult {
    ...
    if pd_index(max_addr) != 511 { return TestResult::Fail; }
    if pt_index(max_addr) != 511 { return TestResult::Fail; }
    if page_offset(max_addr) != 0xFFF { return TestResult::Fail; }
    TestResult::Pass
}
