...
impl PagingManager {
    pub fn translate_address(&self, virtual_addr: VirtAddr) -> PagingResult<PhysAddr> {
        ...
        unsafe {
            ...
            let l3_table = &*((layout::DIRECTMAP_BASE + l3_pa.as_u64()) as *const [u64; PAGE_TABLE_ENTRIES]);
            ...
            let l2_table = &*((layout::DIRECTMAP_BASE + l2_pa.as_u64()) as *const [u64; PAGE_TABLE_ENTRIES]);
            ...
            let l1_table = &*((layout::DIRECTMAP_BASE + l1_pa.as_u64()) as *const [u64; PAGE_TABLE_ENTRIES]);
