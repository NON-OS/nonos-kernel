...
pub(crate) fn test_line_editor_reset() -> TestResult {
    ...
    if editor.length() != 0 { return TestResult::Fail; }
    if editor.cursor_pos() != 0 { return TestResult::Fail; }
    if editor.row() != 5 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_line_editor_get_content() -> TestResult {
    ...
    if editor.get_content() != b"hi" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_line_editor_length() -> TestResult {
    ...
    if editor.length() != 3 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_line_editor_cursor_col_after_input() -> TestResult {
    ...
    editor.insert_char(b'a');
    editor.insert_char(b'b');
    if editor.cursor_col() != PROMPT_LEN as u32 + 2 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_line_editor_set_content() -> TestResult {
    ...
    if editor.cursor_pos() != 12 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_line_editor_set_content_truncates() -> TestResult {
    ...
    if editor.length() > MAX_INPUT_LEN - 1 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_line_editor_insert_char_multiple() -> TestResult {
    ...
    if editor.get_content() != b"Hello" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_line_editor_insert_char_at_middle() -> TestResult {
    ...
    editor.move_left();
    editor.insert_char(b'B');
    if editor.get_content() != b"ABC" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_line_editor_delete_char() -> TestResult {
    ...
    editor.move_left();
    editor.delete_char();
    if editor.get_content() != b"ac" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_line_editor_delete_char_at_end() -> TestResult {
    ...
    editor.insert_char(b'a');
    editor.delete_char();
    if editor.get_content() != b"a" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_line_editor_move_end() -> TestResult {
    ...
    editor.move_home();
    editor.move_end();
    if editor.cursor_pos() != 2 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_line_editor_move_word_left() -> TestResult {
    ...
    if editor.cursor_pos() >= 13 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_line_editor_delete_word_left_at_start() -> TestResult {
    ...
    editor.move_home();
    editor.delete_word_left();
    if editor.get_content() != b"test" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_line_editor_delete_to_start() -> TestResult {
    ...
    if editor.get_content() != b"world" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_line_editor_insert_at_max_length() -> TestResult {
    ...
    if editor.length() != len_before { return TestResult::Fail; }
    TestResult::Pass
}
