...
pub fn run_all() -> bool {
    ...
    suite.add(TestCase::new("alias_table_get_nonexistent", alias::test_alias_table_get_nonexistent));
    suite.add(TestCase::new("alias_table_set_multiple", alias::test_alias_table_set_multiple));
    suite.add(TestCase::new("alias_table_set_update_existing", alias::test_alias_table_set_update_existing));
    suite.add(TestCase::new("alias_table_unset_existing", alias::test_alias_table_unset_existing));
    suite.add(TestCase::new("alias_table_unset_nonexistent", alias::test_alias_table_unset_nonexistent));
    ...
    suite.add(TestCase::new("alias_table_expand_with_args", alias::test_alias_table_expand_with_args));
    suite.add(TestCase::new("alias_table_expand_nonexistent", alias::test_alias_table_expand_nonexistent));
    ...
    suite.add(TestCase::new("alias_table_secure_erase_clears_all", alias::test_alias_table_secure_erase_clears_all));
    ...
    suite.add(TestCase::new("alias_table_expand_preserves_whitespace", alias::test_alias_table_expand_preserves_whitespace));
    suite.add(TestCase::new("alias_table_get_after_unset_others", alias::test_alias_table_get_after_unset_others));
    ...
    suite.add(TestCase::new("buffer_from_string_single_line", buffer::test_buffer_from_string_single_line));
    suite.add(TestCase::new("buffer_from_string_multiple_lines", buffer::test_buffer_from_string_multiple_lines));
    ...
    suite.add(TestCase::new("buffer_line_mut_marks_modified", buffer::test_buffer_line_mut_marks_modified));
    ...
    suite.add(TestCase::new("buffer_delete_char_out_of_bounds", buffer::test_buffer_delete_char_out_of_bounds));
    ...
    suite.add(TestCase::new("buffer_backspace_start_of_line", buffer::test_buffer_backspace_start_of_line));
    suite.add(TestCase::new("buffer_backspace_start_of_buffer", buffer::test_buffer_backspace_start_of_buffer));
    ...
    suite.add(TestCase::new("buffer_line_len_out_of_bounds", buffer::test_buffer_line_len_out_of_bounds));
    ...
    suite.add(TestCase::new("completer_find_completions_empty", completion::test_completer_find_completions_empty));
    suite.add(TestCase::new("completer_find_completions_single_match", completion::test_completer_find_completions_single_match));
    suite.add(TestCase::new("completer_find_completions_multiple_matches", completion::test_completer_find_completions_multiple_matches));
    suite.add(TestCase::new("completer_find_completions_no_match", completion::test_completer_find_completions_no_match));
    suite.add(TestCase::new("completer_complete_single", completion::test_completer_complete_single));
    suite.add(TestCase::new("completer_complete_cycles", completion::test_completer_complete_cycles));
    suite.add(TestCase::new("completer_complete_no_match", completion::test_completer_complete_no_match));
    suite.add(TestCase::new("completer_reset", completion::test_completer_reset));
    suite.add(TestCase::new("completer_is_showing_after_complete", completion::test_completer_is_showing_after_complete));
    ...
    suite.add(TestCase::new("max_completion_len_constant", completion::test_max_completion_len_constant));
    suite.add(TestCase::new("completer_complete_with_space_prefix", completion::test_completer_complete_with_space_prefix));
    suite.add(TestCase::new("completer_find_completions_case_sensitive", completion::test_completer_find_completions_case_sensitive));
    ...
    suite.add(TestCase::new("completer_reset_clears_showing", completion::test_completer_reset_clears_showing));
    suite.add(TestCase::new("completer_complete_returns_full_command", completion::test_completer_complete_returns_full_command));
    ...
    suite.add(TestCase::new("line_delete_char_out_of_bounds", editor::test_line_delete_char_out_of_bounds));
    ...
    suite.add(TestCase::new("line_first_non_whitespace_no_leading", editor::test_line_first_non_whitespace_no_leading));
    ...
    suite.add(TestCase::new("editor_buffer_from_string_empty", editor::test_buffer_from_string_empty));
    suite.add(TestCase::new("editor_buffer_from_string_single_line", editor::test_buffer_from_string_single_line));
    suite.add(TestCase::new("editor_buffer_from_string_multiple_lines", editor::test_buffer_from_string_multiple_lines));
    ...
    suite.add(TestCase::new("editor_buffer_line_out_of_bounds", editor::test_buffer_line_out_of_bounds));
    suite.add(TestCase::new("editor_buffer_line_mut_marks_modified", editor::test_buffer_line_mut_marks_modified));
    ...
    suite.add(TestCase::new("mode_status_indicator_normal", editor::test_mode_status_indicator_normal));
    suite.add(TestCase::new("mode_status_indicator_insert", editor::test_mode_status_indicator_insert));
    ...
    suite.add(TestCase::new("mode_is_insert_like_replace", editor::test_mode_is_insert_like_replace));
    ...
    suite.add(TestCase::new("mode_state_accumulate_count", editor::test_mode_state_accumulate_count));
    ...
    suite.add(TestCase::new("expand_preserves_special_chars", expand::test_expand_preserves_special_chars));
    suite.add(TestCase::new("expand_braced_var_missing_close", expand::test_expand_braced_var_missing_close));
    suite.add(TestCase::new("expand_multiple_dollar_signs", expand::test_expand_multiple_dollar_signs));
    ...
    suite.add(TestCase::new("expand_preserves_double_quotes", expand::test_expand_preserves_double_quotes));
    ...
    suite.add(TestCase::new("command_history_add_single", history::test_command_history_add_single));
    suite.add(TestCase::new("command_history_add_empty", history::test_command_history_add_empty));
    suite.add(TestCase::new("command_history_add_multiple", history::test_command_history_add_multiple));
    suite.add(TestCase::new("command_history_no_duplicates", history::test_command_history_no_duplicates));
    suite.add(TestCase::new("command_history_duplicates_after_other", history::test_command_history_duplicates_after_other));
    suite.add(TestCase::new("command_history_get_single", history::test_command_history_get_single));
    suite.add(TestCase::new("command_history_get_multiple", history::test_command_history_get_multiple));
    suite.add(TestCase::new("command_history_get_out_of_bounds", history::test_command_history_get_out_of_bounds));
    suite.add(TestCase::new("command_history_get_empty", history::test_command_history_get_empty));
    suite.add(TestCase::new("command_history_start_browse", history::test_command_history_start_browse));
    suite.add(TestCase::new("command_history_browse_prev", history::test_command_history_browse_prev));
    suite.add(TestCase::new("command_history_browse_prev_multiple", history::test_command_history_browse_prev_multiple));
    suite.add(TestCase::new("command_history_browse_prev_at_start", history::test_command_history_browse_prev_at_start));
    suite.add(TestCase::new("command_history_browse_next", history::test_command_history_browse_next));
    suite.add(TestCase::new("command_history_browse_next_to_saved", history::test_command_history_browse_next_to_saved));
    suite.add(TestCase::new("command_history_browse_next_not_browsing", history::test_command_history_browse_next_not_browsing));
    suite.add(TestCase::new("command_history_cancel_browse", history::test_command_history_cancel_browse));
    ...
    suite.add(TestCase::new("command_history_truncates_long", history::test_command_history_truncates_long));
    ...
    suite.add(TestCase::new("command_history_secure_erase", history::test_command_history_secure_erase));
    suite.add(TestCase::new("command_history_browse_empty", history::test_command_history_browse_empty));
    suite.add(TestCase::new("command_history_add_preserves_order", history::test_command_history_add_preserves_order));
    suite.add(TestCase::new("command_history_browsing_resets_on_add", history::test_command_history_browsing_resets_on_add));
    ...
    suite.add(TestCase::new("line_editor_get_content_empty", input::test_line_editor_get_content_empty));
    ...
    suite.add(TestCase::new("line_editor_cursor_col_after_input", input::test_line_editor_cursor_col_after_input));
    suite.add(TestCase::new("line_editor_set_content", input::test_line_editor_set_content));
    suite.add(TestCase::new("line_editor_set_content_truncates", input::test_line_editor_set_content_truncates));
    suite.add(TestCase::new("line_editor_insert_char", input::test_line_editor_insert_char));
    suite.add(TestCase::new("line_editor_insert_char_multiple", input::test_line_editor_insert_char_multiple));
    suite.add(TestCase::new("line_editor_insert_char_at_middle", input::test_line_editor_insert_char_at_middle));
    suite.add(TestCase::new("line_editor_delete_char", input::test_line_editor_delete_char));
    suite.add(TestCase::new("line_editor_delete_char_at_end", input::test_line_editor_delete_char_at_end));
    suite.add(TestCase::new("line_editor_backspace", input::test_line_editor_backspace));
    suite.add(TestCase::new("line_editor_backspace_at_start", input::test_line_editor_backspace_at_start));
    suite.add(TestCase::new("line_editor_move_left", input::test_line_editor_move_left));
    suite.add(TestCase::new("line_editor_move_left_at_start", input::test_line_editor_move_left_at_start));
    suite.add(TestCase::new("line_editor_move_right", input::test_line_editor_move_right));
    suite.add(TestCase::new("line_editor_move_right_at_end", input::test_line_editor_move_right_at_end));
    ...
    suite.add(TestCase::new("line_editor_move_word_left_at_start", input::test_line_editor_move_word_left_at_start));
    suite.add(TestCase::new("line_editor_move_word_right", input::test_line_editor_move_word_right));
    suite.add(TestCase::new("line_editor_delete_word_left", input::test_line_editor_delete_word_left));
    suite.add(TestCase::new("line_editor_delete_word_left_at_start", input::test_line_editor_delete_word_left_at_start));
    suite.add(TestCase::new("line_editor_delete_to_end", input::test_line_editor_delete_to_end));
    suite.add(TestCase::new("line_editor_delete_to_start", input::test_line_editor_delete_to_start));
    suite.add(TestCase::new("line_editor_delete_to_start_at_beginning", input::test_line_editor_delete_to_start_at_beginning));
    ...
    suite.add(TestCase::new("line_editor_insert_at_max_length", input::test_line_editor_insert_at_max_length));
    ...
    suite.add(TestCase::new("pipeline_parse_three_stages", pipeline::test_pipeline_parse_three_stages));
    suite.add(TestCase::new("pipeline_parse_redirect_write", pipeline::test_pipeline_parse_redirect_write));
    suite.add(TestCase::new("pipeline_parse_redirect_append", pipeline::test_pipeline_parse_redirect_append));
    suite.add(TestCase::new("pipeline_parse_redirect_input", pipeline::test_pipeline_parse_redirect_input));
    suite.add(TestCase::new("pipeline_is_simple_true", pipeline::test_pipeline_is_simple_true));
    suite.add(TestCase::new("pipeline_is_simple_false_with_pipe", pipeline::test_pipeline_is_simple_false_with_pipe));
    suite.add(TestCase::new("pipeline_is_simple_false_with_redirect", pipeline::test_pipeline_is_simple_false_with_redirect));
    ...
    suite.add(TestCase::new("pipeline_parse_whitespace_only", pipeline::test_pipeline_parse_whitespace_only));
    suite.add(TestCase::new("pipeline_parse_trims_whitespace", pipeline::test_pipeline_parse_trims_whitespace));
    suite.add(TestCase::new("pipeline_parse_pipe_with_spaces", pipeline::test_pipeline_parse_pipe_with_spaces));
    suite.add(TestCase::new("pipeline_parse_redirect_no_target", pipeline::test_pipeline_parse_redirect_no_target));
    suite.add(TestCase::new("pipeline_parse_multiple_pipes_and_redirect", pipeline::test_pipeline_parse_multiple_pipes_and_redirect));
    suite.add(TestCase::new("pipeline_stage_command_preserved", pipeline::test_pipeline_stage_command_preserved));
    suite.add(TestCase::new("pipeline_redirect_type_copy", pipeline::test_pipeline_redirect_type_copy));
    suite.add(TestCase::new("pipeline_redirect_type_clone", pipeline::test_pipeline_redirect_type_clone));
    suite.add(TestCase::new("pipeline_parse_long_command", pipeline::test_pipeline_parse_long_command));
    ...
    suite.add(TestCase::new("trim_bytes_single_space_char", utils::test_trim_bytes_single_space_char));
    suite.add(TestCase::new("trim_bytes_internal_spaces", utils::test_trim_bytes_internal_spaces));
    suite.add(TestCase::new("trim_bytes_multiple_internal_spaces", utils::test_trim_bytes_multiple_internal_spaces));
    ...
    suite.add(TestCase::new("write_right_aligned_padding", utils::test_write_right_aligned_padding));
