...
pub fn test_alias_table_get_existing() -> TestResult {
    ...
    if value.unwrap() != b"ls -la" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_alias_table_set_update_existing() -> TestResult {
    ...
    table.set(b"ll", b"ls -la");
    if table.count != 1 { return TestResult::Fail; }
    if table.get(b"ll").unwrap() != b"ls -la" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_alias_table_unset_middle() -> TestResult {
    ...
    if table.get(b"a").is_none() { return TestResult::Fail; }
    if table.get(b"b").is_some() { return TestResult::Fail; }
    if table.get(b"c").is_none() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_alias_table_expand_simple() -> TestResult {
    ...
    if &buf[..len] != b"ls -la" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_alias_table_expand_with_args() -> TestResult {
    ...
    if result.is_none() { return TestResult::Fail; }
    let (buf, len) = result.unwrap();
    if &buf[..len] != b"ls -la /home" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_alias_table_init_defaults() -> TestResult {
    ...
    table.init_defaults();
    if table.count <= 0 { return TestResult::Fail; }
    if table.get(b"ll").is_none() { return TestResult::Fail; }
    if table.get(b"cls").is_none() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_alias_table_secure_erase_clears_all() -> TestResult {
    ...
    table.init_defaults();
    table.secure_erase();
    if table.get(b"ll").is_some() { return TestResult::Fail; }
    if table.get(b"cls").is_some() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_alias_table_max_capacity() -> TestResult {
    ...
    if table.count != MAX_ALIASES { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_alias_table_empty_value() -> TestResult {
    ...
    if value.is_none() { return TestResult::Fail; }
    if value.unwrap() != b"" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_alias_table_expand_preserves_whitespace() -> TestResult {
    ...
    if result.is_none() { return TestResult::Fail; }
    let (buf, len) = result.unwrap();
    if &buf[..len] != b"ls -la  /home  /var" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_alias_table_get_after_unset_others() -> TestResult {
    ...
    table.unset(b"a");
    table.unset(b"b");
    if table.get(b"c").unwrap() != b"3" { return TestResult::Fail; }
    TestResult::Pass
}
