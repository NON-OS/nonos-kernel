...
use super::embed::{NET_IP_ELF, NET_IP_MANIFEST_BYTES, NET_IP_NONOS_ID_CERT_BYTES};
use super::state;
...
const SERVICE_NAME: &str = "net.ip";
const SERVICE_PORT: u32 = 4402;
const REPLY_INBOX: &str = "endpoint.net.ip.reply";
const REPLY_PORT: u32 = 4403;
const TARGET_TRIPLE: &str = "x86_64-nonos-user";

pub fn spawn_net_ip_capsule() -> Result<(), SpawnError> {
    ...
    let spec = CapsuleSpecVerified {
        ...
        elf: NET_IP_ELF,
        nonos_id_cert_bytes: NET_IP_NONOS_ID_CERT_BYTES,
