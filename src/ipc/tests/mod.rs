...
pub fn run_all() -> bool {
    ...
    // Transport tests (50)
    suite.add(TestCase::new("frame_magic_constant", transport_tests::test_frame_magic_constant));
    suite
        .add(TestCase::new("frame_version_constant", transport_tests::test_frame_version_constant));
    suite.add(TestCase::new("flag_eof_constant", transport_tests::test_flag_eof_constant));
    suite.add(TestCase::new(
        "frame_header_size_constant",
        transport_tests::test_frame_header_size_constant,
    ));
    suite.add(TestCase::new(
        "frame_header_is_eof_true",
        transport_tests::test_frame_header_is_eof_true,
    ));
    suite.add(TestCase::new(
        "frame_header_is_eof_false",
        transport_tests::test_frame_header_is_eof_false,
    ));
    suite.add(TestCase::new(
        "frame_header_to_bytes_size",
        transport_tests::test_frame_header_to_bytes_size,
    ));
    suite.add(TestCase::new(
        "frame_header_to_bytes_magic",
        transport_tests::test_frame_header_to_bytes_magic,
    ));
    suite.add(TestCase::new(
        "frame_header_to_bytes_version",
        transport_tests::test_frame_header_to_bytes_version,
    ));
    suite.add(TestCase::new(
        "frame_header_to_bytes_stream_id",
        transport_tests::test_frame_header_to_bytes_stream_id,
    ));
    suite.add(TestCase::new(
        "frame_header_to_bytes_seq",
        transport_tests::test_frame_header_to_bytes_seq,
    ));
    suite.add(TestCase::new(
        "frame_header_to_bytes_total",
        transport_tests::test_frame_header_to_bytes_total,
    ));
    suite.add(TestCase::new(
        "frame_header_to_bytes_flags",
        transport_tests::test_frame_header_to_bytes_flags,
    ));
    suite.add(TestCase::new(
        "frame_header_from_bytes_valid",
        transport_tests::test_frame_header_from_bytes_valid,
    ));
    suite.add(TestCase::new(
        "frame_header_from_bytes_invalid_magic",
        transport_tests::test_frame_header_from_bytes_invalid_magic,
    ));
    suite.add(TestCase::new(
        "frame_header_from_bytes_unsupported_version",
        transport_tests::test_frame_header_from_bytes_unsupported_version,
    ));
    suite.add(TestCase::new(
        "frame_header_from_bytes_frame_too_short",
        transport_tests::test_frame_header_from_bytes_frame_too_short,
    ));
    suite.add(TestCase::new(
        "frame_header_from_bytes_sequence_out_of_range",
        transport_tests::test_frame_header_from_bytes_sequence_out_of_range,
    ));
    suite.add(TestCase::new(
        "frame_header_from_bytes_zero_total_allowed",
        transport_tests::test_frame_header_from_bytes_zero_total_allowed,
    ));
    suite
        .add(TestCase::new("frame_header_roundtrip", transport_tests::test_frame_header_roundtrip));
    suite.add(TestCase::new("frame_header_clone", transport_tests::test_frame_header_clone));
    suite.add(TestCase::new("frame_header_copy", transport_tests::test_frame_header_copy));
    suite.add(TestCase::new("frame_header_debug", transport_tests::test_frame_header_debug));
    suite.add(TestCase::new(
        "transport_error_invalid_magic_as_str",
        transport_tests::test_transport_error_invalid_magic_as_str,
    ));
    suite.add(TestCase::new(
        "transport_error_unsupported_version_as_str",
        transport_tests::test_transport_error_unsupported_version_as_str,
    ));
    suite.add(TestCase::new(
        "transport_error_frame_too_short_as_str",
        transport_tests::test_transport_error_frame_too_short_as_str,
    ));
    suite.add(TestCase::new(
        "transport_error_sequence_out_of_range_as_str",
        transport_tests::test_transport_error_sequence_out_of_range_as_str,
    ));
    suite.add(TestCase::new(
        "transport_error_duplicate_frame_as_str",
        transport_tests::test_transport_error_duplicate_frame_as_str,
    ));
    suite.add(TestCase::new(
        "transport_error_stream_not_found_as_str",
        transport_tests::test_transport_error_stream_not_found_as_str,
    ));
    suite.add(TestCase::new(
        "transport_error_mtu_too_small_as_str",
        transport_tests::test_transport_error_mtu_too_small_as_str,
    ));
    suite.add(TestCase::new(
        "transport_error_mtu_too_large_as_str",
        transport_tests::test_transport_error_mtu_too_large_as_str,
    ));
    suite.add(TestCase::new(
        "transport_error_payload_too_large_as_str",
        transport_tests::test_transport_error_payload_too_large_as_str,
    ));
    suite.add(TestCase::new(
        "transport_error_transmit_failed_as_str",
        transport_tests::test_transport_error_transmit_failed_as_str,
    ));
    suite.add(TestCase::new(
        "transport_error_assembly_timeout_as_str",
        transport_tests::test_transport_error_assembly_timeout_as_str,
    ));
    suite.add(TestCase::new(
        "transport_error_too_many_streams_as_str",
        transport_tests::test_transport_error_too_many_streams_as_str,
    ));
    suite.add(TestCase::new(
        "transport_error_display_invalid_magic",
        transport_tests::test_transport_error_display_invalid_magic,
    ));
    suite.add(TestCase::new(
        "transport_error_display_unsupported_version",
        transport_tests::test_transport_error_display_unsupported_version,
    ));
    suite.add(TestCase::new(
        "transport_error_display_frame_too_short",
        transport_tests::test_transport_error_display_frame_too_short,
    ));
    suite.add(TestCase::new(
        "transport_error_display_sequence_out_of_range",
        transport_tests::test_transport_error_display_sequence_out_of_range,
    ));
    suite.add(TestCase::new(
        "transport_error_display_mtu_too_small",
        transport_tests::test_transport_error_display_mtu_too_small,
    ));
    suite.add(TestCase::new(
        "transport_error_display_payload_too_large",
        transport_tests::test_transport_error_display_payload_too_large,
    ));
    suite.add(TestCase::new("transport_error_clone", transport_tests::test_transport_error_clone));
    suite.add(TestCase::new("transport_error_copy", transport_tests::test_transport_error_copy));
    suite.add(TestCase::new(
        "transport_error_equality",
        transport_tests::test_transport_error_equality,
    ));
    suite.add(TestCase::new("parse_frame_valid", transport_tests::test_parse_frame_valid));
    suite.add(TestCase::new(
        "parse_frame_empty_payload",
        transport_tests::test_parse_frame_empty_payload,
    ));
    suite.add(TestCase::new("parse_frame_invalid", transport_tests::test_parse_frame_invalid));
    suite.add(TestCase::new(
        "frame_header_first_frame",
        transport_tests::test_frame_header_first_frame,
    ));
    suite.add(TestCase::new(
        "frame_header_last_frame",
        transport_tests::test_frame_header_last_frame,
    ));
    suite.add(TestCase::new(
        "transport_error_all_variants_have_str",
        transport_tests::test_transport_error_all_variants_have_str,
    ));
