...
pub fn test_pci_device_empty_creation() -> TestResult {
    ...
    if dev.device_id != 0xFFFF { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_pci_device_all_bars_initially_zero() -> TestResult {
    ...
    if dev.bar2 != 0 { return TestResult::Fail; }
    if dev.bar3 != 0 { return TestResult::Fail; }
    if dev.bar4 != 0 { return TestResult::Fail; }
    if dev.bar5 != 0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_pci_device_class_fields() -> TestResult {
    ...
    if dev.prog_if != 0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_pci_device_copy_trait() -> TestResult {
    ...
    if dev1.device_id != dev2.device_id { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_pci_device_class_storage() -> TestResult {
    ...
    dev.class = 0x01;
    dev.subclass = 0x08;
    if dev.class != 0x01 { return TestResult::Fail; }
    if dev.subclass != 0x08 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_pci_device_class_network() -> TestResult {
    ...
    dev.class = 0x02;
    dev.subclass = 0x00;
    if dev.class != 0x02 { return TestResult::Fail; }
    if dev.subclass != 0x00 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_pci_device_class_display() -> TestResult {
    ...
    dev.class = 0x03;
    dev.subclass = 0x00;
    if dev.class != 0x03 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_pci_device_class_serial_bus() -> TestResult {
    ...
    dev.subclass = 0x03;
    dev.prog_if = 0x30;
    if dev.class != 0x0C { return TestResult::Fail; }
    if dev.subclass != 0x03 { return TestResult::Fail; }
    if dev.prog_if != 0x30 { return TestResult::Fail; }
    TestResult::Pass
}
