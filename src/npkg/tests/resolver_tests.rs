...
pub fn test_resolution_result_new() -> TestResult {
    ...
    if !result.to_remove.is_empty() { return TestResult::Fail; }
    if !result.satisfied.is_empty() { return TestResult::Fail; }
    if !result.optional.is_empty() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_resolution_result_total_packages_with_install() -> TestResult {
    ...
    result.to_install.push((pkg, InstallReason::Explicit));
    if result.total_packages() != 1 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_resolution_result_total_packages_combined() -> TestResult {
    ...
    if result.total_packages() != 3 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_resolution_result_clone() -> TestResult {
    ...
    if result.to_install.len() != cloned.to_install.len() { return TestResult::Fail; }
    if result.to_remove.len() != cloned.to_remove.len() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_resolution_result_with_satisfied() -> TestResult {
    ...
    if !result.is_empty() { return TestResult::Fail; }
    if result.satisfied.len() != 1 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_resolution_result_with_optional() -> TestResult {
    ...
    if !result.is_empty() { return TestResult::Fail; }
    if result.optional.len() != 1 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_resolution_result_install_reasons() -> TestResult {
    ...
    if result.to_install[0].1 != InstallReason::Explicit { return TestResult::Fail; }
    if result.to_install[1].1 != InstallReason::Dependency { return TestResult::Fail; }
    if result.to_install[2].1 != InstallReason::Optional { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_resolution_plan_fields() -> TestResult {
    ...
    if plan.download_size != 1024 { return TestResult::Fail; }
    if plan.install_size != 2048 { return TestResult::Fail; }
    if plan.remove_size != 512 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_resolution_plan_empty_result() -> TestResult {
    ...
    if !plan.result.is_empty() { return TestResult::Fail; }
    if plan.download_size != 0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_resolution_plan_with_installs() -> TestResult {
    ...
    if plan.result.total_packages() != 1 { return TestResult::Fail; }
    if plan.download_size != 512 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_resolution_plan_with_removes() -> TestResult {
    ...
    if plan.result.to_remove.len() != 1 { return TestResult::Fail; }
    if plan.remove_size != 4096 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_resolution_plan_clone() -> TestResult {
    ...
    if plan.download_size != cloned.download_size { return TestResult::Fail; }
    if plan.install_size != cloned.install_size { return TestResult::Fail; }
    if plan.remove_size != cloned.remove_size { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_resolution_plan_large_sizes() -> TestResult {
    ...
    if plan.download_size != u64::MAX { return TestResult::Fail; }
    if plan.install_size != u64::MAX { return TestResult::Fail; }
    if plan.remove_size != u64::MAX { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_resolution_plan_net_size_increase() -> TestResult {
    ...
    if net_change != 1500 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_resolution_plan_net_size_decrease() -> TestResult {
    ...
    let net_change = plan.install_size as i64 - plan.remove_size as i64;
    if net_change != -500 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_resolution_result_multiple_satisfied() -> TestResult {
    ...
    if result.satisfied.len() != 3 { return TestResult::Fail; }
    if !result.is_empty() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_resolution_result_complex_scenario() -> TestResult {
    ...
    if result.is_empty() { return TestResult::Fail; }
    if result.total_packages() != 3 { return TestResult::Fail; }
    if result.to_remove.len() != 1 { return TestResult::Fail; }
    if result.satisfied.len() != 1 { return TestResult::Fail; }
    if result.optional.len() != 1 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_resolution_plan_debug() -> TestResult {
    ...
    if !debug_str.contains("ResolutionPlan") { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_resolution_result_upgrade_versions() -> TestResult {
    ...
    if result.to_upgrade[0].1.major != 1 { return TestResult::Fail; }
    if result.to_upgrade[0].0.meta.version.major != 2 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_resolution_plan_access_inner_result() -> TestResult {
    ...
    if plan.result.to_install.len() != 1 { return TestResult::Fail; }
    if plan.result.to_install[0].0.meta.name != "inner" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_resolution_result_empty_strings() -> TestResult {
    ...
    if result.is_empty() { return TestResult::Fail; }
    if result.to_remove[0] != "" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_resolution_plan_zero_download_nonzero_install() -> TestResult {
    ...
    if plan.download_size != 0 { return TestResult::Fail; }
    if plan.install_size != 1000 { return TestResult::Fail; }
    TestResult::Pass
}
