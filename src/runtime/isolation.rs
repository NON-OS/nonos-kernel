...
pub fn create_isolation_context(reqs: &MemoryRequirements) -> Result<Arc<IsolationContext>, &'static str> {
...
fn create_isolated_page_table(_memory: &MemRegion, _stack: &MemRegion) -> Result<u64, &'static str> {
