...
pub(crate) fn test_capsule_id_clone() -> TestResult {
    ...
    let id2 = id1.clone();
    if id1 != id2 { return TestResult::Fail; }
    if id1.get() != id2.get() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_capsule_id_debug() -> TestResult {
    ...
    if !debug_str.contains("789") { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_capsule_id_ord() -> TestResult {
    ...
    if id2.cmp(&id1) != core::cmp::Ordering::Greater { return TestResult::Fail; }
    if id1.cmp(&id1) != core::cmp::Ordering::Equal { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_next_capsule_id_increments() -> TestResult {
    ...
    if !(id1.get() < id2.get()) { return TestResult::Fail; }
    if !(id2.get() < id3.get()) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_capsule_state_all_variants_debug() -> TestResult {
    ...
    if !stopped.contains("Stopped") { return TestResult::Fail; }
    if !running.contains("Running") { return TestResult::Fail; }
    if !degraded.contains("Degraded") { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_capsule_quotas_default() -> TestResult {
    ...
    if quotas.max_bytes_per_sec != 4 << 20 { return TestResult::Fail; }
    if quotas.heartbeat_interval_ms != 2_000 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_capsule_quotas_custom() -> TestResult {
    ...
    if quotas.inbox_capacity != 512 { return TestResult::Fail; }
    if quotas.max_msg_bytes != 4096 { return TestResult::Fail; }
    if quotas.max_bytes_per_sec != 1024 { return TestResult::Fail; }
    if quotas.heartbeat_interval_ms != 5000 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_capsule_quotas_clone() -> TestResult {
    ...
    if quotas1.inbox_capacity != quotas2.inbox_capacity { return TestResult::Fail; }
    if quotas1.max_msg_bytes != quotas2.max_msg_bytes { return TestResult::Fail; }
    if quotas1.max_bytes_per_sec != quotas2.max_bytes_per_sec { return TestResult::Fail; }
    if quotas1.heartbeat_interval_ms != quotas2.heartbeat_interval_ms { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_capsule_quotas_debug() -> TestResult {
    ...
    if !debug_str.contains("inbox_capacity") { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_capsule_quotas_zero_values() -> TestResult {
    ...
    if quotas.inbox_capacity != 0 { return TestResult::Fail; }
    if quotas.max_msg_bytes != 0 { return TestResult::Fail; }
    if quotas.max_bytes_per_sec != 0 { return TestResult::Fail; }
    if quotas.heartbeat_interval_ms != 0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_capsule_quotas_max_values() -> TestResult {
    ...
    if quotas.inbox_capacity != usize::MAX { return TestResult::Fail; }
    if quotas.max_msg_bytes != usize::MAX { return TestResult::Fail; }
    if quotas.max_bytes_per_sec != u64::MAX { return TestResult::Fail; }
    if quotas.heartbeat_interval_ms != u64::MAX { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_capsule_id_min_max_ordering() -> TestResult {
    ...
    if !(max > min) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_capsule_id_from_sequential() -> TestResult {
    ...
    let id2 = CapsuleId(2);
    let id3 = CapsuleId(3);
    if id2.get() - id1.get() != 1 { return TestResult::Fail; }
    if id3.get() - id2.get() != 1 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_capsule_quotas_multiple_defaults() -> TestResult {
    ...
    if q1.max_msg_bytes != q2.max_msg_bytes { return TestResult::Fail; }
    if q1.max_bytes_per_sec != q2.max_bytes_per_sec { return TestResult::Fail; }
    if q1.heartbeat_interval_ms != q2.heartbeat_interval_ms { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_capsule_quotas_clone_independence() -> TestResult {
    ...
    if original.inbox_capacity != 100 { return TestResult::Fail; }
    if cloned.inbox_capacity != 999 { return TestResult::Fail; }
    TestResult::Pass
}
