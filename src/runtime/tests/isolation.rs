...
pub fn test_isolation_policy_clone() -> TestResult {
    ...
    if policy.max_msg_bytes != cloned.max_msg_bytes { return TestResult::Fail; }
    if policy.max_bytes_per_sec != cloned.max_bytes_per_sec { return TestResult::Fail; }
    if policy.heartbeat_interval_ms != cloned.heartbeat_interval_ms { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_isolation_policy_custom_inbox_capacity() -> TestResult {
    ...
    if policy.inbox_capacity != 2048 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_isolation_policy_custom_max_msg_bytes() -> TestResult {
    ...
    if policy.max_msg_bytes != 524288 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_isolation_policy_custom_max_bytes_per_sec() -> TestResult {
    ...
    if policy.max_bytes_per_sec != 8388608 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_isolation_policy_custom_heartbeat_interval_ms() -> TestResult {
    ...
    if policy.heartbeat_interval_ms != 5_000 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_isolation_policy_all_custom() -> TestResult {
    ...
    if policy.inbox_capacity != 512 { return TestResult::Fail; }
    if policy.max_msg_bytes != 262144 { return TestResult::Fail; }
    if policy.max_bytes_per_sec != 1048576 { return TestResult::Fail; }
    if policy.heartbeat_interval_ms != 1_000 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_isolation_state_status_format() -> TestResult {
    ...
    if !status.contains("iso[capsule=my_capsule") { return TestResult::Fail; }
    if !status.contains("used=") { return TestResult::Fail; }
    if !status.contains("limit=") { return TestResult::Fail; }
    if !status.contains("dropped=") { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_isolation_state_charge_message_over_limit() -> TestResult {
    ...
    if result.unwrap_err() != "isolation: message too large" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_isolation_state_dropped_increments_on_large_message() -> TestResult {
    ...
    if state.dropped() != 1 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_isolation_state_set_enforced() -> TestResult {
    ...
    let status = state.status();
    if !status.contains("test") { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_isolation_state_multiple_charge_messages() -> TestResult {
    ...
    let state = isolation::IsolationState::new("test", policy);
    if !state.charge_message(100).is_ok() { return TestResult::Fail; }
    if !state.charge_message(100).is_ok() { return TestResult::Fail; }
    if !state.charge_message(100).is_ok() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_isolation_policy_megabyte_limits() -> TestResult {
    ...
    if policy.max_msg_bytes != 1048576 { return TestResult::Fail; }
    if policy.max_bytes_per_sec != 4194304 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_isolation_state_status_contains_capsule_name() -> TestResult {
    ...
    let status = state.status();
    if !status.contains("unique_capsule_name") { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_isolation_state_status_contains_limit() -> TestResult {
    ...
    let state = isolation::IsolationState::new("test", policy);
    let status = state.status();
    if !status.contains("12345678") { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_isolation_policy_zero_inbox_capacity() -> TestResult {
    ...
    if policy.inbox_capacity != 0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_isolation_policy_large_heartbeat_interval() -> TestResult {
    ...
    if policy.heartbeat_interval_ms != 60_000 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_isolation_state_multiple_dropped() -> TestResult {
    ...
    let _ = state.charge_message(100);
    let _ = state.charge_message(100);
    if state.dropped() != 3 { return TestResult::Fail; }
    TestResult::Pass
}
