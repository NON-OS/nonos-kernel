...
pub fn test_zerostate_register_capsule_with_peers() -> TestResult {
    ...
    if p.len() != 2 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_zerostate_register_capsule_with_custom_quotas() -> TestResult {
    ...
    if cap.quotas.inbox_capacity != 2048 { return TestResult::Fail; }
    if cap.quotas.max_msg_bytes != 524288 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_zerostate_get_capsule_by_name() -> TestResult {
    ...
    if found.unwrap().name != "get_by_name_test" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_zerostate_register_multiple_capsules() -> TestResult {
    ...
    if cap1.id == cap2.id { return TestResult::Fail; }
    if cap2.id == cap3.id { return TestResult::Fail; }
    if cap1.id == cap3.id { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_zerostate_capsule_ids_increasing() -> TestResult {
    ...
    if !(cap2.id.get() > cap1.id.get()) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_zerostate_register_with_empty_peers() -> TestResult {
    ...
    if !peers.is_empty() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_zerostate_register_with_many_peers() -> TestResult {
    ...
    let p = cap.peers.read();
    if p.len() != 5 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_zerostate_capsule_name_preserved() -> TestResult {
    ...
    if !found.is_some() { return TestResult::Fail; }
    if found.unwrap().name != "preserved_name" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_zerostate_quotas_applied() -> TestResult {
    ...
    if cap.quotas.inbox_capacity != 100 { return TestResult::Fail; }
    if cap.quotas.max_msg_bytes != 200 { return TestResult::Fail; }
    if cap.quotas.max_bytes_per_sec != 300 { return TestResult::Fail; }
    if cap.quotas.heartbeat_interval_ms != 400 { return TestResult::Fail; }
    TestResult::Pass
}
