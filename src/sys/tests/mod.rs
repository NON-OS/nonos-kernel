...
pub fn run_all() -> bool {
    ...
    // process_tests (66 tests)
    suite.add(TestCase::new("process::max_tasks_value", process_tests::test_max_tasks_value));
    suite.add(TestCase::new(
        "process::task_stack_size_value",
        process_tests::test_task_stack_size_value,
    ));
    suite.add(TestCase::new(
        "process::task_stack_size_alignment",
        process_tests::test_task_stack_size_alignment,
    ));
    suite.add(TestCase::new(
        "process::task_state_empty_value",
        process_tests::test_task_state_empty_value,
    ));
    suite.add(TestCase::new(
        "process::task_state_ready_value",
        process_tests::test_task_state_ready_value,
    ));
    suite.add(TestCase::new(
        "process::task_state_running_value",
        process_tests::test_task_state_running_value,
    ));
    suite.add(TestCase::new(
        "process::task_state_blocked_value",
        process_tests::test_task_state_blocked_value,
    ));
    suite.add(TestCase::new(
        "process::task_state_sleeping_value",
        process_tests::test_task_state_sleeping_value,
    ));
    suite.add(TestCase::new(
        "process::task_state_terminated_value",
        process_tests::test_task_state_terminated_value,
    ));
    suite.add(TestCase::new(
        "process::task_state_equality",
        process_tests::test_task_state_equality,
    ));
    suite.add(TestCase::new("process::task_state_clone", process_tests::test_task_state_clone));
    suite.add(TestCase::new("process::task_state_copy", process_tests::test_task_state_copy));
    suite.add(TestCase::new("process::cpu_context_empty", process_tests::test_cpu_context_empty));
    suite.add(TestCase::new(
        "process::cpu_context_rflags_default",
        process_tests::test_cpu_context_rflags_default,
    ));
    suite.add(TestCase::new("process::cpu_context_size", process_tests::test_cpu_context_size));
    suite.add(TestCase::new(
        "process::cpu_context_is_copy",
        process_tests::test_cpu_context_is_copy,
    ));
    suite.add(TestCase::new(
        "process::cpu_context_is_clone",
        process_tests::test_cpu_context_is_clone,
    ));
    suite.add(TestCase::new("process::task_empty", process_tests::test_task_empty));
    suite.add(TestCase::new("process::task_set_name", process_tests::test_task_set_name));
    suite.add(TestCase::new(
        "process::task_set_name_truncates",
        process_tests::test_task_set_name_truncates,
    ));
    suite.add(TestCase::new("process::task_get_name", process_tests::test_task_get_name));
    suite.add(TestCase::new(
        "process::task_get_name_empty",
        process_tests::test_task_get_name_empty,
    ));
    suite.add(TestCase::new("process::task_is_copy", process_tests::test_task_is_copy));
    suite.add(TestCase::new("process::task_is_clone", process_tests::test_task_is_clone));
    suite.add(TestCase::new("process::state_str_empty", process_tests::test_state_str_empty));
    suite.add(TestCase::new("process::state_str_ready", process_tests::test_state_str_ready));
    suite.add(TestCase::new("process::state_str_running", process_tests::test_state_str_running));
    suite.add(TestCase::new("process::state_str_blocked", process_tests::test_state_str_blocked));
    suite.add(TestCase::new("process::state_str_sleeping", process_tests::test_state_str_sleeping));
    suite.add(TestCase::new(
        "process::state_str_terminated",
        process_tests::test_state_str_terminated,
    ));
    suite.add(TestCase::new(
        "process::scheduler_policy_round_robin",
        process_tests::test_scheduler_policy_round_robin,
    ));
    suite.add(TestCase::new(
        "process::scheduler_policy_priority",
        process_tests::test_scheduler_policy_priority,
    ));
    suite.add(TestCase::new(
        "process::scheduler_policy_fair",
        process_tests::test_scheduler_policy_fair,
    ));
    suite.add(TestCase::new(
        "process::scheduler_policy_from_u8_round_robin",
        process_tests::test_scheduler_policy_from_u8_round_robin,
    ));
    suite.add(TestCase::new(
        "process::scheduler_policy_from_u8_priority",
        process_tests::test_scheduler_policy_from_u8_priority,
    ));
    suite.add(TestCase::new(
        "process::scheduler_policy_from_u8_fair",
        process_tests::test_scheduler_policy_from_u8_fair,
    ));
    suite.add(TestCase::new(
        "process::scheduler_policy_from_u8_invalid",
        process_tests::test_scheduler_policy_from_u8_invalid,
    ));
    suite.add(TestCase::new(
        "process::scheduler_policy_equality",
        process_tests::test_scheduler_policy_equality,
    ));
    suite.add(TestCase::new(
        "process::scheduler_policy_clone",
        process_tests::test_scheduler_policy_clone,
    ));
    suite.add(TestCase::new(
        "process::scheduler_policy_copy",
        process_tests::test_scheduler_policy_copy,
    ));
    suite.add(TestCase::new("process::task_stats_struct", process_tests::test_task_stats_struct));
    suite.add(TestCase::new("process::task_stats_copy", process_tests::test_task_stats_copy));
    suite.add(TestCase::new("process::task_stats_clone", process_tests::test_task_stats_clone));
    suite.add(TestCase::new(
        "process::scheduler_stats_struct",
        process_tests::test_scheduler_stats_struct,
    ));
    suite.add(TestCase::new(
        "process::scheduler_stats_copy",
        process_tests::test_scheduler_stats_copy,
    ));
    suite.add(TestCase::new(
        "process::scheduler_stats_clone",
        process_tests::test_scheduler_stats_clone,
    ));
    suite.add(TestCase::new(
        "process::is_init_returns_bool",
        process_tests::test_is_init_returns_bool,
    ));
    suite.add(TestCase::new(
        "process::current_id_returns_u32",
        process_tests::test_current_id_returns_u32,
    ));
    suite.add(TestCase::new(
        "process::task_count_returns_u32",
        process_tests::test_task_count_returns_u32,
    ));
    suite.add(TestCase::new(
        "process::context_switch_count_returns_u64",
        process_tests::test_context_switch_count_returns_u64,
    ));
    suite.add(TestCase::new(
        "process::get_policy_returns_policy",
        process_tests::test_get_policy_returns_policy,
    ));
    suite.add(TestCase::new(
        "process::set_policy_round_robin",
        process_tests::test_set_policy_round_robin,
    ));
    suite.add(TestCase::new(
        "process::set_policy_priority",
        process_tests::test_set_policy_priority,
    ));
    suite.add(TestCase::new("process::set_policy_fair", process_tests::test_set_policy_fair));
    suite.add(TestCase::new(
        "process::get_time_quantum_us",
        process_tests::test_get_time_quantum_us,
    ));
    suite.add(TestCase::new(
        "process::set_time_quantum_us",
        process_tests::test_set_time_quantum_us,
    ));
    suite.add(TestCase::new(
        "process::get_scheduler_stats_returns_struct",
        process_tests::test_get_scheduler_stats_returns_struct,
    ));
    suite.add(TestCase::new(
        "process::get_task_info_kernel_main",
        process_tests::test_get_task_info_kernel_main,
    ));
    suite.add(TestCase::new(
        "process::get_task_info_invalid_id",
        process_tests::test_get_task_info_invalid_id,
    ));
    suite.add(TestCase::new(
        "process::get_task_stats_kernel_main",
        process_tests::test_get_task_stats_kernel_main,
    ));
    suite.add(TestCase::new(
        "process::get_task_stats_invalid_id",
        process_tests::test_get_task_stats_invalid_id,
    ));
    suite.add(TestCase::new(
        "process::get_task_priority_kernel_main",
        process_tests::test_get_task_priority_kernel_main,
    ));
    suite.add(TestCase::new(
        "process::get_task_priority_invalid_id",
        process_tests::test_get_task_priority_invalid_id,
    ));
    suite.add(TestCase::new(
        "process::for_each_task_callback",
        process_tests::test_for_each_task_callback,
    ));
    suite.add(TestCase::new(
        "process::for_each_task_sees_kernel_main",
        process_tests::test_for_each_task_sees_kernel_main,
    ));
    suite.add(TestCase::new(
        "process::get_task_info_extended_kernel_main",
        process_tests::test_get_task_info_extended_kernel_main,
    ));
    suite.add(TestCase::new(
        "process::get_task_info_extended_invalid_id",
        process_tests::test_get_task_info_extended_invalid_id,
    ));
    suite.add(TestCase::new(
        "process::task_default_priority",
        process_tests::test_task_default_priority,
    ));
    suite.add(TestCase::new(
        "process::cpu_context_const_empty",
        process_tests::test_cpu_context_const_empty,
    ));
    suite.add(TestCase::new("process::task_const_empty", process_tests::test_task_const_empty));
    suite.add(TestCase::new(
        "process::all_task_states_unique",
        process_tests::test_all_task_states_unique,
    ));
    suite.add(TestCase::new(
        "process::all_scheduler_policies_unique",
        process_tests::test_all_scheduler_policies_unique,
    ));
