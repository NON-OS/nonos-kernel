...
//! Shared liveness state for the marketplace capsule. Same shape
//! as the other userland service capsules so the supervisor and
//! the boot harness probe it through the standard `CapsuleState`
//! surface.
