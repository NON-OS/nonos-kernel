...
pub fn test_cpu_vulnerabilities_default() -> TestResult {
...
pub fn test_cpu_vulnerabilities_all_fields() -> TestResult {
...
pub fn test_cpu_vulnerabilities_copy() -> TestResult {
...
pub fn test_cpu_vulnerabilities_clone() -> TestResult {
    let vulns1 = CpuVulnerabilities::default();
...
pub fn test_mitigation_status_default() -> TestResult {
...
pub fn test_mitigation_status_all_enabled() -> TestResult {
...
pub fn test_mitigation_status_copy() -> TestResult {
...
pub fn test_mitigation_status_clone() -> TestResult {
    let status1 = MitigationStatus::default();
...
pub fn test_mitigation_status_partial_enabled() -> TestResult {
    let status = MitigationStatus {
        kpti_enabled: true,
        retpoline_enabled: true,
        ibrs_enabled: false,
...
pub fn test_lfence_barrier() -> TestResult {
    lfence();
    TestResult::Pass
}

pub fn test_mfence_barrier() -> TestResult {
    mfence();
    TestResult::Pass
}

pub fn test_sfence_barrier() -> TestResult {
    sfence();
    TestResult::Pass
}

pub fn test_array_index_mask_nospec() -> TestResult {
    let mask = array_index_mask_nospec(5, 10);
    if mask != !0usize { return TestResult::Fail; }
    TestResult::Pass
}

pub fn test_array_index_mask_nospec_out_of_bounds() -> TestResult {
    let mask = array_index_mask_nospec(15, 10);
    if mask != 0 { return TestResult::Fail; }
    TestResult::Pass
}

pub fn test_array_index_mask_nospec_boundary() -> TestResult {
    let mask = array_index_mask_nospec(10, 10);
    if mask != 0 { return TestResult::Fail; }
    TestResult::Pass
}

pub fn test_array_access_nospec() -> TestResult {
...
pub fn test_array_access_nospec_first_element() -> TestResult {
...
pub fn test_array_access_nospec_last_element() -> TestResult {
    let array = [1, 2, 3, 4, 5];
...
pub fn test_rsb_fill() -> TestResult {
    rsb_fill();
    TestResult::Pass
}

pub fn test_rsb_clear() -> TestResult {
    rsb_clear();
    TestResult::Pass
}

pub fn test_l1d_flush() -> TestResult {
    l1d_flush();
    TestResult::Pass
}

pub fn test_mds_clear() -> TestResult {
    mds_clear();
    TestResult::Pass
}

pub fn test_kernel_entry_mitigations() -> TestResult {
    kernel_entry_mitigations();
    TestResult::Pass
}

pub fn test_kernel_exit_mitigations() -> TestResult {
    kernel_exit_mitigations();
    TestResult::Pass
}

pub fn test_context_switch_mitigations() -> TestResult {
    context_switch_mitigations();
    TestResult::Pass
}

pub fn test_get_vulnerabilities() -> TestResult {
    let vulns = get_vulnerabilities();
    let _ = vulns.spectre_v1;
    TestResult::Pass
}

pub fn test_get_mitigation_status() -> TestResult {
    let status = get_mitigation_status();
    let _ = status.kpti_enabled;
    TestResult::Pass
}

pub fn test_are_mitigations_enabled() -> TestResult {
    let enabled = are_mitigations_enabled();
    let _ = enabled;
    TestResult::Pass
}

pub fn test_cpu_vulnerabilities_debug_format() -> TestResult {
    let vulns = CpuVulnerabilities::default();
...
pub fn test_mitigation_status_debug_format() -> TestResult {
    let status = MitigationStatus::default();
...
pub fn test_vulnerability_fields_are_bools() -> TestResult {
    let vulns = CpuVulnerabilities::default();
...
pub fn test_mitigation_fields_are_bools() -> TestResult {
    let status = MitigationStatus::default();
