...
use super::super::protocol::{encode_request, MAX_INPUT_BYTES, OP_SHA256_HASH};
use super::seq::next_request_id;
use super::transport::round_trip;

// SHA-256 hash via the userland crypto capsule. Cap-gated by
// `CAP_CRYPTO`. Returns the 32-byte digest. Bounded by
...
pub fn hash_sha256(input: &[u8]) -> Result<[u8; 32], CryptoCapsuleError> {
    ...
    let frame = encode_request(OP_SHA256_HASH, 0, request_id, input);
