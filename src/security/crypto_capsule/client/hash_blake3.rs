...
use super::super::protocol::{encode_request, MAX_INPUT_BYTES, OP_BLAKE3_HASH};
use super::seq::next_request_id;
use super::transport::round_trip;

// BLAKE3 hash via the userland crypto capsule. Cap-gated by
...
pub fn hash_blake3(input: &[u8]) -> Result<[u8; 32], CryptoCapsuleError> {
    ...
    let frame = encode_request(OP_BLAKE3_HASH, 0, request_id, input);
