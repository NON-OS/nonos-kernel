...
pub fn run_all() -> bool {
    ...
    suite.add(TestCase::new("hid_descriptor_parse_valid", descriptor::test_hid_descriptor_parse_valid));
    suite.add(TestCase::new("hid_descriptor_parse_too_short", descriptor::test_hid_descriptor_parse_too_short));
    suite.add(TestCase::new("hid_descriptor_parse_invalid_length", descriptor::test_hid_descriptor_parse_invalid_length));
    suite.add(TestCase::new("hid_descriptor_parse_invalid_version", descriptor::test_hid_descriptor_parse_invalid_version));
    ...
    suite.add(TestCase::new("field_location_extract_single_bit", descriptor::test_field_location_extract_single_bit));
    suite.add(TestCase::new("field_location_extract_single_bit_offset", descriptor::test_field_location_extract_single_bit_offset));
    suite.add(TestCase::new("field_location_extract_byte_aligned", descriptor::test_field_location_extract_byte_aligned));
    suite.add(TestCase::new("field_location_extract_16bit_aligned", descriptor::test_field_location_extract_16bit_aligned));
    suite.add(TestCase::new("field_location_extract_empty_data", descriptor::test_field_location_extract_empty_data));
    suite.add(TestCase::new("field_location_extract_invalid", descriptor::test_field_location_extract_invalid));
    suite.add(TestCase::new("field_location_extract_out_of_bounds", descriptor::test_field_location_extract_out_of_bounds));
    ...
    suite.add(TestCase::new("touchpad_layout_contacts_array", descriptor::test_touchpad_layout_contacts_array));
    ...
    suite.add(TestCase::new("field_location_extract_multi_byte", descriptor::test_field_location_extract_multi_byte));
    suite.add(TestCase::new("field_location_extract_nibble", descriptor::test_field_location_extract_nibble));
    ...
    suite.add(TestCase::new("touchpad_layout_structure", descriptor::test_touchpad_layout_structure));
    ...
    suite.add(TestCase::new("hid_register_to_le_bytes_zero", i2c_hid::test_hid_register_to_le_bytes_zero));
    suite.add(TestCase::new("hid_register_to_le_bytes_max", i2c_hid::test_hid_register_to_le_bytes_max));
    ...
    suite.add(TestCase::new("supported_commands_contains_reset", i2c_hid::test_supported_commands_contains_reset));
    suite.add(TestCase::new("supported_commands_contains_get_report", i2c_hid::test_supported_commands_contains_get_report));
    suite.add(TestCase::new("supported_commands_contains_set_report", i2c_hid::test_supported_commands_contains_set_report));
    suite.add(TestCase::new("supported_commands_contains_set_power", i2c_hid::test_supported_commands_contains_set_power));
    suite.add(TestCase::new("hid_usage_page_digitizer", i2c_hid::test_hid_usage_page_digitizer));
    suite.add(TestCase::new("hid_usage_page_generic_desktop", i2c_hid::test_hid_usage_page_generic_desktop));
    ...
    suite.add(TestCase::new("hid_usage_button_secondary", i2c_hid::test_hid_usage_button_secondary));
    suite.add(TestCase::new("all_hid_commands_have_unique_opcodes", i2c_hid::test_all_hid_commands_have_unique_opcodes));
    ...
    suite.add(TestCase::new("input_source_enum_values", input_manager::test_input_source_enum_values));
    ...
    suite.add(TestCase::new("input_manager_struct_creation", input_manager::test_input_manager_struct_creation));
    suite.add(TestCase::new("input_manager_source_returns_valid_source", input_manager::test_input_manager_source_returns_valid_source));
    suite.add(TestCase::new("input_source_all_variants", input_manager::test_input_source_all_variants));
    suite.add(TestCase::new("input_source_pattern_matching", input_manager::test_input_source_pattern_matching));
    suite.add(TestCase::new("input_source_usb_pattern", input_manager::test_input_source_usb_pattern));
    suite.add(TestCase::new("input_source_i2c_pattern", input_manager::test_input_source_i2c_pattern));
    ...
    suite.add(TestCase::new("key_event_from_code_arrows", keyboard::test_key_event_from_code_arrows));
    suite.add(TestCase::new("key_event_from_code_navigation", keyboard::test_key_event_from_code_navigation));
    suite.add(TestCase::new("key_event_from_code_special", keyboard::test_key_event_from_code_special));
    suite.add(TestCase::new("key_event_from_code_function_keys", keyboard::test_key_event_from_code_function_keys));
    suite.add(TestCase::new("key_event_from_code_invalid_zero", keyboard::test_key_event_from_code_invalid_zero));
    suite.add(TestCase::new("key_event_from_code_invalid_high", keyboard::test_key_event_from_code_invalid_high));
    ...
    suite.add(TestCase::new("key_event_name_function_keys", keyboard::test_key_event_name_function_keys));
    ...
    suite.add(TestCase::new("key_event_is_navigation_true", keyboard::test_key_event_is_navigation_true));
    suite.add(TestCase::new("key_event_is_navigation_false", keyboard::test_key_event_is_navigation_false));
    suite.add(TestCase::new("key_event_is_function_key_true", keyboard::test_key_event_is_function_key_true));
    suite.add(TestCase::new("key_event_is_function_key_false", keyboard::test_key_event_is_function_key_false));
    ...
    suite.add(TestCase::new("mouse_left_button_not_pressed", mouse::test_mouse_left_button_not_pressed));
    suite.add(TestCase::new("mouse_left_button_pressed", mouse::test_mouse_left_button_pressed));
    suite.add(TestCase::new("mouse_right_button_not_pressed", mouse::test_mouse_right_button_not_pressed));
    suite.add(TestCase::new("mouse_right_button_pressed", mouse::test_mouse_right_button_pressed));
    suite.add(TestCase::new("mouse_middle_button_not_pressed", mouse::test_mouse_middle_button_not_pressed));
    suite.add(TestCase::new("mouse_middle_button_pressed", mouse::test_mouse_middle_button_pressed));
    ...
    suite.add(TestCase::new("mouse_not_available_by_default", mouse::test_mouse_not_available_by_default));
    suite.add(TestCase::new("mouse_available", mouse::test_mouse_available));
    suite.add(TestCase::new("mouse_scroll_wheel_not_available_by_default", mouse::test_mouse_scroll_wheel_not_available_by_default));
    suite.add(TestCase::new("mouse_scroll_wheel_available", mouse::test_mouse_scroll_wheel_available));
    suite.add(TestCase::new("mouse_scroll_delta_zero_default", mouse::test_mouse_scroll_delta_zero_default));
    suite.add(TestCase::new("mouse_scroll_delta_positive", mouse::test_mouse_scroll_delta_positive));
    suite.add(TestCase::new("mouse_scroll_delta_negative", mouse::test_mouse_scroll_delta_negative));
    suite.add(TestCase::new("mouse_take_scroll_delta_clears", mouse::test_mouse_take_scroll_delta_clears));
    suite.add(TestCase::new("mouse_take_scroll_delta_zero", mouse::test_mouse_take_scroll_delta_zero));
    suite.add(TestCase::new("mouse_take_scroll_delta_multiple", mouse::test_mouse_take_scroll_delta_multiple));
    ...
    suite.add(TestCase::new("mouse_position_boundary_left", mouse::test_mouse_position_boundary_left));
    suite.add(TestCase::new("mouse_position_boundary_top", mouse::test_mouse_position_boundary_top));
    ...
    suite.add(TestCase::new("mouse_button_bitmask_values", mouse::test_mouse_button_bitmask_values));
    suite.add(TestCase::new("mouse_atomic_ordering", mouse::test_mouse_atomic_ordering));
    suite.add(TestCase::new("mouse_independent_button_states", mouse::test_mouse_independent_button_states));
    ...
    suite.add(TestCase::new("touch_point_is_palm_by_area", touchpad::test_touch_point_is_palm_by_area));
    suite.add(TestCase::new("touch_point_is_palm_by_pressure", touchpad::test_touch_point_is_palm_by_pressure));
    suite.add(TestCase::new("touch_point_is_palm_by_left_edge", touchpad::test_touch_point_is_palm_by_left_edge));
    suite.add(TestCase::new("touch_point_is_palm_by_right_edge", touchpad::test_touch_point_is_palm_by_right_edge));
    suite.add(TestCase::new("touch_point_is_palm_by_top_edge", touchpad::test_touch_point_is_palm_by_top_edge));
    suite.add(TestCase::new("touch_point_is_palm_by_bottom_edge", touchpad::test_touch_point_is_palm_by_bottom_edge));
    ...
    suite.add(TestCase::new("gesture_three_finger_swipes", touchpad::test_gesture_three_finger_swipes));
    suite.add(TestCase::new("gesture_four_finger_swipes", touchpad::test_gesture_four_finger_swipes));
    ...
    suite.add(TestCase::new("constants_gesture_thresholds", touchpad::test_constants_gesture_thresholds));
    ...
    suite.add(TestCase::new("detect_two_finger_gesture_no_contacts", touchpad::test_detect_two_finger_gesture_no_contacts));
    suite.add(TestCase::new("detect_two_finger_gesture_one_contact", touchpad::test_detect_two_finger_gesture_one_contact));
    suite.add(TestCase::new("detect_three_finger_gesture_no_contacts", touchpad::test_detect_three_finger_gesture_no_contacts));
    suite.add(TestCase::new("detect_four_finger_gesture_no_contacts", touchpad::test_detect_four_finger_gesture_no_contacts));
    suite.add(TestCase::new("apply_acceleration_small_delta", touchpad::test_apply_acceleration_small_delta));
    suite.add(TestCase::new("apply_acceleration_medium_delta", touchpad::test_apply_acceleration_medium_delta));
    suite.add(TestCase::new("apply_acceleration_large_delta", touchpad::test_apply_acceleration_large_delta));
    suite.add(TestCase::new("apply_acceleration_very_large_delta", touchpad::test_apply_acceleration_very_large_delta));
    suite.add(TestCase::new("apply_acceleration_negative", touchpad::test_apply_acceleration_negative));
    ...
    suite.add(TestCase::new("touchpad_state_contacts_array_size", touchpad::test_touchpad_state_contacts_array_size));
    ...
    suite.add(TestCase::new("hid_to_ascii_shifted_letters", usb_hid::test_hid_to_ascii_shifted_letters));
    suite.add(TestCase::new("hid_to_ascii_numbers", usb_hid::test_hid_to_ascii_numbers));
    suite.add(TestCase::new("hid_to_ascii_shifted_numbers", usb_hid::test_hid_to_ascii_shifted_numbers));
    ...
    suite.add(TestCase::new("hid_to_ascii_shifted_punctuation", usb_hid::test_hid_to_ascii_shifted_punctuation));
    ...
    suite.add(TestCase::new("hid_to_ascii_forward_delete", usb_hid::test_hid_to_ascii_forward_delete));
    ...
    suite.add(TestCase::new("usb_descriptor_type_constants", usb_hid::test_usb_descriptor_type_constants));
