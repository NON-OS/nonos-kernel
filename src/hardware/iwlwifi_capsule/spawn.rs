...
const SERVICE_NAME: &str = "driver.iwlwifi0";
const SERVICE_PORT: u32 = 4228;
const REPLY_INBOX: &str = "endpoint.4294967317";
const REPLY_PORT: u32 = 4229;
const TARGET_TRIPLE: &str = "x86_64-nonos-user";

pub fn spawn_driver_iwlwifi_capsule() -> Result<(), SpawnError> {
    ...
    let spec = CapsuleSpecVerified {
        ...
        requested_caps: Capability::IPC.bit()
            ...
            | Capability::Irq.bit()
            | Capability::Dma.bit(),
        debug_tag: b"[DRIVER-IWLWIFI] load_elf_executable error:",
    };
