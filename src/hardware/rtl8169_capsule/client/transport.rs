...
pub const REPLY_INBOX: &str = "endpoint.4294967310";
const SENDER_NAME: &str = "kernel.driver_rtl8169";
...
fn map_err(e: transport::TransportError) -> DriverRtl8169Error {
    match e {
        transport::TransportError::Dead => DriverRtl8169Error::Dead,
        transport::TransportError::Stale => DriverRtl8169Error::Stale,
        transport::TransportError::TransportFailure => DriverRtl8169Error::TransportFailure,
        transport::TransportError::ProtocolMismatch => DriverRtl8169Error::ProtocolMismatch,
    }
}
