...
//! capsule prepends the virtio-net header and posts a one-shot
//! TX descriptor. Frame length is bounds-checked here so a
//! caller with a runaway buffer is refused before round-trip.
