...
//! `userland/capsule_driver_virtio_net/src/protocol/header.rs`
//! and `.../src/protocol/limits.rs`. Drift surfaces as
//! `DriverNetError::ProtocolMismatch`.

pub(in super::super) const MAGIC: u32 = 0x4E4E_4554; // "NNET"
