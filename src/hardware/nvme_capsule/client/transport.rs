...
pub const REPLY_INBOX: &str = "endpoint.4294967313";
const SENDER_NAME: &str = "kernel.driver_nvme";
...
fn map_err(e: transport::TransportError) -> DriverNvmeError {
    match e {
        transport::TransportError::Dead => DriverNvmeError::Dead,
        transport::TransportError::Stale => DriverNvmeError::Stale,
        transport::TransportError::TransportFailure => DriverNvmeError::TransportFailure,
        transport::TransportError::ProtocolMismatch => DriverNvmeError::ProtocolMismatch,
    }
}
