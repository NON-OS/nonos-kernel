...
pub(crate) fn test_easing_values() -> TestResult {
    ...
    if Easing::EaseInOut != Easing::EaseInOut { return TestResult::Fail; }
    if Easing::Spring != Easing::Spring { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_apply_easing_ease_in() -> TestResult {
    ...
    if start != 0.0 { return TestResult::Fail; }
    if !(middle < 0.5) { return TestResult::Fail; }
    if end != 1.0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_apply_easing_ease_in_out() -> TestResult {
    ...
    if start != 0.0 { return TestResult::Fail; }
    if !((middle - 0.5).abs() < 0.01) { return TestResult::Fail; }
    if end != 1.0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_interpolate_color() -> TestResult {
    ...
    if start != black { return TestResult::Fail; }
    if end != white { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_interpolate_color_midpoint() -> TestResult {
    ...
    if !((r as i32 - 127).abs() <= 1) { return TestResult::Fail; }
    if !((g as i32 - 127).abs() <= 1) { return TestResult::Fail; }
    if !((b as i32 - 127).abs() <= 1) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_interpolate_color_alpha() -> TestResult {
    ...
    if !((a as i32 - 127).abs() <= 1) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_animation_status_values() -> TestResult {
    ...
    if AnimationStatus::Paused != AnimationStatus::Paused { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_animation_new() -> TestResult {
    ...
    if anim.duration_ms != 500 { return TestResult::Fail; }
    if anim.easing != Easing::EaseOut { return TestResult::Fail; }
    if anim.status != AnimationStatus::Idle { return TestResult::Fail; }
    if anim.delay_ms != 0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_animation_start() -> TestResult {
    ...
    if anim.started_at != 1000 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_animation_progress_running() -> TestResult {
    ...
    if anim.progress(50) != 0.5 { return TestResult::Fail; }
    if anim.progress(100) != 1.0 { return TestResult::Fail; }
    if anim.progress(200) != 1.0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_animation_progress_with_delay() -> TestResult {
    ...
    anim.start(0);
    if anim.progress(0) != 0.0 { return TestResult::Fail; }
    if anim.progress(50) != 0.0 { return TestResult::Fail; }
    if anim.progress(100) != 0.5 { return TestResult::Fail; }
    if anim.progress(150) != 1.0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_animation_current_value() -> TestResult {
    ...
    if anim.current_value(50) != 50.0 { return TestResult::Fail; }
    if anim.current_value(100) != 100.0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_animation_is_complete() -> TestResult {
    ...
    if !anim.is_complete(100) { return TestResult::Fail; }
    if !anim.is_complete(200) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_animation_complete() -> TestResult {
    ...
    anim.start(0);
    anim.complete();
    if anim.status != AnimationStatus::Completed { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_animation_reset() -> TestResult {
    ...
    anim.reset();
    if anim.status != AnimationStatus::Idle { return TestResult::Fail; }
    if anim.started_at != 0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_animation_default() -> TestResult {
    ...
    if anim.duration_ms != 300 { return TestResult::Fail; }
    if anim.easing != Easing::EaseOut { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_animation_copy() -> TestResult {
    ...
    if anim1.easing != anim2.easing { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_transition_fade_in() -> TestResult {
    ...
    if anim.start_value != 0.0 { return TestResult::Fail; }
    if anim.end_value != 1.0 { return TestResult::Fail; }
    if anim.duration_ms != 200 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_transition_scale_in() -> TestResult {
    ...
    if anim.start_value != 0.0 { return TestResult::Fail; }
    if anim.end_value != 1.0 { return TestResult::Fail; }
    if anim.easing != Easing::Spring { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_transition_spinner_rotation() -> TestResult {
    ...
    if anim.easing != Easing::Linear { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_duration_constants() -> TestResult {
    ...
    if transitions::DURATION_VERY_SLOW != 600 { return TestResult::Fail; }
    TestResult::Pass
}
