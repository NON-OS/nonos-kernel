...
pub(crate) fn test_char_bitmap_uppercase_letters() -> TestResult {
    ...
    if bitmap_z.len() != 16 { return TestResult::Fail; }
    if bitmap_z[1] == 0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_char_bitmap_slashes() -> TestResult {
    ...
    if bitmap_forward.len() != 16 { return TestResult::Fail; }
    if bitmap_back.len() != 16 { return TestResult::Fail; }
    if bitmap_pipe.len() != 16 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_char_bitmap_special() -> TestResult {
    ...
    if bitmap_caret.len() != 16 { return TestResult::Fail; }
    if bitmap_tilde.len() != 16 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_bitmap_has_content() -> TestResult {
    ...
    for ch in non_empty_chars {
        ...
        if !has_content { return TestResult::Fail; }
    }
    TestResult::Pass
}
