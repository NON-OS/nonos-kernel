...
pub fn test_theme_values() -> TestResult {
    ...
    if Theme::DeepPurple as u8 != 3 { return TestResult::Fail; }
    if Theme::OceanBlue as u8 != 4 { return TestResult::Fail; }
    if Theme::ForestGreen as u8 != 5 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_theme_from_u8() -> TestResult {
    ...
    if Theme::from_u8(3) != Theme::DeepPurple { return TestResult::Fail; }
    if Theme::from_u8(4) != Theme::OceanBlue { return TestResult::Fail; }
    if Theme::from_u8(5) != Theme::ForestGreen { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_theme_name() -> TestResult {
    ...
    if Theme::DeepPurple.name() != "Deep Purple" { return TestResult::Fail; }
    if Theme::OceanBlue.name() != "Ocean Blue" { return TestResult::Fail; }
    if Theme::ForestGreen.name() != "Forest Green" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_theme_next() -> TestResult {
    ...
    if Theme::DeepPurple.next() != Theme::OceanBlue { return TestResult::Fail; }
    if Theme::OceanBlue.next() != Theme::ForestGreen { return TestResult::Fail; }
    if Theme::ForestGreen.next() != Theme::NonosDark { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_theme_prev() -> TestResult {
    ...
    if Theme::DeepPurple.prev() != Theme::SolarizedDark { return TestResult::Fail; }
    if Theme::OceanBlue.prev() != Theme::DeepPurple { return TestResult::Fail; }
    if Theme::ForestGreen.prev() != Theme::OceanBlue { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_theme_cycle_next_full() -> TestResult {
    ...
    if theme != Theme::NonosDark { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_color_scheme_nonos_dark() -> TestResult {
    ...
    if colors.bg_tertiary != 0xFF21262D { return TestResult::Fail; }
    if colors.text_primary != 0xFFFFFFFF { return TestResult::Fail; }
    if colors.text_secondary != 0xFF7D8590 { return TestResult::Fail; }
    if colors.accent != 0xFF58A6FF { return TestResult::Fail; }
    if colors.success != 0xFF3FB950 { return TestResult::Fail; }
    if colors.warning != 0xFFD29922 { return TestResult::Fail; }
    if colors.error != 0xFFF85149 { return TestResult::Fail; }
    if colors.border != 0xFF30363D { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_color_scheme_solarized() -> TestResult {
    ...
    if colors.success != 0xFF859900 { return TestResult::Fail; }
    if colors.error != 0xFFDC322F { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_color_scheme_deep_purple() -> TestResult {
    ...
    if colors.success != 0xFF03DAC5 { return TestResult::Fail; }
    if colors.error != 0xFFCF6679 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_color_scheme_ocean_blue() -> TestResult {
    ...
    if colors.success != 0xFF40E0D0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_color_scheme_forest_green() -> TestResult {
    ...
    if colors.success != 0xFF8BC34A { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_all_themes_have_valid_colors() -> TestResult {
    for i in 0..Theme::count() {
        ...
        if colors.bg_primary == 0 { return TestResult::Fail; }
        if colors.text_primary == 0 { return TestResult::Fail; }
        if colors.accent == 0 { return TestResult::Fail; }
    }
    TestResult::Pass
}
...
pub fn test_color_scheme_copy() -> TestResult {
    ...
    if c1.accent != c2.accent { return TestResult::Fail; }
    TestResult::Pass
}
