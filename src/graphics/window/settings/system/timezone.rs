...
pub(super) fn draw_timezone(x: u32, y: u32, w: u32) {
    draw_string(x + 15, y + 430, b"Timezone", COLOR_TEXT_WHITE);
    fill_rect(x + 15, y + 450, w - 30, 36, 0xFF1A1F26);
    fill_rect(x + 20, y + 455, 26, 26, 0xFF2D333B);
    draw_string(x + 28, y + 460, b"<", COLOR_TEXT_WHITE);
    draw_tz_name(x + 60, y + 461, sys_settings::timezone());
    fill_rect(x + w - 46, y + 455, 26, 26, 0xFF2D333B);
    draw_string(x + w - 38, y + 460, b">", COLOR_TEXT_WHITE);
}

pub(super) fn draw_screen_timeout(x: u32, y: u32, w: u32) {
    draw_string(x + 15, y + 500, b"Screen Timeout", COLOR_TEXT_WHITE);
