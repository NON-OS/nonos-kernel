...
pub fn draw_staking_view(x: u32, y: u32, w: u32, _h: u32) {
    ...
    draw_string(x + 36, y + 310, b"Pool Stats", COLOR_TEXT_DIM);
    let (pool_eth, pool_wei) = ((state2.total_pool_staked / 1_000_000_000_000_000_000) as u64, (state2.total_pool_staked % 1_000_000_000_000_000_000 / 1_000_000_000_000_000) as u64);
    let mut pool_buf = [0u8; 32]; let pool_len = format_balance(&mut pool_buf, pool_eth, pool_wei);
    draw_string(x + 36, y + 330, b"Total Staked:", COLOR_TEXT_DIM);
    draw_string(x + 150, y + 330, &pool_buf[..pool_len], COLOR_TEXT_WHITE);
    draw_string(x + 150 + (pool_len as u32 + 1) * 8, y + 330, b"NOX", 0xFFBF5AF2);
}
