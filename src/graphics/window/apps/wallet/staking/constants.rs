...
pub const STAKING_SEPOLIA: [u8; 20] = hex_addr("0000000000000000000000000000000000000000");
pub const REWARDS_MAINNET: [u8; 20] = hex_addr("0000000000000000000000000000000000000000");
