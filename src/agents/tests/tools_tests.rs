...
pub fn test_execute_tool() -> TestResult {
    register_tool(b"exec_test_tool", b"Exec test", dummy_tool);

    let result = execute_tool(b"exec_test_tool", b"");
    if result.as_slice() != b"dummy result" { return TestResult::Fail; }
    TestResult::Pass
}

pub fn test_execute_tool_with_args() -> TestResult {
...
pub fn test_execute_tool_not_found() -> TestResult {
    let result = execute_tool(b"nonexistent_tool_xyz", b"");
    if result.is_empty() { return TestResult::Fail; }
    TestResult::Pass
}

pub fn test_execute_tool_transformation() -> TestResult {
    register_tool(b"upper_tool", b"Converts to uppercase", upper_tool);

    let result = execute_tool(b"upper_tool", b"hello");
    if result.as_slice() != b"HELLO" { return TestResult::Fail; }
    TestResult::Pass
}

pub fn test_list_tools() -> TestResult {
    register_tool(b"list_test_tool", b"For listing test", dummy_tool);

    let tools = list_tools();
    if tools.is_empty() { return TestResult::Fail; }
    TestResult::Pass
}

pub fn test_list_tools_contains_registered() -> TestResult {
    ...
    if !found { return TestResult::Fail; }
    TestResult::Pass
}

pub fn test_max_tools_constant() -> TestResult {
    if MAX_TOOLS != 32 { return TestResult::Fail; }
    TestResult::Pass
}

pub fn test_tool_name_truncation() -> TestResult {
...
pub fn test_tool_description_truncation() -> TestResult {
...
pub fn test_execute_empty_args() -> TestResult {
...
pub fn test_execute_large_args() -> TestResult {
    ...
    if result.len() != 10000 { return TestResult::Fail; }
    TestResult::Pass
}

pub fn test_tool_binary_args() -> TestResult {
    ...
    if result.as_slice() != binary_args { return TestResult::Fail; }
    TestResult::Pass
}

pub fn test_multiple_tools() -> TestResult {
    ...
    if execute_tool(b"multi_a", b"").as_slice() != b"A" { return TestResult::Fail; }
    if execute_tool(b"multi_b", b"").as_slice() != b"B" { return TestResult::Fail; }
    if execute_tool(b"multi_c", b"").as_slice() != b"C" { return TestResult::Fail; }
    TestResult::Pass
}

pub fn test_tool_returns_empty() -> TestResult {
...
pub fn test_list_tools_name_and_description() -> TestResult {
    ...
    if &desc[..desc_len] != b"Info description" { return TestResult::Fail; }
    TestResult::Pass
}
