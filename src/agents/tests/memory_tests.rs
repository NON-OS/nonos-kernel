...
pub(crate) fn test_memory_store_and_recall() -> TestResult {
    ...
    if recalled.is_none() { return TestResult::Fail; }
    if recalled.unwrap().as_slice() != b"test_value" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_memory_recall_nonexistent() -> TestResult {
    ...
    if recalled.is_some() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_memory_store_update_existing() -> TestResult {
    ...
    if recalled.is_none() { return TestResult::Fail; }
    if recalled.unwrap().as_slice() != b"value2" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_memory_multiple_keys() -> TestResult {
    ...
    if mem.recall(b"key1").unwrap().as_slice() != b"value1" { return TestResult::Fail; }
    if mem.recall(b"key2").unwrap().as_slice() != b"value2" { return TestResult::Fail; }
    if mem.recall(b"key3").unwrap().as_slice() != b"value3" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_memory_isolation_between_agents() -> TestResult {
    ...
    if mem1.recall(b"shared_key").unwrap().as_slice() != b"agent1_value" { return TestResult::Fail; }
    if mem2.recall(b"shared_key").unwrap().as_slice() != b"agent2_value" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_memory_search_basic() -> TestResult {
    ...
    if results.len() != 2 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_memory_search_no_results() -> TestResult {
    ...
    if !results.is_empty() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_memory_search_isolation() -> TestResult {
    ...
    if results1.len() != 1 { return TestResult::Fail; }
    if results2.len() != 1 { return TestResult::Fail; }
    if results1[0].agent_id != 400 { return TestResult::Fail; }
    if results2[0].agent_id != 401 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_memory_recent() -> TestResult {
    ...
    if recent.len() != 2 { return TestResult::Fail; }
    if recent[0].value.as_slice() != b"value3" { return TestResult::Fail; }
    if recent[1].value.as_slice() != b"value2" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_memory_recent_isolation() -> TestResult {
    ...
    if recent1.len() != 1 { return TestResult::Fail; }
    if recent2.len() != 1 { return TestResult::Fail; }
    if recent1[0].agent_id != 600 { return TestResult::Fail; }
    if recent2[0].agent_id != 601 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_memory_importance_stored() -> TestResult {
    ...
    if low_entry.importance != 1 { return TestResult::Fail; }
    if high_entry.importance != 10 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_memory_key_truncation() -> TestResult {
    ...
    if recalled.is_none() { return TestResult::Fail; }
    if recalled.unwrap().as_slice() != b"value" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_memory_entry_timestamp() -> TestResult {
    ...
    if recent.len() != 1 { return TestResult::Fail; }
    if recent[0].timestamp == 0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_memory_entry_clone() -> TestResult {
    ...
    if cloned.key != entry.key { return TestResult::Fail; }
    if cloned.value != entry.value { return TestResult::Fail; }
    if cloned.agent_id != entry.agent_id { return TestResult::Fail; }
    if cloned.timestamp != entry.timestamp { return TestResult::Fail; }
    if cloned.importance != entry.importance { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_memory_empty_value() -> TestResult {
    ...
    let recalled = mem.recall(b"key");
    if recalled.is_none() { return TestResult::Fail; }
    if !recalled.unwrap().is_empty() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_memory_large_value() -> TestResult {
    ...
    let recalled = mem.recall(b"key");
    if recalled.is_none() { return TestResult::Fail; }
    if recalled.unwrap().len() != 10000 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_memory_binary_value() -> TestResult {
    ...
    let recalled = mem.recall(b"key");
    if recalled.is_none() { return TestResult::Fail; }
    if recalled.unwrap().as_slice() != binary_value { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_memory_search_partial_match() -> TestResult {
    ...
    if results.len() != 3 { return TestResult::Fail; }
    TestResult::Pass
}
