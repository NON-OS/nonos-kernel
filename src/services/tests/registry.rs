...
pub(crate) fn test_service_endpoint_fields() -> TestResult {
    ...
    if ep.name != "test_svc" { return TestResult::Fail; }
    if ep.port != 1234 { return TestResult::Fail; }
    if ep.pid != 42 { return TestResult::Fail; }
    if ep.caps_required != 0x1234 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_service_endpoint_empty_name() -> TestResult {
    ...
    if !ep.name.is_empty() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_service_endpoint_clone() -> TestResult {
    ...
    let ep2 = ep1.clone();
    if ep1.name != ep2.name { return TestResult::Fail; }
    if ep1.port != ep2.port { return TestResult::Fail; }
    if ep1.pid != ep2.pid { return TestResult::Fail; }
    if ep1.caps_required != ep2.caps_required { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_service_endpoint_debug() -> TestResult {
    ...
    if !debug_str.contains("ServiceEndpoint") { return TestResult::Fail; }
    if !debug_str.contains("debug_svc") { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_service_endpoint_max_port() -> TestResult {
    ...
    if ep.port != u32::MAX { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_service_endpoint_max_pid() -> TestResult {
    ...
    if ep.pid != u32::MAX { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_service_endpoint_max_caps() -> TestResult {
    ...
    if ep.caps_required != u64::MAX { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_reg_error_all_variants() -> TestResult {
    ...
    if errors.len() != 4 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_service_endpoint_long_name() -> TestResult {
    ...
    if ep.name != long_name { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_service_endpoint_with_unicode_name() -> TestResult {
    ...
    if ep.name != "服务" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_service_endpoint_name_with_numbers() -> TestResult {
    ...
    if ep.name != "service123" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_service_endpoint_name_with_underscores() -> TestResult {
    ...
    if ep.name != "my_service_v2" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_service_endpoint_port_zero() -> TestResult {
    ...
    if ep.port != 0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_service_endpoint_pid_zero() -> TestResult {
    ...
    if ep.pid != 0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_service_endpoint_multiple_caps() -> TestResult {
    ...
    if ep.caps_required != 0xF { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_service_endpoint_default_like() -> TestResult {
    ...
    if ep.port != 0 { return TestResult::Fail; }
    if ep.pid != 0 { return TestResult::Fail; }
    if ep.caps_required != 0 { return TestResult::Fail; }
    TestResult::Pass
}
