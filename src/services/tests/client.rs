...
pub fn test_client_error_remote_error_variant() -> TestResult {
    ...
    match err {
        ClientError::RemoteError(code) => {
            if code != -1 { return TestResult::Fail; }
        }
...
pub fn test_client_error_remote_error_various_codes() -> TestResult {
    ...
    match err1 { ClientError::RemoteError(c) => { if c != -403 { return TestResult::Fail; } }, _ => return TestResult::Fail }
    match err2 { ClientError::RemoteError(c) => { if c != -404 { return TestResult::Fail; } }, _ => return TestResult::Fail }
    match err3 { ClientError::RemoteError(c) => { if c != -500 { return TestResult::Fail; } }, _ => return TestResult::Fail }
    TestResult::Pass
}
...
pub fn test_client_error_equality_simple() -> TestResult {
    ...
    if ClientError::RecvFailed != ClientError::RecvFailed { return TestResult::Fail; }
    if ClientError::Timeout != ClientError::Timeout { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_client_error_debug_remote_error() -> TestResult {
    ...
    if !debug_str.contains("-999") { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_client_error_remote_error_zero() -> TestResult {
    ...
    match err {
        ClientError::RemoteError(code) => {
            if code != 0 { return TestResult::Fail; }
        }
        _ => return TestResult::Fail,
    }
    TestResult::Pass
...
pub fn test_client_error_remote_error_positive() -> TestResult {
    ...
    match err {
        ClientError::RemoteError(code) => {
            if code != 200 { return TestResult::Fail; }
        }
        _ => return TestResult::Fail,
    }
    TestResult::Pass
...
pub fn test_client_error_remote_error_min() -> TestResult {
    ...
    match err {
        ClientError::RemoteError(code) => {
            if code != i32::MIN { return TestResult::Fail; }
        }
        _ => return TestResult::Fail,
    }
    TestResult::Pass
...
pub fn test_client_error_remote_error_max() -> TestResult {
    ...
    match err {
        ClientError::RemoteError(code) => {
            if code != i32::MAX { return TestResult::Fail; }
        }
        _ => return TestResult::Fail,
    }
    TestResult::Pass
