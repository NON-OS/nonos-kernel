...
//
//! NONOS Context Switching Implementation
//!
//! Advanced context switching with security, performance optimization, and full x86_64 state management
...
/// secure context switch with complete state save/restore
#[naked]
pub unsafe extern "C" fn switch_context_secure(
    ...
    asm!(
        ...
        // Load segment registers (we have to be careful with this)
...
impl Task {
    ...
    pub unsafe fn switch_to_secure(&mut self, old_ctx: &mut Context) -> Result<(), &'static str> {
        ...
        crate::log::logger::log_debug(&format!(
