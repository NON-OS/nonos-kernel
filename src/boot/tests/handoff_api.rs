...
pub(crate) fn test_handoff_error_null_pointer_str() -> TestResult {
    ...
    if err.as_str() != "Null handoff pointer" {
...
pub(crate) fn test_handoff_error_invalid_magic_str() -> TestResult {
    ...
    if err.as_str() != "Invalid handoff magic value" {
        return TestResult::Fail;
    }
    TestResult::Pass
}
...
pub(crate) fn test_handoff_error_version_mismatch_str() -> TestResult {
    ...
    if err.as_str() != "Handoff version mismatch" {
        return TestResult::Fail;
    }
    TestResult::Pass
}
...
pub(crate) fn test_handoff_error_size_mismatch_str() -> TestResult {
    ...
    if err.as_str() != "Handoff size mismatch" {
        return TestResult::Fail;
    }
    TestResult::Pass
}
...
pub(crate) fn test_handoff_error_already_initialized_str() -> TestResult {
    ...
    if err.as_str() != "Handoff already initialized" {
        return TestResult::Fail;
    }
    TestResult::Pass
}
...
pub(crate) fn test_handoff_error_invalid_data_str() -> TestResult {
    ...
    if err.as_str() != "Invalid handoff data" {
        return TestResult::Fail;
    }
    TestResult::Pass
}
...
pub(crate) fn test_handoff_error_equality() -> TestResult {
    if HandoffError::NullPointer != HandoffError::NullPointer {
        return TestResult::Fail;
    }
    if HandoffError::InvalidMagic != HandoffError::InvalidMagic {
        return TestResult::Fail;
    }
    if HandoffError::AlreadyInitialized != HandoffError::AlreadyInitialized {
        return TestResult::Fail;
    }
    if HandoffError::InvalidData != HandoffError::InvalidData {
        return TestResult::Fail;
    }
...
pub(crate) fn test_handoff_error_not_equal_different_variants() -> TestResult {
    if HandoffError::NullPointer == HandoffError::InvalidMagic {
        return TestResult::Fail;
    }
    if HandoffError::InvalidMagic == HandoffError::AlreadyInitialized {
        return TestResult::Fail;
    }
    if HandoffError::AlreadyInitialized == HandoffError::InvalidData {
        return TestResult::Fail;
    }
    TestResult::Pass
}
