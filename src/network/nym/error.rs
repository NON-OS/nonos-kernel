...
impl NymError {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            Self::NotConnected => "Not connected to gateway",
            Self::HandshakeFailed => "Gateway handshake failed",
            Self::SendFailed => "Failed to send data",
            Self::ReceiveFailed => "Failed to receive data",
