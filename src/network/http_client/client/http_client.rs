...
pub struct HttpClient { pub(super) options: HttpRequestOptions }

impl HttpClient {
    pub fn new() -> Self { Self { options: HttpRequestOptions::default() } }
    pub fn with_options(options: HttpRequestOptions) -> Self { Self { options } }
}
