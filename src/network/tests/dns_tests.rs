...
pub(crate) fn test_mx_record_fields() -> TestResult {
    ...
    if mx.preference != 10 { return TestResult::Fail; }
    if mx.exchange != "mail.example.com" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_mx_record_clone() -> TestResult {
    ...
    let cloned = mx.clone();
    if mx.preference != cloned.preference { return TestResult::Fail; }
    if mx.exchange != cloned.exchange { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_mx_record_debug() -> TestResult {
    ...
    if !debug_str.contains("MxRecord") { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_srv_record_fields() -> TestResult {
    ...
    if srv.priority != 10 { return TestResult::Fail; }
    if srv.weight != 20 { return TestResult::Fail; }
    if srv.port != 5060 { return TestResult::Fail; }
    if srv.target != "sip.example.com" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_srv_record_clone() -> TestResult {
    ...
    if srv.priority != cloned.priority { return TestResult::Fail; }
    if srv.weight != cloned.weight { return TestResult::Fail; }
    if srv.port != cloned.port { return TestResult::Fail; }
    if srv.target != cloned.target { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_dns_record_aaaa() -> TestResult {
    ...
    if let DnsRecord::AAAA(addr) = record {
        ...
        if addr[15] != 1 { return TestResult::Fail; }
    } else {
        return TestResult::Fail;
    }
    TestResult::Pass
...
pub(crate) fn test_dns_record_mx() -> TestResult {
    ...
    if let DnsRecord::MX(r) = record {
        if r.preference != 10 { return TestResult::Fail; }
    } else {
        return TestResult::Fail;
    }
    TestResult::Pass
...
pub(crate) fn test_dns_record_srv() -> TestResult {
    ...
    if let DnsRecord::SRV(r) = record {
        if r.port != 80 { return TestResult::Fail; }
    } else {
        return TestResult::Fail;
    }
    TestResult::Pass
...
pub(crate) fn test_dns_cache_entry_fields() -> TestResult {
    ...
    if entry.hostname != "example.com" { return TestResult::Fail; }
    if entry.addresses.len() != 1 { return TestResult::Fail; }
    if entry.timestamp_ms != 1000000 { return TestResult::Fail; }
    if entry.ttl_ms != 300000 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_dns_cache_entry_multiple_addresses() -> TestResult {
    ...
    if entry.addresses.len() != 3 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_dns_cache_entry_clone() -> TestResult {
    ...
    if entry.hostname != cloned.hostname { return TestResult::Fail; }
    if entry.addresses != cloned.addresses { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_dns_record_cache_entry_fields() -> TestResult {
    ...
    if entry.hostname != "example.org" { return TestResult::Fail; }
    if entry.record_type != DnsRecordType::A { return TestResult::Fail; }
    if entry.records.len() != 1 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_dns_record_cache_entry_clone() -> TestResult {
    ...
    let cloned = entry.clone();
    if entry.hostname != cloned.hostname { return TestResult::Fail; }
    if entry.record_type != cloned.record_type { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_dns_query_record_fields() -> TestResult {
    ...
    if query.hostname != "query.test.com" { return TestResult::Fail; }
    if query.timestamp_ms != 999999 { return TestResult::Fail; }
    if !query.success { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_dns_query_record_clone() -> TestResult {
    ...
    if query.hostname != cloned.hostname { return TestResult::Fail; }
    if query.success != cloned.success { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_pending_query_fields() -> TestResult {
    ...
    if pending.hostname != "pending.example.com" { return TestResult::Fail; }
    if pending.start_ms != 1000 { return TestResult::Fail; }
    if pending.timeout_ms != 5000 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_pending_query_clone() -> TestResult {
    ...
    if pending.hostname != cloned.hostname { return TestResult::Fail; }
    if pending.timeout_ms != cloned.timeout_ms { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_dns_response_a_fields() -> TestResult {
    ...
    if response.addresses.len() != 2 { return TestResult::Fail; }
    if response.ttl_seconds != 3600 { return TestResult::Fail; }
    if response.cnames.len() != 1 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_dns_response_a_empty() -> TestResult {
    ...
    if !response.addresses.is_empty() { return TestResult::Fail; }
    if !response.cnames.is_empty() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_dns_response_a_clone() -> TestResult {
    ...
    if response.addresses != cloned.addresses { return TestResult::Fail; }
    if response.ttl_seconds != cloned.ttl_seconds { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_dns_response_aaaa_fields() -> TestResult {
    ...
    if response.addresses.len() != 1 { return TestResult::Fail; }
    if response.ttl_seconds != 7200 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_dns_record_type_all_values() -> TestResult {
    ...
    for (t, v) in types {
        if t as u16 != v { return TestResult::Fail; }
        if DnsRecordType::from_u16(v) != Some(t) { return TestResult::Fail; }
    }
    TestResult::Pass
}
