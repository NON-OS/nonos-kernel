...
pub fn run_all() -> bool {
    ...
    suite.add(TestCase::new("ip_address_not_unspecified_v4", ip_tests::test_ip_address_not_unspecified_v4));
    suite.add(TestCase::new("ip_address_not_unspecified_v6", ip_tests::test_ip_address_not_unspecified_v6));
    suite.add(TestCase::new("ip_address_loopback_v4", ip_tests::test_ip_address_loopback_v4));
    suite.add(TestCase::new("ip_address_loopback_v4_any", ip_tests::test_ip_address_loopback_v4_any));
    suite.add(TestCase::new("ip_address_loopback_v6", ip_tests::test_ip_address_loopback_v6));
    suite.add(TestCase::new("ip_address_not_loopback_v4", ip_tests::test_ip_address_not_loopback_v4));
    suite.add(TestCase::new("ip_address_not_loopback_v6", ip_tests::test_ip_address_not_loopback_v6));
    ...
    suite.add(TestCase::new("ip_address_v4_v6_different", ip_tests::test_ip_address_v4_v6_different));
    ...
    suite.add(TestCase::new("tcp_header_all_flags_combined", tcp_tests::test_tcp_header_all_flags_combined));
    ...
    suite.add(TestCase::new("udp_header_parse_too_short", udp_tests::test_udp_header_parse_too_short));
    suite.add(TestCase::new("udp_header_parse_empty", udp_tests::test_udp_header_parse_empty));
    suite.add(TestCase::new("udp_header_parse_exact_size", udp_tests::test_udp_header_parse_exact_size));
    suite.add(TestCase::new("udp_header_serialize", udp_tests::test_udp_header_serialize));
    suite.add(TestCase::new("udp_header_serialize_roundtrip", udp_tests::test_udp_header_serialize_roundtrip));
    ...
    suite.add(TestCase::new("udp_header_calculate_checksum", udp_tests::test_udp_header_calculate_checksum));
    suite.add(TestCase::new("udp_header_calculate_checksum_empty_data", udp_tests::test_udp_header_calculate_checksum_empty_data));
    suite.add(TestCase::new("udp_header_calculate_checksum_odd_length", udp_tests::test_udp_header_calculate_checksum_odd_length));

    // DNS tests (52 tests)
    suite.add(TestCase::new("dns_max_query_cache_constant", dns_tests::test_max_query_cache_constant));
    suite.add(TestCase::new("dns_default_ttl_ms_constant", dns_tests::test_default_ttl_ms_constant));
    suite.add(TestCase::new("dns_max_cname_depth_constant", dns_tests::test_max_cname_depth_constant));
    ...
    suite.add(TestCase::new("dns_record_type_from_u16_a", dns_tests::test_dns_record_type_from_u16_a));
    suite.add(TestCase::new("dns_record_type_from_u16_ns", dns_tests::test_dns_record_type_from_u16_ns));
    suite.add(TestCase::new("dns_record_type_from_u16_cname", dns_tests::test_dns_record_type_from_u16_cname));
    suite.add(TestCase::new("dns_record_type_from_u16_soa", dns_tests::test_dns_record_type_from_u16_soa));
    suite.add(TestCase::new("dns_record_type_from_u16_ptr", dns_tests::test_dns_record_type_from_u16_ptr));
    suite.add(TestCase::new("dns_record_type_from_u16_mx", dns_tests::test_dns_record_type_from_u16_mx));
    suite.add(TestCase::new("dns_record_type_from_u16_txt", dns_tests::test_dns_record_type_from_u16_txt));
    suite.add(TestCase::new("dns_record_type_from_u16_aaaa", dns_tests::test_dns_record_type_from_u16_aaaa));
    suite.add(TestCase::new("dns_record_type_from_u16_srv", dns_tests::test_dns_record_type_from_u16_srv));
    suite.add(TestCase::new("dns_record_type_from_u16_invalid", dns_tests::test_dns_record_type_from_u16_invalid));
    ...
    suite.add(TestCase::new("dns_cache_entry_multiple_addresses", dns_tests::test_dns_cache_entry_multiple_addresses));
    suite.add(TestCase::new("dns_cache_entry_clone", dns_tests::test_dns_cache_entry_clone));
    suite.add(TestCase::new("dns_record_cache_entry_fields", dns_tests::test_dns_record_cache_entry_fields));
    suite.add(TestCase::new("dns_record_cache_entry_clone", dns_tests::test_dns_record_cache_entry_clone));
    ...
    suite.add(TestCase::new("dns_record_type_all_values", dns_tests::test_dns_record_type_all_values));
    ...
    suite.add(TestCase::new("firewall_direction_outbound", firewall_tests::test_direction_outbound));
    suite.add(TestCase::new("firewall_direction_both", firewall_tests::test_direction_both));
    suite.add(TestCase::new("firewall_direction_equality", firewall_tests::test_direction_equality));
    ...
    suite.add(TestCase::new("firewall_port_match_equality", firewall_tests::test_port_match_equality));
    ...
    suite.add(TestCase::new("firewall_rule_stats_default", firewall_tests::test_rule_stats_default));
    ...
    suite.add(TestCase::new("firewall_rule_with_rate_limit", firewall_tests::test_rule_with_rate_limit));
    ...
    suite.add(TestCase::new("firewall_conn_state_established", firewall_tests::test_conn_state_established));
    suite.add(TestCase::new("firewall_conn_state_related", firewall_tests::test_conn_state_related));
    suite.add(TestCase::new("firewall_conn_state_invalid", firewall_tests::test_conn_state_invalid));
    suite.add(TestCase::new("firewall_conn_state_time_wait", firewall_tests::test_conn_state_time_wait));
    suite.add(TestCase::new("firewall_conn_state_equality", firewall_tests::test_conn_state_equality));
    ...
    suite.add(TestCase::new("firewall_format_ip_localhost", firewall_tests::test_format_ip_localhost));

    // SOCKS tests (20 tests)
    suite.add(TestCase::new("socks_error_connection_failed", socks_tests::test_socks_error_connection_failed));
    suite.add(TestCase::new("socks_error_auth_failed", socks_tests::test_socks_error_auth_failed));
    suite.add(TestCase::new("socks_error_target_unreachable", socks_tests::test_socks_error_target_unreachable));
    suite.add(TestCase::new("socks_error_timeout", socks_tests::test_socks_error_timeout));
    suite.add(TestCase::new("socks_error_protocol_error", socks_tests::test_socks_error_protocol_error));
    ...
    suite.add(TestCase::new("socks_error_message_connection_failed", socks_tests::test_error_message_connection_failed));
    suite.add(TestCase::new("socks_error_message_auth_failed", socks_tests::test_error_message_auth_failed));
    suite.add(TestCase::new("socks_error_message_target_unreachable", socks_tests::test_error_message_target_unreachable));
    suite.add(TestCase::new("socks_error_message_timeout", socks_tests::test_error_message_timeout));
    suite.add(TestCase::new("socks_error_message_protocol_error", socks_tests::test_error_message_protocol_error));
    suite.add(TestCase::new("socks_error_message_send_failed", socks_tests::test_error_message_send_failed));
    suite.add(TestCase::new("socks_error_message_recv_failed", socks_tests::test_error_message_recv_failed));
    suite.add(TestCase::new("socks_all_error_variants_distinct", socks_tests::test_all_error_variants_distinct));
    suite.add(TestCase::new("socks_all_error_messages_non_empty", socks_tests::test_all_error_messages_non_empty));

    // Ethernet tests (35 tests)
    suite.add(TestCase::new("ethernet_ethertype_ip_constant", ethernet_tests::test_ethertype_ip_constant));
    suite.add(TestCase::new("ethernet_ethertype_ipv6_constant", ethernet_tests::test_ethertype_ipv6_constant));
    suite.add(TestCase::new("ethernet_ethertype_arp_constant", ethernet_tests::test_ethertype_arp_constant));
    suite.add(TestCase::new("ethernet_ethertypes_unique", ethernet_tests::test_ethertypes_unique));
    suite.add(TestCase::new("ethernet_ethertype_ipv4_variant", ethernet_tests::test_ethertype_ipv4_variant));
    suite.add(TestCase::new("ethernet_ethertype_ipv6_variant", ethernet_tests::test_ethertype_ipv6_variant));
    suite.add(TestCase::new("ethernet_ethertype_arp_variant", ethernet_tests::test_ethertype_arp_variant));
    suite.add(TestCase::new("ethernet_ethertype_other_variant", ethernet_tests::test_ethertype_other_variant));
    suite.add(TestCase::new("ethernet_ethertype_from_u16_ipv4", ethernet_tests::test_ethertype_from_u16_ipv4));
    suite.add(TestCase::new("ethernet_ethertype_from_u16_ipv6", ethernet_tests::test_ethertype_from_u16_ipv6));
    suite.add(TestCase::new("ethernet_ethertype_from_u16_arp", ethernet_tests::test_ethertype_from_u16_arp));
    suite.add(TestCase::new("ethernet_ethertype_from_u16_other", ethernet_tests::test_ethertype_from_u16_other));
    suite.add(TestCase::new("ethernet_ethertype_from_u16_zero", ethernet_tests::test_ethertype_from_u16_zero));
    suite.add(TestCase::new("ethernet_ethertype_to_u16_ipv4", ethernet_tests::test_ethertype_to_u16_ipv4));
    suite.add(TestCase::new("ethernet_ethertype_to_u16_ipv6", ethernet_tests::test_ethertype_to_u16_ipv6));
    suite.add(TestCase::new("ethernet_ethertype_to_u16_arp", ethernet_tests::test_ethertype_to_u16_arp));
    suite.add(TestCase::new("ethernet_ethertype_to_u16_other", ethernet_tests::test_ethertype_to_u16_other));
    suite.add(TestCase::new("ethernet_ethertype_roundtrip_ipv4", ethernet_tests::test_ethertype_roundtrip_ipv4));
    suite.add(TestCase::new("ethernet_ethertype_roundtrip_ipv6", ethernet_tests::test_ethertype_roundtrip_ipv6));
    suite.add(TestCase::new("ethernet_ethertype_roundtrip_arp", ethernet_tests::test_ethertype_roundtrip_arp));
    suite.add(TestCase::new("ethernet_ethertype_roundtrip_other", ethernet_tests::test_ethertype_roundtrip_other));
    ...
    suite.add(TestCase::new("ethernet_ethertype_equality", ethernet_tests::test_ethertype_equality));
    suite.add(TestCase::new("ethernet_ethertype_inequality", ethernet_tests::test_ethertype_inequality));
    suite.add(TestCase::new("ethernet_ethertype_debug", ethernet_tests::test_ethertype_debug));
    suite.add(TestCase::new("ethernet_ethertype_debug_other", ethernet_tests::test_ethertype_debug_other));
    suite.add(TestCase::new("ethernet_ethertype_all_known_values", ethernet_tests::test_ethertype_all_known_values));
    suite.add(TestCase::new("ethernet_ethertype_from_all_known_values", ethernet_tests::test_ethertype_from_all_known_values));
    suite.add(TestCase::new("ethernet_ethertype_max_value", ethernet_tests::test_ethertype_max_value));
    suite.add(TestCase::new("ethernet_ethertype_common_protocols", ethernet_tests::test_ethertype_common_protocols));
    ...
    suite.add(TestCase::new("http_request_options_default", http_tests::test_http_request_options_default));
    suite.add(TestCase::new("http_request_options_with_method", http_tests::test_http_request_options_with_method));
    suite.add(TestCase::new("http_request_options_with_headers", http_tests::test_http_request_options_with_headers));
    suite.add(TestCase::new("http_request_options_with_body", http_tests::test_http_request_options_with_body));
    suite.add(TestCase::new("http_request_options_no_redirects", http_tests::test_http_request_options_no_redirects));
    suite.add(TestCase::new("http_request_options_custom_timeout", http_tests::test_http_request_options_custom_timeout));
    suite.add(TestCase::new("http_request_options_verbose", http_tests::test_http_request_options_verbose));
    suite.add(TestCase::new("http_request_options_no_keep_alive", http_tests::test_http_request_options_no_keep_alive));
    suite.add(TestCase::new("http_request_options_no_cookies", http_tests::test_http_request_options_no_cookies));
    suite.add(TestCase::new("http_request_options_clone", http_tests::test_http_request_options_clone));
    ...
    suite.add(TestCase::new("http_response_success_range", http_tests::test_http_response_success_range));
    suite.add(TestCase::new("http_response_not_success", http_tests::test_http_response_not_success));
    suite.add(TestCase::new("http_response_redirect_301", http_tests::test_http_response_redirect_301));
    suite.add(TestCase::new("http_response_redirect_302", http_tests::test_http_response_redirect_302));
    suite.add(TestCase::new("http_response_redirect_303", http_tests::test_http_response_redirect_303));
    suite.add(TestCase::new("http_response_redirect_307", http_tests::test_http_response_redirect_307));
    suite.add(TestCase::new("http_response_redirect_308", http_tests::test_http_response_redirect_308));
    suite.add(TestCase::new("http_response_not_redirect", http_tests::test_http_response_not_redirect));
    suite.add(TestCase::new("http_response_header_found", http_tests::test_http_response_header_found));
    suite.add(TestCase::new("http_response_header_not_found", http_tests::test_http_response_header_not_found));
    suite.add(TestCase::new("http_response_content_length", http_tests::test_http_response_content_length));
    suite.add(TestCase::new("http_response_content_length_none", http_tests::test_http_response_content_length_none));
    suite.add(TestCase::new("http_response_content_type", http_tests::test_http_response_content_type));
    ...
    suite.add(TestCase::new("http_response_body_text_invalid_utf8", http_tests::test_http_response_body_text_invalid_utf8));
    suite.add(TestCase::new("http_response_is_keep_alive_true", http_tests::test_http_response_is_keep_alive_true));
    suite.add(TestCase::new("http_response_is_keep_alive_false", http_tests::test_http_response_is_keep_alive_false));
    suite.add(TestCase::new("http_response_is_keep_alive_no_header", http_tests::test_http_response_is_keep_alive_no_header));
    suite.add(TestCase::new("http_response_set_cookie_headers", http_tests::test_http_response_set_cookie_headers));
    suite.add(TestCase::new("http_response_no_set_cookie_headers", http_tests::test_http_response_no_set_cookie_headers));
    ...
    suite.add(TestCase::new("boot_config_privacy_mode_standard", boot_config_tests::test_privacy_mode_standard));
    suite.add(TestCase::new("boot_config_privacy_mode_tor_only", boot_config_tests::test_privacy_mode_tor_only));
    suite.add(TestCase::new("boot_config_privacy_mode_maximum", boot_config_tests::test_privacy_mode_maximum));
    suite.add(TestCase::new("boot_config_privacy_mode_isolated", boot_config_tests::test_privacy_mode_isolated));
    suite.add(TestCase::new("boot_config_privacy_mode_from_u8_standard", boot_config_tests::test_privacy_mode_from_u8_standard));
    suite.add(TestCase::new("boot_config_privacy_mode_from_u8_tor_only", boot_config_tests::test_privacy_mode_from_u8_tor_only));
    suite.add(TestCase::new("boot_config_privacy_mode_from_u8_maximum", boot_config_tests::test_privacy_mode_from_u8_maximum));
    suite.add(TestCase::new("boot_config_privacy_mode_from_u8_isolated", boot_config_tests::test_privacy_mode_from_u8_isolated));
    suite.add(TestCase::new("boot_config_privacy_mode_from_u8_invalid", boot_config_tests::test_privacy_mode_from_u8_invalid));
    suite.add(TestCase::new("boot_config_privacy_mode_clone", boot_config_tests::test_privacy_mode_clone));
    suite.add(TestCase::new("boot_config_privacy_mode_copy", boot_config_tests::test_privacy_mode_copy));
    suite.add(TestCase::new("boot_config_privacy_mode_equality", boot_config_tests::test_privacy_mode_equality));
    suite.add(TestCase::new("boot_config_privacy_mode_debug", boot_config_tests::test_privacy_mode_debug));
    suite.add(TestCase::new("boot_config_dns_mode_dhcp", boot_config_tests::test_dns_mode_dhcp));
    suite.add(TestCase::new("boot_config_dns_mode_custom", boot_config_tests::test_dns_mode_custom));
    suite.add(TestCase::new("boot_config_dns_mode_tor_dns", boot_config_tests::test_dns_mode_tor_dns));
    ...
    suite.add(TestCase::new("boot_config_dns_mode_equality", boot_config_tests::test_dns_mode_equality));
    suite.add(TestCase::new("boot_config_dns_mode_debug", boot_config_tests::test_dns_mode_debug));
    suite.add(TestCase::new("boot_config_ipv4_config_default", boot_config_tests::test_ipv4_config_default));
    suite.add(TestCase::new("boot_config_ipv4_config_fields", boot_config_tests::test_ipv4_config_fields));
    suite.add(TestCase::new("boot_config_ipv4_config_clone", boot_config_tests::test_ipv4_config_clone));
    suite.add(TestCase::new("boot_config_ipv4_config_no_gateway", boot_config_tests::test_ipv4_config_no_gateway));
    suite.add(TestCase::new("boot_config_onion_config_default", boot_config_tests::test_onion_config_default));
    suite.add(TestCase::new("boot_config_onion_config_fields", boot_config_tests::test_onion_config_fields));
    suite.add(TestCase::new("boot_config_onion_config_clone", boot_config_tests::test_onion_config_clone));
    suite.add(TestCase::new("boot_config_firewall_config_default", boot_config_tests::test_firewall_config_default));
    suite.add(TestCase::new("boot_config_firewall_config_fields", boot_config_tests::test_firewall_config_fields));
    suite.add(TestCase::new("boot_config_firewall_config_clone", boot_config_tests::test_firewall_config_clone));
    suite.add(TestCase::new("boot_config_firewall_config_blocked_range", boot_config_tests::test_firewall_config_blocked_range));
    suite.add(TestCase::new("boot_config_network_boot_config_default", boot_config_tests::test_network_boot_config_default));
    suite.add(TestCase::new("boot_config_network_boot_config_fields", boot_config_tests::test_network_boot_config_fields));
    suite.add(TestCase::new("boot_config_network_boot_config_clone", boot_config_tests::test_network_boot_config_clone));
    suite.add(TestCase::new("boot_config_network_boot_config_isolated", boot_config_tests::test_network_boot_config_isolated));
    suite.add(TestCase::new("boot_config_network_boot_config_tor_mode", boot_config_tests::test_network_boot_config_tor_mode));
    suite.add(TestCase::new("boot_config_privacy_mode_all_variants", boot_config_tests::test_privacy_mode_all_variants));
    suite.add(TestCase::new("boot_config_dns_mode_all_variants", boot_config_tests::test_dns_mode_all_variants));
    suite.add(TestCase::new("boot_config_ipv4_config_debug", boot_config_tests::test_ipv4_config_debug));
    suite.add(TestCase::new("boot_config_onion_config_debug", boot_config_tests::test_onion_config_debug));
    suite.add(TestCase::new("boot_config_firewall_config_debug", boot_config_tests::test_firewall_config_debug));
    suite.add(TestCase::new("boot_config_network_boot_config_debug", boot_config_tests::test_network_boot_config_debug));
    ...
    suite.add(TestCase::new("nym_max_hops_equals_mix_layers", nym_tests::test_nym_max_hops_equals_mix_layers));
    suite.add(TestCase::new("nym_mixnode_id_from_bytes", nym_tests::test_mixnode_id_from_bytes));
    suite.add(TestCase::new("nym_mixnode_id_from_bytes_wrong_size", nym_tests::test_mixnode_id_from_bytes_wrong_size));
    ...
    suite.add(TestCase::new("nym_gateway_id_from_bytes_wrong_size", nym_tests::test_gateway_id_from_bytes_wrong_size));
    ...
    suite.add(TestCase::new("nym_client_id_from_bytes_wrong_size", nym_tests::test_client_id_from_bytes_wrong_size));
    ...
    suite.add(TestCase::new("nym_surb_id_from_bytes_wrong_size", nym_tests::test_surb_id_from_bytes_wrong_size));
    ...
    suite.add(TestCase::new("nym_address_from_bytes_wrong_size", nym_tests::test_nym_address_from_bytes_wrong_size));
    ...
    suite.add(TestCase::new("nym_error_not_initialized", nym_tests::test_nym_error_not_initialized));
    suite.add(TestCase::new("nym_error_already_initialized", nym_tests::test_nym_error_already_initialized));
    suite.add(TestCase::new("nym_error_connection_failed", nym_tests::test_nym_error_connection_failed));
    suite.add(TestCase::new("nym_error_not_connected", nym_tests::test_nym_error_not_connected));
    suite.add(TestCase::new("nym_error_handshake_failed", nym_tests::test_nym_error_handshake_failed));
    ...
    suite.add(TestCase::new("nym_error_gateway_not_found", nym_tests::test_nym_error_gateway_not_found));
    suite.add(TestCase::new("nym_error_mixnode_not_found", nym_tests::test_nym_error_mixnode_not_found));
    ...
    suite.add(TestCase::new("nym_error_packet_too_large", nym_tests::test_nym_error_packet_too_large));
    suite.add(TestCase::new("nym_error_encryption_failed", nym_tests::test_nym_error_encryption_failed));
    suite.add(TestCase::new("nym_error_decryption_failed", nym_tests::test_nym_error_decryption_failed));
    ...
    suite.add(TestCase::new("nym_error_invalid_payload", nym_tests::test_nym_error_invalid_payload));
    suite.add(TestCase::new("nym_error_invalid_surb", nym_tests::test_nym_error_invalid_surb));
    suite.add(TestCase::new("nym_error_no_available_mixnodes", nym_tests::test_nym_error_no_available_mixnodes));
    suite.add(TestCase::new("nym_error_no_available_gateways", nym_tests::test_nym_error_no_available_gateways));
    suite.add(TestCase::new("nym_error_directory_fetch_failed", nym_tests::test_nym_error_directory_fetch_failed));
    ...
    suite.add(TestCase::new("nym_error_invalid_address", nym_tests::test_nym_error_invalid_address));
    ...
    suite.add(TestCase::new("stack_tcp_socket_from_connection", stack_tests::test_tcp_socket_from_connection));
    suite.add(TestCase::new("stack_tcp_socket_remote_port", stack_tests::test_tcp_socket_remote_port));
    suite.add(TestCase::new("stack_tcp_socket_clone", stack_tests::test_tcp_socket_clone));
    suite.add(TestCase::new("stack_tcp_socket_increments_id", stack_tests::test_tcp_socket_increments_id));
    ...
    suite.add(TestCase::new("stack_socket_for_connection", stack_tests::test_socket_for_connection));
    suite.add(TestCase::new("stack_socket_clone", stack_tests::test_socket_clone));
    suite.add(TestCase::new("stack_network_stats_default", stack_tests::test_network_stats_default));
    ...
    suite.add(TestCase::new("stack_socket_info_with_error", stack_tests::test_socket_info_with_error));
    ...
    suite.add(TestCase::new("stack_dhcp_lease_short_time", stack_tests::test_dhcp_lease_short_time));
