...
pub fn test_udp_stats_default() -> TestResult {
    ...
    if stats.bytes_sent != 0 { return TestResult::Fail; }
    if stats.bytes_received != 0 { return TestResult::Fail; }
...
pub fn test_udp_stats_fields() -> TestResult {
    ...
    if stats.packets_sent != 100 { return TestResult::Fail; }
    if stats.packets_received != 150 { return TestResult::Fail; }
    if stats.bytes_sent != 5000 { return TestResult::Fail; }
    if stats.bytes_received != 7500 { return TestResult::Fail; }
    if stats.errors != 2 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_udp_stats_clone() -> TestResult {
    ...
    if stats.packets_sent != cloned.packets_sent { return TestResult::Fail; }
    if stats.packets_received != cloned.packets_received { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_udp_header_parse_valid() -> TestResult {
    ...
    if header.src_port != 12345 { return TestResult::Fail; }
    if header.dst_port != 80 { return TestResult::Fail; }
    if header.length != 16 { return TestResult::Fail; }
    if header.checksum != 0xABCD { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_udp_header_parse_exact_size() -> TestResult {
    ...
    if header.src_port != 53 { return TestResult::Fail; }
    if header.dst_port != 53 { return TestResult::Fail; }
    if header.length != 8 { return TestResult::Fail; }
    if header.checksum != 0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_udp_header_serialize() -> TestResult {
    ...
    if bytes[0] != 0x30 { return TestResult::Fail; }
    if bytes[1] != 0x39 { return TestResult::Fail; }
    if bytes[2] != 0x00 { return TestResult::Fail; }
    if bytes[3] != 0x50 { return TestResult::Fail; }
    if bytes[4] != 0x00 { return TestResult::Fail; }
    if bytes[5] != 0x10 { return TestResult::Fail; }
    if bytes[6] != 0xAB { return TestResult::Fail; }
    if bytes[7] != 0xCD { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_udp_header_serialize_roundtrip() -> TestResult {
    ...
    if original.src_port != parsed.src_port { return TestResult::Fail; }
    if original.dst_port != parsed.dst_port { return TestResult::Fail; }
    if original.length != parsed.length { return TestResult::Fail; }
    if original.checksum != parsed.checksum { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_udp_header_max_port() -> TestResult {
    ...
    if parsed.src_port != 65535 { return TestResult::Fail; }
    if parsed.dst_port != 65535 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_udp_packet_fields() -> TestResult {
    ...
    if packet.src_addr != [192, 168, 1, 1] { return TestResult::Fail; }
    if packet.src_port != 12345 { return TestResult::Fail; }
    if packet.data != vec![1, 2, 3, 4] { return TestResult::Fail; }
    if packet.timestamp != 1000 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_udp_packet_clone() -> TestResult {
    ...
    if packet.src_addr != cloned.src_addr { return TestResult::Fail; }
    if packet.src_port != cloned.src_port { return TestResult::Fail; }
    if packet.data != cloned.data { return TestResult::Fail; }
    if packet.timestamp != cloned.timestamp { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_udp_packet_empty_data() -> TestResult {
    ...
    if !packet.data.is_empty() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_udp_header_calculate_checksum() -> TestResult {
    ...
    if checksum == 0 { return TestResult::Fail; }
    TestResult::Pass
}
