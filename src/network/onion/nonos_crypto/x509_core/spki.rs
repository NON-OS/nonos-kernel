...
pub(super) fn parse_subject_public_key_info(parser: &mut DerParser) -> Result<PublicKeyInfo, OnionError> {
...
pub(in crate::network::onion::nonos_crypto) fn parse_spki_der(spki_der: &[u8]) -> Result<PublicKeyInfo, OnionError> {
