...
pub fn test_try_recover_fault_with_handler() -> TestResult {
    ...
    if result != Some(0xDEAD_BEEF) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_multiple_set_fault_handler_overwrites() -> TestResult {
    ...
    let result = try_recover_fault();
    if result != Some(0x2000) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_try_recover_fault_idempotent() -> TestResult {
    ...
    if result1 != result2 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_clear_then_set_fault_handler() -> TestResult {
    ...
    let result = try_recover_fault();
    if result != Some(0x3000) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_set_fault_handler_sequence() -> TestResult {
    for i in 0..10 {
        ...
        let result = try_recover_fault();
        if result != Some(i * 0x1000) { return TestResult::Fail; }
    }
    TestResult::Pass
}
...
pub fn test_fault_handler_boundary_values() -> TestResult {
    ...
    for &val in &values {
        ...
        let result = try_recover_fault();
        if result != Some(val) { return TestResult::Fail; }
    }
    TestResult::Pass
}
...
pub fn test_fault_handler_power_of_two_addresses() -> TestResult {
    for i in 0..48 {
        ...
        let result = try_recover_fault();
        if result != Some(addr) { return TestResult::Fail; }
    }
    TestResult::Pass
}
