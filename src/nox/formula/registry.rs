...
impl FormulaRegistry {
    ...
    pub fn get(&self, name: &str) -> Option<&Formula> { self.formulas.get(name) }
    ...
    pub fn mark_installed(&mut self, formula: Formula, path: String, as_dep: bool) {
        ...
        self.installed.insert(name, InstalledFormula {
            formula, install_time: 0, install_path: path,
            linked: true, pinned: false, installed_as_dependency: as_dep,
        });
    }
