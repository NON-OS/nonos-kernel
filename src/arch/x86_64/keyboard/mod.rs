...
//!
//! Production-grade keyboard handling with scan code translation and event
//! processing

use crate::arch::x86_64::port::{inb, outb};
use crate::ui::event::{publish, Event, Pri};
use spin::Mutex;
...
pub fn handle_keyboard_interrupt() {
    ...
    match scan_code {
        ...
        _ if !key_released => {
            // Handle regular keys
            let ascii =
                if state.shift_pressed || (state.caps_lock && scan_code >= 16 && scan_code <= 25) {
