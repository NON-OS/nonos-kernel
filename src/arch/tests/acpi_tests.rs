...
pub(crate) fn test_table_signatures() -> TestResult {
    ...
    if SIG_MCFG != *b"MCFG" { return TestResult::Fail; }
    if SIG_RSDT != *b"RSDT" { return TestResult::Fail; }
    if SIG_XSDT != *b"XSDT" { return TestResult::Fail; }
    if SIG_SRAT != *b"SRAT" { return TestResult::Fail; }
    if SIG_SLIT != *b"SLIT" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_pm_profile_variants() -> TestResult {
    ...
    if PmProfile::Workstation as u8 != 3 { return TestResult::Fail; }
    if PmProfile::EnterpriseServer as u8 != 4 { return TestResult::Fail; }
    if PmProfile::SohoServer as u8 != 5 { return TestResult::Fail; }
    if PmProfile::AppliancePc as u8 != 6 { return TestResult::Fail; }
    if PmProfile::PerformanceServer as u8 != 7 { return TestResult::Fail; }
    if PmProfile::Tablet as u8 != 8 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_madt_entry_types() -> TestResult {
    ...
    if MadtEntryType::NmiSource as u8 != 3 { return TestResult::Fail; }
    if MadtEntryType::LocalApicNmi as u8 != 4 { return TestResult::Fail; }
    if MadtEntryType::LocalApicOverride as u8 != 5 { return TestResult::Fail; }
    if MadtEntryType::LocalX2Apic as u8 != 9 { return TestResult::Fail; }
    if MadtEntryType::LocalX2ApicNmi as u8 != 10 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_address_space_variants() -> TestResult {
    ...
    if AddressSpace::EmbeddedController as u8 != 3 { return TestResult::Fail; }
    if AddressSpace::SmBus as u8 != 4 { return TestResult::Fail; }
    if AddressSpace::Cmos as u8 != 5 { return TestResult::Fail; }
    if AddressSpace::PciBar as u8 != 6 { return TestResult::Fail; }
    if AddressSpace::Ipmi as u8 != 7 { return TestResult::Fail; }
    if AddressSpace::GeneralIo as u8 != 8 { return TestResult::Fail; }
    if AddressSpace::FunctionalFixed as u8 != 0x7F { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_signatures_are_4_bytes() -> TestResult {
    ...
    if SIG_MCFG.len() != 4 { return TestResult::Fail; }
    if SIG_RSDT.len() != 4 { return TestResult::Fail; }
    if SIG_XSDT.len() != 4 { return TestResult::Fail; }
    TestResult::Pass
}
