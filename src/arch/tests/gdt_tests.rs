...
pub fn test_gdt_constants() -> TestResult {
    ...
    if DEFAULT_STACK_SIZE != 16384 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_segment_selectors() -> TestResult {
    ...
    if SEL_TSS != 0x28 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_ist_indices_valid() -> TestResult {
    ...
    if IST_DEBUG == 0 || IST_DEBUG > IST_COUNT { return TestResult::Fail; }
    if IST_PAGE_FAULT == 0 || IST_PAGE_FAULT > IST_COUNT { return TestResult::Fail; }
    if IST_GP == 0 || IST_GP > IST_COUNT { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_gdt_entry_null() -> TestResult {
    ...
    if entry.base_mid != 0 { return TestResult::Fail; }
    if entry.access != 0 { return TestResult::Fail; }
    if entry.granularity != 0 { return TestResult::Fail; }
    if entry.base_high != 0 { return TestResult::Fail; }
...
pub fn test_gdt_entry_kernel_code() -> TestResult {
    ...
    if !entry.is_code() { return TestResult::Fail; }
    if !entry.is_long_mode() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_gdt_entry_new() -> TestResult {
    ...
    if entry.base_high != 0x12 { return TestResult::Fail; }
    if entry.limit_low != 0xBCDE { return TestResult::Fail; }
    if entry.access != 0x9A { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_gdt_entry_clone() -> TestResult {
    ...
    if entry1.granularity != entry2.granularity { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_selector_alignment() -> TestResult {
    ...
    if (SEL_USER_CODE & !0x03) % 8 != 0 { return TestResult::Fail; }
    if (SEL_USER_DATA & !0x03) % 8 != 0 { return TestResult::Fail; }
    if (SEL_TSS & !0x03) % 8 != 0 { return TestResult::Fail; }
    TestResult::Pass
}
