...
impl G2FieldElement {
    ...
    pub fn frobenius_coeff_x_2() -> Self {
        G2FieldElement { c0: FieldElement::from_limbs([0x5033a4b3d8d18c8c, 0x285c512fe7e6c4b9, 0xf1495f6b8b30ba53, 0x30644e72e131a028]), c1: FieldElement::zero() }
    }
    ...
    pub fn frobenius_coeff_y_2() -> Self {
        G2FieldElement { c0: FieldElement::from_limbs([0x59e26bcea0d48bac, 0x0, 0x0, 0x0]), c1: FieldElement::zero() }
    }
    ...
    pub fn frobenius_coeff_fp12_sq() -> Self {
        G2FieldElement { c0: FieldElement::from_limbs([0x30644e72e131a029, 0x0, 0x0, 0x0]), c1: FieldElement::zero() }
    }
    pub fn frobenius_coeff_fp12_cub() -> Self {
        G2FieldElement { c0: FieldElement::from_limbs([0x59e26bcea0d48ba6, 0x0, 0x0, 0x0]), c1: FieldElement::from_limbs([0x0, 0x0, 0x0, 0x0]) }
    }
}
