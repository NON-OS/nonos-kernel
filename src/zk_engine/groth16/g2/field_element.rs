...
impl G2FieldElement {
    ...
    pub fn from_base_field(base: &FieldElement) -> Self { G2FieldElement { c0: *base, c1: FieldElement::zero() } }
    pub fn from_base(e: FieldElement) -> Self { G2FieldElement { c0: e, c1: FieldElement::zero() } }
    pub fn is_zero(&self) -> bool { self.c0.is_zero() && self.c1.is_zero() }
    pub fn add(&self, other: &G2FieldElement) -> G2FieldElement { G2FieldElement { c0: self.c0.add(&other.c0), c1: self.c1.add(&other.c1) } }
    pub fn sub(&self, other: &G2FieldElement) -> G2FieldElement { G2FieldElement { c0: self.c0.sub(&other.c0), c1: self.c1.sub(&other.c1) } }
    ...
    pub fn double(&self) -> G2FieldElement { self.add(self) }
    pub fn neg(&self) -> G2FieldElement { G2FieldElement { c0: self.c0.neg(), c1: self.c1.neg() } }
    ...
    pub fn inverse_unchecked(&self) -> Self { self.inverse().unwrap_or(G2FieldElement::zero()) }
    pub fn conjugate(&self) -> G2FieldElement { G2FieldElement { c0: self.c0, c1: self.c1.neg() } }
}

impl PartialEq for G2FieldElement {
    fn eq(&self, other: &Self) -> bool { self.c0 == other.c0 && self.c1 == other.c1 }
}
