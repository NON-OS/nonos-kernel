...
pub fn test_field_element_add_commutative() -> TestResult {
    ...
    let ab = a.add(&b);
    let ba = b.add(&a);
    if !ab.equals(&ba) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_field_element_square() -> TestResult {
    ...
    let square = a.square();
    let manual = a.mul(&a);
    if !square.equals(&manual) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_field_element_double() -> TestResult {
    ...
    let manual = a.add(&a);
    if !doubled.equals(&manual) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_field_element_inverse() -> TestResult {
    ...
    if !product.equals(&FieldElement::one()) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_field_element_sqrt_perfect_square() -> TestResult {
    ...
    if let Some(root) = sqrt {
        ...
        if !squared.equals(&a) { return TestResult::Fail; }
    }
    TestResult::Pass
}
...
pub fn test_field_element_to_bytes_from_bytes_roundtrip() -> TestResult {
    ...
    if !a.equals(&recovered) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_field_element_montgomery_conversion_roundtrip() -> TestResult {
    ...
    if raw.limbs != back.limbs { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_g1_point_negate() -> TestResult {
    ...
    let neg = gen.negate();
    let sum = gen.add(&neg);
    if !sum.is_infinity() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_g1_point_double() -> TestResult {
    ...
    if let (Some((dx, dy)), Some((mx, my))) = (d_coords, m_coords) {
        if !dx.equals(&mx) { return TestResult::Fail; }
        if !dy.equals(&my) { return TestResult::Fail; }
    }
    TestResult::Pass
}
...
pub fn test_g1_point_scalar_mul_one() -> TestResult {
    ...
    if let (Some((gx, gy)), Some((rx, ry))) = (gen_coords, result_coords) {
        if !gx.equals(&rx) { return TestResult::Fail; }
        if !gy.equals(&ry) { return TestResult::Fail; }
    }
    TestResult::Pass
}
...
pub fn test_g1_point_to_bytes_from_bytes_roundtrip() -> TestResult {
    ...
    if recovered.is_infinity() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_g2_field_element_from_base_field() -> TestResult {
    ...
    if !g2fe.c1.is_zero() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_g2_field_element_conjugate() -> TestResult {
    ...
    if !conj.c0.equals(&a.c0) { return TestResult::Fail; }
    if !conj.c1.equals(&a.c1.neg()) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_g2_point_double() -> TestResult {
    ...
    let manual = gen.add(&gen);
    if doubled.is_infinity() { return TestResult::Fail; }
    if manual.is_infinity() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_g2_point_serialize_deserialize() -> TestResult {
    ...
    if deserialized.is_infinity() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_g2_affine_neg() -> TestResult {
    ...
    if neg_affine.x != affine.x { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_linear_combination_from_variable() -> TestResult {
    ...
    if !lc.terms.contains_key(&v) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_linear_combination_from_constant() -> TestResult {
    ...
    if lc.terms.len() != 1 { return TestResult::Fail; }
    if !lc.terms.contains_key(&Variable::ONE) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_linear_combination_add() -> TestResult {
    ...
    lc1.add(&lc2);
    if lc1.terms.len() != 2 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_linear_combination_evaluate_variable() -> TestResult {
    ...
    if !result.equals(&FieldElement::from_u64(10)) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_linear_combination_evaluate_out_of_bounds() -> TestResult {
    ...
    let lc = LinearCombination::from_variable(v);
    let assignment = vec![FieldElement::from_u64(10)];
    if lc.evaluate(&assignment).is_ok() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_constraint_enforce_multiplication() -> TestResult {
    ...
    if constraint.a.terms.is_empty() { return TestResult::Fail; }
    if constraint.b.terms.is_empty() { return TestResult::Fail; }
    if constraint.c.terms.is_empty() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_circuit_new() -> TestResult {
    ...
    if circuit.num_inputs != 0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_circuit_with_params() -> TestResult {
    ...
    if circuit.num_variables != 3 { return TestResult::Fail; }
...
pub fn test_circuit_get_matrices() -> TestResult {
    ...
    if a.len() != 1 { return TestResult::Fail; }
    if b.len() != 1 { return TestResult::Fail; }
    if c.len() != 1 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_circuit_builder_new() -> TestResult {
    ...
    if builder.num_inputs != 0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_circuit_builder_alloc_variable() -> TestResult {
    ...
    if !builder.variable_names.contains_key(&v) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_circuit_builder_alloc_variable_no_name() -> TestResult {
    ...
    if builder.num_variables != 1 { return TestResult::Fail; }
    if !builder.variable_names.is_empty() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_circuit_builder_alloc_input() -> TestResult {
    ...
    if builder.num_variables != 1 { return TestResult::Fail; }
    if builder.num_inputs != 1 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_circuit_builder_enforce_constraint() -> TestResult {
    ...
    if builder.constraints.len() != 1 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_circuit_builder_add_range_constraint() -> TestResult {
    ...
    if builder.constraints.len() <= 0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_circuit_optimizer_keeps_nontrivial() -> TestResult {
    ...
    let optimized = CircuitOptimizer::optimize(circuit);
    if optimized.constraints.len() != 1 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_proof_new() -> TestResult {
    ...
    if proof.circuit_id != 42 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_proof_serialize_deserialize() -> TestResult {
    ...
    if deserialized.circuit_id != 123 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_proof_is_valid_structure_valid() -> TestResult {
    ...
    if !proof.is_valid_structure() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_verifying_key_verify_key_valid() -> TestResult {
    ...
    if !vk.verify_key().unwrap() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_verification_cache_insert_get() -> TestResult {
    ...
    if cache.get(&key) != Some(true) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_verification_cache_len() -> TestResult {
    ...
    if cache.len() != 2 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_verification_cache_evict_oldest() -> TestResult {
    ...
    if cache.len() != 5 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_verification_result_success() -> TestResult {
    ...
    if result.timing_ms != 100 { return TestResult::Fail; }
    if result.pairing_checks != 4 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_verification_result_failure() -> TestResult {
    ...
    if result.timing_ms != 50 { return TestResult::Fail; }
    if result.pairing_checks != 0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_verification_stats_default() -> TestResult {
    ...
    if stats.failed_verifications != 0 { return TestResult::Fail; }
    if stats.avg_verification_time_ms != 0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_verification_key_manager_add_key() -> TestResult {
    ...
    if manager.add_key(1, vk).is_err() { return TestResult::Fail; }
    if manager.key_count() != 1 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_verification_key_manager_get_key() -> TestResult {
    ...
    if manager.get_key(42).is_none() { return TestResult::Fail; }
    if manager.get_key(99).is_some() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_verification_key_manager_list_circuits() -> TestResult {
    ...
    if circuits.len() != 2 { return TestResult::Fail; }
    if !circuits.contains(&1) { return TestResult::Fail; }
    if !circuits.contains(&2) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_merkle_verifier_verify_membership_single() -> TestResult {
    ...
    let root = leaf;
    let proof: &[[u8; 32]] = &[];
    if !MerkleVerifier::verify_membership(&root, &leaf, proof, 0) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_syscall_constants() -> TestResult {
    ...
    if SYS_ZK_GET_STATS != 403 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_syscall_limits() -> TestResult {
    ...
    if MAX_CONSTRAINTS <= 0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_deserialize_witness_valid() -> TestResult {
    ...
    let result = deserialize_witness(&data).unwrap();
    if result.len() != 1 { return TestResult::Fail; }
    if result[0] != vec![1, 2, 3, 4] { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_kernel_measurement_new() -> TestResult {
    ...
    if measurement.config_hash != [0u8; 32] { return TestResult::Fail; }
    if !measurement.module_hashes.is_empty() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_memory_layout_default() -> TestResult {
    ...
    if layout.user_start.as_u64() != 0 { return TestResult::Fail; }
    if layout.user_end.as_u64() != 0 { return TestResult::Fail; }
    if layout.heap_start.as_u64() != 0 { return TestResult::Fail; }
    if layout.heap_end.as_u64() != 0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_zk_config_default() -> TestResult {
    ...
    if !config.enable_preprocessing { return TestResult::Fail; }
    if !config.enable_verification_cache { return TestResult::Fail; }
    if config.trusted_setup_path.is_some() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_zk_error_variants() -> TestResult {
    ...
    if errors.len() != 16 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_range_proof_structure() -> TestResult {
    ...
    if proof.bit_length != 64 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_g1_point_from_affine() -> TestResult {
    ...
    if point.is_infinity() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_proof_clone() -> TestResult {
    ...
    if proof.circuit_id != cloned.circuit_id { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_field_element_sub_assign() -> TestResult {
    ...
    if a[0] != 7 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_field_element_add_assign() -> TestResult {
    ...
    if a[0] != 13 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_g1_point_neg_vs_negate() -> TestResult {
    ...
    if let (Some((x1, y1)), Some((x2, y2))) = (coords1, coords2) {
        if !x1.equals(&x2) { return TestResult::Fail; }
        if !y1.equals(&y2) { return TestResult::Fail; }
    }
    TestResult::Pass
}
...
pub fn test_groth16_verifier_new() -> TestResult {
    ...
    if !verifier.verifying_key.verify_key().unwrap() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_linear_combination_multiple_terms() -> TestResult {
    ...
    if lc.terms.len() != 3 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_g2_field_element_mul_complex() -> TestResult {
    ...
    let c = a.mul(&b);
    if c.is_zero() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_fp6_element_zero() -> TestResult {
    ...
    if !zero.c2.is_zero() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_pairing_bilinearity_property() -> TestResult {
    ...
    if !e_2g1_g2.equals(&e_g1_g2_squared) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_module_hash_structure() -> TestResult {
    ...
    if mh.name != "test_module" { return TestResult::Fail; }
    if mh.hash[0] != 0xAB { return TestResult::Fail; }
    if mh.address.as_u64() != 0x1000 { return TestResult::Fail; }
    if mh.size != 4096 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_field_element_distributive() -> TestResult {
    ...
    if !left.equals(&right) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_g1_point_associative_add() -> TestResult {
    ...
    if let (Some((lx, ly)), Some((rx, ry))) = (left_coords, right_coords) {
        if !lx.equals(&rx) { return TestResult::Fail; }
        if !ly.equals(&ry) { return TestResult::Fail; }
    }
    TestResult::Pass
}
...
pub fn test_g2_point_associative_add() -> TestResult {
    ...
    let left = p.add(&q).add(&r);
    let right = p.add(&q.add(&r));
    if left.is_infinity() { return TestResult::Fail; }
    if right.is_infinity() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn run_all() -> bool {
    ...
    suite.add(TestCase::new("field_element_inverse_zero_returns_none", test_field_element_inverse_zero_returns_none));
    ...
    suite.add(TestCase::new("field_element_sqrt_perfect_square", test_field_element_sqrt_perfect_square));
    suite.add(TestCase::new("field_element_sqrt_zero", test_field_element_sqrt_zero));
    suite.add(TestCase::new("field_element_to_bytes_from_bytes_roundtrip", test_field_element_to_bytes_from_bytes_roundtrip));
    suite.add(TestCase::new("field_element_from_bytes_too_short", test_field_element_from_bytes_too_short));
    ...
    suite.add(TestCase::new("field_element_montgomery_conversion_roundtrip", test_field_element_montgomery_conversion_roundtrip));
    ...
    suite.add(TestCase::new("g1_point_to_bytes_from_bytes_roundtrip", test_g1_point_to_bytes_from_bytes_roundtrip));
    ...
    suite.add(TestCase::new("g2_field_element_from_base_field", test_g2_field_element_from_base_field));
    suite.add(TestCase::new("g2_field_element_add_zero", test_g2_field_element_add_zero));
    suite.add(TestCase::new("g2_field_element_sub_self_is_zero", test_g2_field_element_sub_self_is_zero));
    ...
    suite.add(TestCase::new("g2_field_element_inverse_zero_returns_none", test_g2_field_element_inverse_zero_returns_none));
    ...
    suite.add(TestCase::new("g2_point_to_bytes_from_bytes_roundtrip", test_g2_point_to_bytes_from_bytes_roundtrip));
    ...
    suite.add(TestCase::new("linear_combination_from_variable", test_linear_combination_from_variable));
    suite.add(TestCase::new("linear_combination_from_constant", test_linear_combination_from_constant));
    suite.add(TestCase::new("linear_combination_from_constant_zero", test_linear_combination_from_constant_zero));
    suite.add(TestCase::new("linear_combination_add_term", test_linear_combination_add_term));
    suite.add(TestCase::new("linear_combination_add_term_zero_coefficient", test_linear_combination_add_term_zero_coefficient));
    suite.add(TestCase::new("linear_combination_add_term_cancellation", test_linear_combination_add_term_cancellation));
    ...
    suite.add(TestCase::new("linear_combination_evaluate_constant", test_linear_combination_evaluate_constant));
    suite.add(TestCase::new("linear_combination_evaluate_variable", test_linear_combination_evaluate_variable));
    suite.add(TestCase::new("linear_combination_evaluate_out_of_bounds", test_linear_combination_evaluate_out_of_bounds));
    suite.add(TestCase::new("linear_combination_multiple_terms", test_linear_combination_multiple_terms));
    ...
    suite.add(TestCase::new("constraint_enforce_multiplication", test_constraint_enforce_multiplication));
    suite.add(TestCase::new("constraint_default_multiplication", test_constraint_default_multiplication));
    ...
    suite.add(TestCase::new("circuit_verify_assignment_empty", test_circuit_verify_assignment_empty));
    suite.add(TestCase::new("circuit_verify_assignment_wrong_length", test_circuit_verify_assignment_wrong_length));
    suite.add(TestCase::new("circuit_clone", test_circuit_clone));
    suite.add(TestCase::new("circuit_compute_witness_map_wrong_inputs", test_circuit_compute_witness_map_wrong_inputs));
    ...
    suite.add(TestCase::new("circuit_builder_alloc_variable_no_name", test_circuit_builder_alloc_variable_no_name));
    suite.add(TestCase::new("circuit_builder_alloc_input", test_circuit_builder_alloc_input));
    suite.add(TestCase::new("circuit_builder_enforce_constraint", test_circuit_builder_enforce_constraint));
    suite.add(TestCase::new("circuit_builder_enforce_equal", test_circuit_builder_enforce_equal));
    suite.add(TestCase::new("circuit_builder_enforce_multiplication", test_circuit_builder_enforce_multiplication));
    suite.add(TestCase::new("circuit_builder_add_boolean_constraint", test_circuit_builder_add_boolean_constraint));
    suite.add(TestCase::new("circuit_builder_add_range_constraint", test_circuit_builder_add_range_constraint));
    ...
    suite.add(TestCase::new("circuit_optimizer_optimize_empty", test_circuit_optimizer_optimize_empty));
    suite.add(TestCase::new("circuit_optimizer_removes_trivial", test_circuit_optimizer_removes_trivial));
    suite.add(TestCase::new("circuit_optimizer_keeps_nontrivial", test_circuit_optimizer_keeps_nontrivial));
    ...
    suite.add(TestCase::new("proof_is_valid_structure_invalid_a", test_proof_is_valid_structure_invalid_a));
    suite.add(TestCase::new("proof_is_valid_structure_invalid_b", test_proof_is_valid_structure_invalid_b));
    suite.add(TestCase::new("proof_is_valid_structure_invalid_c", test_proof_is_valid_structure_invalid_c));
    ...
    suite.add(TestCase::new("verifying_key_verify_key_invalid_alpha", test_verifying_key_verify_key_invalid_alpha));
    suite.add(TestCase::new("verifying_key_verify_key_invalid_beta", test_verifying_key_verify_key_invalid_beta));
    suite.add(TestCase::new("verifying_key_verify_key_empty_ic", test_verifying_key_verify_key_empty_ic));
    ...
    suite.add(TestCase::new("verification_cache_evict_oldest", test_verification_cache_evict_oldest));
    suite.add(TestCase::new("compute_cache_key_deterministic", test_compute_cache_key_deterministic));
    suite.add(TestCase::new("compute_cache_key_different_circuit_id", test_compute_cache_key_different_circuit_id));
    ...
    suite.add(TestCase::new("verification_key_manager_add_key", test_verification_key_manager_add_key));
    suite.add(TestCase::new("verification_key_manager_get_key", test_verification_key_manager_get_key));
    suite.add(TestCase::new("verification_key_manager_remove_key", test_verification_key_manager_remove_key));
    suite.add(TestCase::new("verification_key_manager_list_circuits", test_verification_key_manager_list_circuits));

    // Merkle verifier tests (3 tests)
    suite.add(TestCase::new("merkle_verifier_verify_membership_single", test_merkle_verifier_verify_membership_single));
    suite.add(TestCase::new("merkle_verifier_verify_membership_mismatch", test_merkle_verifier_verify_membership_mismatch));
    suite.add(TestCase::new("merkle_verifier_verify_membership_too_long_proof", test_merkle_verifier_verify_membership_too_long_proof));

    // Range proof verifier tests (3 tests)
    suite.add(TestCase::new("range_proof_verifier_invalid_range", test_range_proof_verifier_invalid_range));
    suite.add(TestCase::new("range_proof_verifier_verify_simple_invalid_bit_length_zero", test_range_proof_verifier_verify_simple_invalid_bit_length_zero));
    suite.add(TestCase::new("range_proof_verifier_verify_simple_invalid_bit_length_too_large", test_range_proof_verifier_verify_simple_invalid_bit_length_too_large));
    ...
    suite.add(TestCase::new("deserialize_constraints_invalid_length", test_deserialize_constraints_invalid_length));
    ...
    suite.add(TestCase::new("kernel_measurement_compute_integrity_hash", test_kernel_measurement_compute_integrity_hash));
    suite.add(TestCase::new("kernel_measurement_compute_integrity_hash_deterministic", test_kernel_measurement_compute_integrity_hash_deterministic));
    suite.add(TestCase::new("kernel_measurement_clone", test_kernel_measurement_clone));
    suite.add(TestCase::new("kernel_measurement_with_modules", test_kernel_measurement_with_modules));
    ...
    suite.add(TestCase::new("g2_field_element_frobenius_coefficients", test_g2_field_element_frobenius_coefficients));
