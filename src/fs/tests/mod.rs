...
pub fn run_all() -> bool {
    ...
    suite.add(TestCase::new("fs_error_not_initialized_errno", ramfs_tests::test_fs_error_not_initialized_errno));
    suite.add(TestCase::new("fs_error_not_found_errno", ramfs_tests::test_fs_error_not_found_errno));
    suite.add(TestCase::new("fs_error_already_exists_errno", ramfs_tests::test_fs_error_already_exists_errno));
    suite.add(TestCase::new("fs_error_path_too_long_errno", ramfs_tests::test_fs_error_path_too_long_errno));
    suite.add(TestCase::new("fs_error_invalid_path_errno", ramfs_tests::test_fs_error_invalid_path_errno));
    suite.add(TestCase::new("fs_error_file_too_large_errno", ramfs_tests::test_fs_error_file_too_large_errno));
    suite.add(TestCase::new("fs_error_too_many_files_errno", ramfs_tests::test_fs_error_too_many_files_errno));
    suite.add(TestCase::new("fs_error_no_encryption_key_errno", ramfs_tests::test_fs_error_no_encryption_key_errno));
    suite.add(TestCase::new("fs_error_data_too_short_errno", ramfs_tests::test_fs_error_data_too_short_errno));
    suite.add(TestCase::new("fs_error_decryption_failed_errno", ramfs_tests::test_fs_error_decryption_failed_errno));
    suite.add(TestCase::new("fs_error_encryption_failed_errno", ramfs_tests::test_fs_error_encryption_failed_errno));
    suite.add(TestCase::new("fs_error_directory_not_found_errno", ramfs_tests::test_fs_error_directory_not_found_errno));
    suite.add(TestCase::new("fs_error_not_a_directory_errno", ramfs_tests::test_fs_error_not_a_directory_errno));
    suite.add(TestCase::new("fs_error_directory_not_empty_errno", ramfs_tests::test_fs_error_directory_not_empty_errno));
    suite.add(TestCase::new("fs_error_permission_denied_errno", ramfs_tests::test_fs_error_permission_denied_errno));
    suite.add(TestCase::new("fs_error_as_str_not_found", ramfs_tests::test_fs_error_as_str_not_found));
    suite.add(TestCase::new("fs_error_as_str_already_exists", ramfs_tests::test_fs_error_as_str_already_exists));
    suite.add(TestCase::new("fs_error_as_str_path_too_long", ramfs_tests::test_fs_error_as_str_path_too_long));
    suite.add(TestCase::new("fs_error_as_str_invalid_path", ramfs_tests::test_fs_error_as_str_invalid_path));
    suite.add(TestCase::new("fs_error_as_str_file_too_large", ramfs_tests::test_fs_error_as_str_file_too_large));
    ...
    suite.add(TestCase::new("fs_constants_max_file_size", ramfs_tests::test_fs_constants_max_file_size));
    suite.add(TestCase::new("fs_constants_max_path_len", ramfs_tests::test_fs_constants_max_path_len));
    suite.add(TestCase::new("fs_constants_max_files", ramfs_tests::test_fs_constants_max_files));
    suite.add(TestCase::new("nonos_file_system_type_variants", ramfs_tests::test_nonos_file_system_type_variants));
    ...
    suite.add(TestCase::new("secure_zeroize_single_byte", ramfs_tests::test_secure_zeroize_single_byte));
    suite.add(TestCase::new("normalize_path_absolute", ramfs_tests::test_normalize_path_absolute));
    suite.add(TestCase::new("normalize_path_double_slash", ramfs_tests::test_normalize_path_double_slash));
    ...
    suite.add(TestCase::new("normalize_path_empty_result", ramfs_tests::test_normalize_path_empty_result));
    ...
    suite.add(TestCase::new("fs_statistics_with_values", ramfs_tests::test_fs_statistics_with_values));
    suite.add(TestCase::new("nonos_file_system_type_equality", ramfs_tests::test_nonos_file_system_type_equality));
    ...
    suite.add(TestCase::new("cache_stats_hit_ratio_zero", cache_tests::test_cache_stats_hit_ratio_zero));
    suite.add(TestCase::new("cache_stats_hit_ratio_all_hits", cache_tests::test_cache_stats_hit_ratio_all_hits));
    suite.add(TestCase::new("cache_stats_hit_ratio_all_misses", cache_tests::test_cache_stats_hit_ratio_all_misses));
    suite.add(TestCase::new("cache_stats_hit_ratio_mixed", cache_tests::test_cache_stats_hit_ratio_mixed));
    ...
    suite.add(TestCase::new("cache_statistics_hit_ratio_zero", cache_tests::test_cache_statistics_hit_ratio_zero));
    suite.add(TestCase::new("cache_statistics_reset", cache_tests::test_cache_statistics_reset));
    suite.add(TestCase::new("cache_constants_max_cached_pages", cache_tests::test_cache_constants_max_cached_pages));
    suite.add(TestCase::new("cache_constants_writeback_batch_size", cache_tests::test_cache_constants_writeback_batch_size));
    suite.add(TestCase::new("cache_constants_max_cached_inodes", cache_tests::test_cache_constants_max_cached_inodes));
    suite.add(TestCase::new("cache_constants_max_operation_retries", cache_tests::test_cache_constants_max_operation_retries));
    ...
    suite.add(TestCase::new("get_full_cache_statistics", cache_tests::test_get_full_cache_statistics));
    ...
    suite.add(TestCase::new("lookup_dentry_after_insert", cache_tests::test_lookup_dentry_after_insert));
    ...
    suite.add(TestCase::new("get_pending_dentry_updates", cache_tests::test_get_pending_dentry_updates));
    suite.add(TestCase::new("process_inode_cache_maintenance", cache_tests::test_process_inode_cache_maintenance));
    ...
    suite.add(TestCase::new("get_cached_page_not_found", cache_tests::test_get_cached_page_not_found));
    ...
    suite.add(TestCase::new("get_cached_inode_not_found", cache_tests::test_get_cached_inode_not_found));

    // Path tests (88 tests)
    suite.add(TestCase::new("path_constants_max_path_len", path_tests::test_path_constants_max_path_len));
    suite.add(TestCase::new("path_constants_max_component_len", path_tests::test_path_constants_max_component_len));
    suite.add(TestCase::new("path_constants_separator", path_tests::test_path_constants_separator));
    suite.add(TestCase::new("path_constants_current_dir", path_tests::test_path_constants_current_dir));
    suite.add(TestCase::new("path_constants_parent_dir", path_tests::test_path_constants_parent_dir));
    suite.add(TestCase::new("path_error_null_pointer_errno", path_tests::test_path_error_null_pointer_errno));
    suite.add(TestCase::new("path_error_too_long_errno", path_tests::test_path_error_too_long_errno));
    suite.add(TestCase::new("path_error_invalid_utf8_errno", path_tests::test_path_error_invalid_utf8_errno));
    suite.add(TestCase::new("path_error_empty_errno", path_tests::test_path_error_empty_errno));
    suite.add(TestCase::new("path_error_contains_null_errno", path_tests::test_path_error_contains_null_errno));
    suite.add(TestCase::new("path_error_component_too_long_errno", path_tests::test_path_error_component_too_long_errno));
    suite.add(TestCase::new("path_error_invalid_character_errno", path_tests::test_path_error_invalid_character_errno));
    suite.add(TestCase::new("path_error_traversal_attempt_errno", path_tests::test_path_error_traversal_attempt_errno));
    suite.add(TestCase::new("path_error_not_absolute_errno", path_tests::test_path_error_not_absolute_errno));
    suite.add(TestCase::new("path_error_not_relative_errno", path_tests::test_path_error_not_relative_errno));
    suite.add(TestCase::new("path_error_as_str_null_pointer", path_tests::test_path_error_as_str_null_pointer));
    suite.add(TestCase::new("path_error_as_str_too_long", path_tests::test_path_error_as_str_too_long));
    suite.add(TestCase::new("path_error_as_str_invalid_utf8", path_tests::test_path_error_as_str_invalid_utf8));
    suite.add(TestCase::new("path_error_as_str_empty", path_tests::test_path_error_as_str_empty));
    suite.add(TestCase::new("path_error_as_str_contains_null", path_tests::test_path_error_as_str_contains_null));
    suite.add(TestCase::new("path_error_as_str_traversal", path_tests::test_path_error_as_str_traversal));
    ...
    suite.add(TestCase::new("validate_path_secure_valid", path_tests::test_validate_path_secure_valid));
    suite.add(TestCase::new("validate_path_secure_traversal", path_tests::test_validate_path_secure_traversal));
    suite.add(TestCase::new("validate_path_secure_complex_traversal", path_tests::test_validate_path_secure_complex_traversal));
    ...
    suite.add(TestCase::new("path_normalize_path_double_slash", path_tests::test_normalize_path_double_slash));
    ...
    suite.add(TestCase::new("normalize_path_dotdot_at_start", path_tests::test_normalize_path_dotdot_at_start));
    suite.add(TestCase::new("normalize_path_multiple_dotdot", path_tests::test_normalize_path_multiple_dotdot));
    suite.add(TestCase::new("normalize_path_root", path_tests::test_normalize_path_root));
    suite.add(TestCase::new("path_normalize_path_relative", path_tests::test_normalize_path_relative));
    suite.add(TestCase::new("normalize_path_relative_with_dot", path_tests::test_normalize_path_relative_with_dot));
    suite.add(TestCase::new("normalize_path_relative_with_dotdot", path_tests::test_normalize_path_relative_with_dotdot));
    suite.add(TestCase::new("normalize_path_empty", path_tests::test_normalize_path_empty));
    suite.add(TestCase::new("normalize_path_only_dotdot", path_tests::test_normalize_path_only_dotdot));
    suite.add(TestCase::new("normalize_path_relative_dotdot_start", path_tests::test_normalize_path_relative_dotdot_start));
    ...
    suite.add(TestCase::new("extension_hidden_with_ext", path_tests::test_extension_hidden_with_ext));
    ...
    suite.add(TestCase::new("join_secure_absolute_child", path_tests::test_join_secure_absolute_child));
    ...
    suite.add(TestCase::new("normalize_path_secure_valid", path_tests::test_normalize_path_secure_valid));
    suite.add(TestCase::new("normalize_path_secure_traversal", path_tests::test_normalize_path_secure_traversal));
    ...
    suite.add(TestCase::new("storage_constants_default_max_storage", storage_tests::test_storage_constants_default_max_storage));
    suite.add(TestCase::new("storage_constants_default_max_files", storage_tests::test_storage_constants_default_max_files));
    suite.add(TestCase::new("storage_constants_block_size", storage_tests::test_storage_constants_block_size));
    suite.add(TestCase::new("storage_constants_inode_size", storage_tests::test_storage_constants_inode_size));
    suite.add(TestCase::new("storage_constants_warning_threshold", storage_tests::test_storage_constants_warning_threshold));
    suite.add(TestCase::new("storage_constants_critical_threshold", storage_tests::test_storage_constants_critical_threshold));
    suite.add(TestCase::new("storage_health_status_variants", storage_tests::test_storage_health_status_variants));
    suite.add(TestCase::new("storage_stats_default", storage_tests::test_storage_stats_default));
    suite.add(TestCase::new("storage_stats_usage_percent_zero", storage_tests::test_storage_stats_usage_percent_zero));
    suite.add(TestCase::new("storage_stats_usage_percent_half", storage_tests::test_storage_stats_usage_percent_half));
    suite.add(TestCase::new("storage_stats_usage_percent_full", storage_tests::test_storage_stats_usage_percent_full));
    suite.add(TestCase::new("storage_stats_free_percent", storage_tests::test_storage_stats_free_percent));
    suite.add(TestCase::new("storage_stats_block_usage_percent", storage_tests::test_storage_stats_block_usage_percent));
    suite.add(TestCase::new("storage_stats_block_usage_percent_zero_total", storage_tests::test_storage_stats_block_usage_percent_zero_total));
    suite.add(TestCase::new("storage_stats_clone", storage_tests::test_storage_stats_clone));
    suite.add(TestCase::new("filesystem_breakdown_default", storage_tests::test_filesystem_breakdown_default));
    suite.add(TestCase::new("filesystem_breakdown_total_bytes", storage_tests::test_filesystem_breakdown_total_bytes));
    suite.add(TestCase::new("filesystem_breakdown_total_files", storage_tests::test_filesystem_breakdown_total_files));
    suite.add(TestCase::new("filesystem_breakdown_clone", storage_tests::test_filesystem_breakdown_clone));
    ...
    suite.add(TestCase::new("storage_issues_has_issues_none", storage_tests::test_storage_issues_has_issues_none));
    suite.add(TestCase::new("storage_issues_has_issues_low_space", storage_tests::test_storage_issues_has_issues_low_space));
    suite.add(TestCase::new("storage_issues_has_issues_low_inodes", storage_tests::test_storage_issues_has_issues_low_inodes));
    suite.add(TestCase::new("storage_issues_has_issues_high_fragmentation", storage_tests::test_storage_issues_has_issues_high_fragmentation));
    suite.add(TestCase::new("storage_issues_has_issues_allocation_failures", storage_tests::test_storage_issues_has_issues_allocation_failures));
    suite.add(TestCase::new("storage_issues_has_issues_io_errors", storage_tests::test_storage_issues_has_issues_io_errors));
    suite.add(TestCase::new("storage_issues_issue_count_zero", storage_tests::test_storage_issues_issue_count_zero));
    suite.add(TestCase::new("storage_issues_issue_count_all", storage_tests::test_storage_issues_issue_count_all));
    suite.add(TestCase::new("storage_issues_issue_count_some", storage_tests::test_storage_issues_issue_count_some));
    ...
    suite.add(TestCase::new("inode_stats_usage_percent_zero", storage_tests::test_inode_stats_usage_percent_zero));
    suite.add(TestCase::new("inode_stats_usage_percent_half", storage_tests::test_inode_stats_usage_percent_half));
    suite.add(TestCase::new("inode_stats_usage_percent_zero_total", storage_tests::test_inode_stats_usage_percent_zero_total));
    ...
    suite.add(TestCase::new("storage_quota_is_soft_exceeded_false", storage_tests::test_storage_quota_is_soft_exceeded_false));
    suite.add(TestCase::new("storage_quota_is_soft_exceeded_true", storage_tests::test_storage_quota_is_soft_exceeded_true));
    suite.add(TestCase::new("storage_quota_is_hard_exceeded_false", storage_tests::test_storage_quota_is_hard_exceeded_false));
    suite.add(TestCase::new("storage_quota_is_hard_exceeded_true", storage_tests::test_storage_quota_is_hard_exceeded_true));
    suite.add(TestCase::new("storage_quota_remaining_bytes", storage_tests::test_storage_quota_remaining_bytes));
    suite.add(TestCase::new("storage_quota_remaining_bytes_none", storage_tests::test_storage_quota_remaining_bytes_none));
    suite.add(TestCase::new("storage_quota_remaining_files", storage_tests::test_storage_quota_remaining_files));
    ...
    suite.add(TestCase::new("get_total_available_bytes", storage_tests::test_get_total_available_bytes));
    suite.add(TestCase::new("get_storage_usage_percent", storage_tests::test_get_storage_usage_percent));
    suite.add(TestCase::new("get_filesystem_breakdown", storage_tests::test_get_filesystem_breakdown));
