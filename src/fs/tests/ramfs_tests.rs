...
pub fn test_fs_constants_nonce_size() -> TestResult {
    if NONCE_SIZE != 12 { return TestResult::Fail; }
    TestResult::Pass
}

pub fn test_fs_constants_tag_size() -> TestResult {
    if TAG_SIZE != 16 { return TestResult::Fail; }
    TestResult::Pass
}

pub fn test_fs_constants_key_size() -> TestResult {
    if KEY_SIZE != 32 { return TestResult::Fail; }
    TestResult::Pass
}

pub fn test_fs_constants_salt_size() -> TestResult {
    if SALT_SIZE != 16 { return TestResult::Fail; }
    TestResult::Pass
}

pub fn test_fs_constants_max_file_size() -> TestResult {
    if MAX_FILE_SIZE != 256 * 1024 * 1024 { return TestResult::Fail; }
    TestResult::Pass
}

pub fn test_fs_constants_max_path_len() -> TestResult {
    if MAX_PATH_LEN != 4096 { return TestResult::Fail; }
    TestResult::Pass
}

pub fn test_fs_constants_max_files() -> TestResult {
    if MAX_FILES != 65536 { return TestResult::Fail; }
    TestResult::Pass
}

pub fn test_nonos_file_system_type_variants() -> TestResult {
...
pub fn test_fs_statistics_default() -> TestResult {
...
pub fn test_fs_statistics_clone() -> TestResult {
...
pub fn test_dir_entry_file() -> TestResult {
    let entry = DirEntry {
...
pub fn test_dir_entry_directory() -> TestResult {
    let entry = DirEntry {
...
pub fn test_secure_zeroize() -> TestResult {
...
pub fn test_secure_zeroize_array() -> TestResult {
...
pub fn test_secure_zeroize_empty() -> TestResult {
    let mut data: [u8; 0] = [];
    secure_zeroize(&mut data);
...
pub fn test_secure_zeroize_single_byte() -> TestResult {
    let mut data = [0xFF];
    secure_zeroize(&mut data);
...
pub fn test_normalize_path_absolute() -> TestResult {
...
pub fn test_normalize_path_empty_result() -> TestResult {
    if normalize_path("/") != "/" { return TestResult::Fail; }
    TestResult::Pass
}

pub fn test_nonos_file_info_clone() -> TestResult {
...
pub fn test_nonos_file_clone() -> TestResult {
    let file = NonosFile {
...
pub fn test_dir_entry_clone() -> TestResult {
    let entry = DirEntry {
...
pub fn test_fs_statistics_with_values() -> TestResult {
    let stats = FsStatistics {
        files: 100,
...
pub fn test_nonos_file_system_type_equality() -> TestResult {
...
pub fn test_fs_error_io_error() -> TestResult {
