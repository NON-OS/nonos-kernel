...
use super::types::{DeviceNode, DeviceType, DeviceOps};
...
pub fn register_device(name: &str, dev_type: DeviceType, major: u32, minor: u32, mode: u32) -> Result<u64, i32> {
...
pub fn register_device_with_ops(name: &str, dev_type: DeviceType, major: u32, minor: u32, mode: u32, ops: Arc<dyn DeviceOps>) -> Result<u64, i32> {
