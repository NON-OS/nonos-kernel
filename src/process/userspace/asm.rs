...
pub unsafe extern "C" fn jump_to_usermode(entry: u64, stack: u64, arg: u64) -> ! {
    core::arch::naked_asm!(
        ...
        "push 0x23", "push rsi", "push 0x202", "push 0x1B", "push rdi", "mov rdi, rdx",
        "xor rax, rax", "xor rbx, rbx", "xor rcx, rcx", "xor rdx, rdx", "xor rsi, rsi",
        "xor rbp, rbp", "xor r8, r8", "xor r9, r9", "xor r10, r10", "xor r11, r11",
        "xor r12, r12", "xor r13, r13", "xor r14, r14", "xor r15, r15", "iretq",
    );
}
...
pub unsafe extern "C" fn sysret_to_usermode(rip: u64, rsp: u64, rflags: u64, retval: u64) -> ! {
    core::arch::naked_asm!(
        "mov rax, rdi", "shr rax, 47", "cmp rax, 0", "je 2f", "cmp rax, 0x1FFFF", "jne 1f", "2:",
        "mov rax, rcx", "mov rcx, rdi", "mov r11, rdx", "mov rsp, rsi",
        "xor rbx, rbx", "xor rdx, rdx", "xor rsi, rsi", "xor rdi, rdi", "xor rbp, rbp",
        "xor r8, r8", "xor r9, r9", "xor r10, r10", "xor r12, r12", "xor r13, r13",
        "xor r14, r14", "xor r15, r15", "swapgs", "sysretq", "1:", "ud2",
    );
}
