...
#[derive(Default)]
pub struct ProcessTable { inner: RwLock<Vec<Arc<ProcessControlBlock>>> }
...
pub fn create_process(name: &str, state: ProcessState, prio: Priority) -> Result<Pid, &'static str> {
    ...
    let pcb = Arc::new(ProcessControlBlock {
        ...
        clear_child_tid: AtomicU64::new(0), set_child_tid: AtomicU64::new(0),
        alarm_time_ms: AtomicU64::new(0), tls_base: AtomicU64::new(0),
        stack_base: AtomicU64::new(0), clone_flags: AtomicU64::new(0),
