...
pub struct PciStats {
    pub total_devices: u64, pub bridge_devices: u64, pub msi_capable_devices: u64,
    pub msix_capable_devices: u64, pub pcie_devices: u64, pub dma_capable_devices: u64,
    pub enumeration_count: u64, pub enumeration_time_us: u64,
    pub config_reads: u64, pub config_writes: u64, pub config_errors: u64,
    pub interrupts_total: u64, pub msi_interrupts: u64, pub legacy_interrupts: u64,
    pub hotplug_events: u64, pub power_state_changes: u64, pub link_state_changes: u64,
    pub error_events: u64, pub devices_by_class: BTreeMap<u8, u64>, pub devices_by_vendor: BTreeMap<u16, u64>,
}
...
impl PciStats {
    ...
    pub fn snapshot() -> Self {
        Self {
            ...
            devices_by_class: BTreeMap::new(), devices_by_vendor: BTreeMap::new(),
        }
    }

    pub fn average_enumeration_time_us(&self) -> u64 {
        if self.enumeration_count == 0 { 0 } else { self.enumeration_time_us / self.enumeration_count }
    }
}
