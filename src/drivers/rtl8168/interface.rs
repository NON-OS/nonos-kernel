...
use super::{get_rtl8168_device, MAX_MTU};

pub struct Rtl8168SmolBridge;

impl crate::network::stack::SmolDevice for Rtl8168SmolBridge {
    fn now_ms(&self) -> u64 {
...
pub static RTL8168_SMOL_BRIDGE: Rtl8168SmolBridge = Rtl8168SmolBridge;

pub fn register_with_network_stack() {
    crate::network::stack::register_device(&RTL8168_SMOL_BRIDGE);
    crate::log::info!("rtl8168: Registered with network stack");
}

#[derive(Debug, Clone, Default)]
pub struct Rtl8168Stats {
    pub rx_packets: u64,
    pub tx_packets: u64,
    pub rx_bytes: u64,
    pub tx_bytes: u64,
