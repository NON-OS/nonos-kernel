...
pub(crate) fn test_command_header_layout() -> TestResult {
    ...
    if header.flags != 0x1234 { return TestResult::Fail; }
    if header.prdtl != 0x5678 { return TestResult::Fail; }
    if header.prdbc != 0xDEAD_BEEF { return TestResult::Fail; }
    if header.ctba != 0xCAFE_BABE { return TestResult::Fail; }
    if header.ctbau != 0x1234_5678 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_prdt_layout() -> TestResult {
    ...
    if prdt.dba != 0x1234_5678 { return TestResult::Fail; }
    if prdt.dbau != 0x9ABC_DEF0 { return TestResult::Fail; }
    if prdt.reserved0 != 0 { return TestResult::Fail; }
    if prdt.dbc != 0xFFFF_FFFF { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_command_table_cfis_size() -> TestResult {
    ...
    if ct.cfis.len() != 64 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_command_table_acmd_size() -> TestResult {
    ...
    if ct.acmd.len() != 16 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_command_table_reserved_size() -> TestResult {
    ...
    if ct.reserved.len() != 48 { return TestResult::Fail; }
    TestResult::Pass
}
