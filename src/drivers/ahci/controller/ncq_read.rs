...
pub(crate) fn ncq_read_sectors<T: RegisterAccess>(
    ...
    validation_failures: &AtomicU64, read_ops: &AtomicU64, bytes_read: &AtomicU64, errors: &AtomicU64,
    ...
    if !supports_ncq {
        return io::read_sectors(ctrl, ports, port_dma, validation_failures, read_ops, bytes_read,
