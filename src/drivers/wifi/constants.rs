...
pub const SUPPORTED_DEVICE_IDS: &[u16] = &[
    ...
    0x08B1, 0x08B2, 0x08B3, 0x08B4, 0x095A, 0x095B,
    /* Intel Wireless-N (legacy) */
    0x0082, 0x0083, 0x0084, 0x0085, 0x0087, 0x0089, 0x008A, 0x008B,
    0x0090, 0x0091, 0x4232, 0x4235, 0x4236, 0x4237, 0x4238, 0x4239,
    /* Intel Killer WiFi (branded Intel inside) */
    0x2A70, 0x7A70, 0x7AF0,
    /* Intel BE200 WiFi 7 (2024+) */
    0x272F, 0xE020,
];
