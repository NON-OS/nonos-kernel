...
pub(crate) fn test_scan_result_signal_quality_excellent() -> TestResult {
    ...
    if result.signal_quality() != 100 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_scan_result_signal_quality_good() -> TestResult {
    ...
    if result.signal_quality() != 80 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_scan_result_signal_quality_fair() -> TestResult {
    ...
    if result.signal_quality() != 60 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_scan_result_signal_quality_weak() -> TestResult {
    ...
    if result.signal_quality() != 40 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_scan_result_signal_quality_poor() -> TestResult {
    ...
    if result.signal_quality() != 20 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_scan_result_signal_quality_none() -> TestResult {
    ...
    if result.signal_quality() != 0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_scan_result_frequency_2ghz_channel_1() -> TestResult {
    ...
    if result.frequency_mhz() != 2412 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_scan_result_frequency_2ghz_channel_6() -> TestResult {
    ...
    if result.frequency_mhz() != 2437 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_scan_result_frequency_2ghz_channel_11() -> TestResult {
    ...
    if result.frequency_mhz() != 2462 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_scan_result_frequency_5ghz_channel_36() -> TestResult {
    ...
    if result.frequency_mhz() != 5180 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_scan_result_frequency_5ghz_channel_149() -> TestResult {
    ...
    if result.frequency_mhz() != 5745 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_scan_result_band_2ghz() -> TestResult {
    ...
    if result.band() != "2.4 GHz" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_scan_result_band_5ghz() -> TestResult {
    ...
    if result.band() != "5 GHz" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_scan_result_band_6ghz() -> TestResult {
    ...
    if result.band() != "6 GHz" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_scan_config_2ghz_only_channels() -> TestResult {
    ...
    if !cfg.channels.contains(&13) { return TestResult::Fail; }
...
pub(crate) fn test_scan_config_builder_chain() -> TestResult {
    let cfg = ScanConfig::new_2ghz_only()
        ...
        .with_passive();
    if cfg.channels.len() != 13 { return TestResult::Fail; }
    if cfg.ssid_filter != Some("Test".to_string()) { return TestResult::Fail; }
    if !cfg.passive_scan { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_scan_result_clone() -> TestResult {
    ...
    if result.ssid != cloned.ssid { return TestResult::Fail; }
    if result.bssid != cloned.bssid { return TestResult::Fail; }
    if result.channel != cloned.channel { return TestResult::Fail; }
    if result.rssi != cloned.rssi { return TestResult::Fail; }
    if result.security != cloned.security { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_scan_config_clone() -> TestResult {
    ...
    if cfg.ssid_filter != cloned.ssid_filter { return TestResult::Fail; }
    TestResult::Pass
}
