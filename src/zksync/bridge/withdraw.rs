...
use crate::zksync::types::{Address, U256, BatchNumber};
...
impl WithdrawHandler {
    ...
    pub fn initiate(&mut self, state: &mut StateManager, sender: Address, recipient: Address, amount: U256) -> Result<[u8; 32], ZkSyncError> {
        ...
        let withdrawal = Withdrawal { sender, l1_recipient: recipient, amount, batch, message_hash };
    ...
    pub fn finalized_count(&self) -> usize { self.finalized.len() }
}
