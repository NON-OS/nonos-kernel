...
pub fn run_all() -> bool {
    ...
    suite.add(TestCase::new("deposit_handler_queue_multiple", bridge::test_deposit_handler_queue_multiple));
    suite.add(TestCase::new("deposit_handler_process_next_empty", bridge::test_deposit_handler_process_next_empty));
    suite.add(TestCase::new("deposit_handler_process_next", bridge::test_deposit_handler_process_next));
    suite.add(TestCase::new("deposit_handler_process_next_fifo", bridge::test_deposit_handler_process_next_fifo));
    suite.add(TestCase::new("deposit_handler_process_accumulates_balance", bridge::test_deposit_handler_process_accumulates_balance));
    ...
    suite.add(TestCase::new("withdraw_handler_initiate_insufficient_balance", bridge::test_withdraw_handler_initiate_insufficient_balance));
    suite.add(TestCase::new("withdraw_handler_initiate_returns_hash", bridge::test_withdraw_handler_initiate_returns_hash));
    suite.add(TestCase::new("withdraw_handler_initiate_multiple", bridge::test_withdraw_handler_initiate_multiple));
    suite.add(TestCase::new("withdraw_handler_finalize_batch", bridge::test_withdraw_handler_finalize_batch));
    suite.add(TestCase::new("withdraw_handler_finalize_batch_partial", bridge::test_withdraw_handler_finalize_batch_partial));
    suite.add(TestCase::new("withdraw_handler_finalize_batch_none", bridge::test_withdraw_handler_finalize_batch_none));
    suite.add(TestCase::new("withdraw_handler_different_hashes", bridge::test_withdraw_handler_different_hashes));

    // Config tests (19)
    suite.add(TestCase::new("config_default_max_tx_per_block", config::test_config_default_max_tx_per_block));
    suite.add(TestCase::new("config_default_max_blocks_per_batch", config::test_config_default_max_blocks_per_batch));
    suite.add(TestCase::new("config_default_block_time_ms", config::test_config_default_block_time_ms));
    suite.add(TestCase::new("config_default_gas_per_pubdata_byte", config::test_config_default_gas_per_pubdata_byte));
    suite.add(TestCase::new("config_default_max_gas_per_batch", config::test_config_default_max_gas_per_batch));
    ...
    suite.add(TestCase::new("config_default_sequencer_address", config::test_config_default_sequencer_address));
    suite.add(TestCase::new("config_default_bootloader_hash", config::test_config_default_bootloader_hash));
    suite.add(TestCase::new("config_default_default_aa_hash", config::test_config_default_default_aa_hash));
    ...
    suite.add(TestCase::new("config_mainnet_inherits_defaults", config::test_config_mainnet_inherits_defaults));
    suite.add(TestCase::new("config_sepolia_inherits_defaults", config::test_config_sepolia_inherits_defaults));
    ...
    suite.add(TestCase::new("syscall_numbers_sequential", constants::test_syscall_numbers_sequential));
    ...
    suite.add(TestCase::new("public_exports_batch_number", constants::test_public_exports_batch_number));
    suite.add(TestCase::new("public_exports_block_number", constants::test_public_exports_block_number));
    ...
    suite.add(TestCase::new("public_exports_zksync_config", constants::test_public_exports_zksync_config));
    suite.add(TestCase::new("public_exports_zksync_error", constants::test_public_exports_zksync_error));
    suite.add(TestCase::new("public_exports_goldilocks_field", constants::test_public_exports_goldilocks_field));
    suite.add(TestCase::new("public_exports_sparse_merkle_tree", constants::test_public_exports_sparse_merkle_tree));
    suite.add(TestCase::new("init_zksync_function_exists", constants::test_init_zksync_function_exists));
    suite.add(TestCase::new("is_initialized_function_exists", constants::test_is_initialized_function_exists));
    ...
    suite.add(TestCase::new("execution_context_initial_state", eravm::test_execution_context_initial_state));
    suite.add(TestCase::new("execution_context_consume_gas", eravm::test_execution_context_consume_gas));
    suite.add(TestCase::new("execution_context_consume_gas_exceeds_limit", eravm::test_execution_context_consume_gas_exceeds_limit));
    suite.add(TestCase::new("execution_context_consume_gas_exact_limit", eravm::test_execution_context_consume_gas_exact_limit));
    suite.add(TestCase::new("execution_context_remaining_gas", eravm::test_execution_context_remaining_gas));
    ...
    suite.add(TestCase::new("execution_context_is_finished_false", eravm::test_execution_context_is_finished_false));
    suite.add(TestCase::new("execution_context_is_finished_after_finish", eravm::test_execution_context_is_finished_after_finish));
    suite.add(TestCase::new("execution_context_is_finished_after_revert", eravm::test_execution_context_is_finished_after_revert));
    suite.add(TestCase::new("execution_context_memory_access", eravm::test_execution_context_memory_access));
    suite.add(TestCase::new("execution_context_multiple_gas_consumption", eravm::test_execution_context_multiple_gas_consumption));
    suite.add(TestCase::new("execution_context_gas_consumption_fails_mid_execution", eravm::test_execution_context_gas_consumption_fails_mid_execution));
    ...
    suite.add(TestCase::new("error_witness_generation_failed", error::test_error_witness_generation_failed));
    suite.add(TestCase::new("error_l1_communication_failed", error::test_error_l1_communication_failed));
    ...
    suite.add(TestCase::new("all_error_variants_distinct", error::test_all_error_variants_distinct));
    ...
    suite.add(TestCase::new("transaction_pool_insert_duplicate", sequencer::test_transaction_pool_insert_duplicate));
    suite.add(TestCase::new("transaction_pool_insert_full", sequencer::test_transaction_pool_insert_full));
    suite.add(TestCase::new("transaction_pool_get", sequencer::test_transaction_pool_get));
    suite.add(TestCase::new("transaction_pool_get_nonexistent", sequencer::test_transaction_pool_get_nonexistent));
    suite.add(TestCase::new("transaction_pool_contains", sequencer::test_transaction_pool_contains));
    suite.add(TestCase::new("transaction_pool_remove", sequencer::test_transaction_pool_remove));
    suite.add(TestCase::new("transaction_pool_remove_nonexistent", sequencer::test_transaction_pool_remove_nonexistent));
    suite.add(TestCase::new("transaction_pool_get_pending_for", sequencer::test_transaction_pool_get_pending_for));
    suite.add(TestCase::new("transaction_pool_get_pending_for_empty", sequencer::test_transaction_pool_get_pending_for_empty));
    suite.add(TestCase::new("transaction_pool_next_nonce_for", sequencer::test_transaction_pool_next_nonce_for));
    suite.add(TestCase::new("transaction_pool_next_nonce_for_current_higher", sequencer::test_transaction_pool_next_nonce_for_current_higher));
    suite.add(TestCase::new("transaction_pool_drain_batch", sequencer::test_transaction_pool_drain_batch));
    suite.add(TestCase::new("transaction_pool_drain_batch_more_than_available", sequencer::test_transaction_pool_drain_batch_more_than_available));
    suite.add(TestCase::new("transaction_executor_new", sequencer::test_transaction_executor_new));
    suite.add(TestCase::new("transaction_executor_current_block", sequencer::test_transaction_executor_current_block));
    suite.add(TestCase::new("transaction_executor_execute_success", sequencer::test_transaction_executor_execute_success));
    suite.add(TestCase::new("transaction_executor_execute_nonce_too_low", sequencer::test_transaction_executor_execute_nonce_too_low));
    suite.add(TestCase::new("transaction_executor_execute_nonce_too_high", sequencer::test_transaction_executor_execute_nonce_too_high));
    suite.add(TestCase::new("transaction_executor_execute_insufficient_balance", sequencer::test_transaction_executor_execute_insufficient_balance));
    suite.add(TestCase::new("transaction_executor_validate_success", sequencer::test_transaction_executor_validate_success));
    suite.add(TestCase::new("transaction_executor_validate_nonce_too_low", sequencer::test_transaction_executor_validate_nonce_too_low));
    suite.add(TestCase::new("transaction_executor_validate_insufficient_balance", sequencer::test_transaction_executor_validate_insufficient_balance));
    suite.add(TestCase::new("transaction_executor_increments_nonce", sequencer::test_transaction_executor_increments_nonce));
    suite.add(TestCase::new("transaction_executor_transfers_value", sequencer::test_transaction_executor_transfers_value));
    ...
    suite.add(TestCase::new("sparse_merkle_tree_get_nonexistent", state::test_sparse_merkle_tree_get_nonexistent));
    suite.add(TestCase::new("sparse_merkle_tree_remove", state::test_sparse_merkle_tree_remove));
    suite.add(TestCase::new("sparse_merkle_tree_remove_nonexistent", state::test_sparse_merkle_tree_remove_nonexistent));
    suite.add(TestCase::new("sparse_merkle_tree_root_changes_on_insert", state::test_sparse_merkle_tree_root_changes_on_insert));
    suite.add(TestCase::new("sparse_merkle_tree_root_changes_on_remove", state::test_sparse_merkle_tree_root_changes_on_remove));
    suite.add(TestCase::new("sparse_merkle_tree_proof", state::test_sparse_merkle_tree_proof));
    suite.add(TestCase::new("sparse_merkle_tree_proof_nonexistent", state::test_sparse_merkle_tree_proof_nonexistent));
    suite.add(TestCase::new("merkle_proof_verify", state::test_merkle_proof_verify));
    suite.add(TestCase::new("merkle_proof_verify_wrong_root", state::test_merkle_proof_verify_wrong_root));
    ...
    suite.add(TestCase::new("state_manager_get_account_nonexistent", state::test_state_manager_get_account_nonexistent));
    suite.add(TestCase::new("state_manager_get_balance_nonexistent", state::test_state_manager_get_balance_nonexistent));
    suite.add(TestCase::new("state_manager_get_nonce_nonexistent", state::test_state_manager_get_nonce_nonexistent));
    suite.add(TestCase::new("state_manager_set_balance", state::test_state_manager_set_balance));
    suite.add(TestCase::new("state_manager_increment_nonce", state::test_state_manager_increment_nonce));
    suite.add(TestCase::new("state_manager_increment_nonce_nonexistent", state::test_state_manager_increment_nonce_nonexistent));
    suite.add(TestCase::new("state_manager_transfer", state::test_state_manager_transfer));
    suite.add(TestCase::new("state_manager_transfer_insufficient_balance", state::test_state_manager_transfer_insufficient_balance));
    suite.add(TestCase::new("state_manager_state_root_changes", state::test_state_manager_state_root_changes));
    suite.add(TestCase::new("state_manager_advance_block", state::test_state_manager_advance_block));
    suite.add(TestCase::new("state_manager_advance_batch", state::test_state_manager_advance_batch));
    ...
    suite.add(TestCase::new("account_storage_get_nonexistent", state::test_account_storage_get_nonexistent));
    suite.add(TestCase::new("account_storage_exists", state::test_account_storage_exists));
    suite.add(TestCase::new("account_storage_get_or_create", state::test_account_storage_get_or_create));
    ...
    suite.add(TestCase::new("account_storage_increment_nonce", state::test_account_storage_increment_nonce));
    ...
    suite.add(TestCase::new("contract_storage_get_nonexistent", state::test_contract_storage_get_nonexistent));
    suite.add(TestCase::new("contract_storage_set_get", state::test_contract_storage_set_get));
    suite.add(TestCase::new("contract_storage_set_zero_removes", state::test_contract_storage_set_zero_removes));
    suite.add(TestCase::new("contract_storage_remove", state::test_contract_storage_remove));
    suite.add(TestCase::new("contract_storage_remove_nonexistent", state::test_contract_storage_remove_nonexistent));
    suite.add(TestCase::new("contract_storage_clear_account", state::test_contract_storage_clear_account));
    suite.add(TestCase::new("contract_storage_iter_account", state::test_contract_storage_iter_account));
    suite.add(TestCase::new("contract_storage_multiple_accounts", state::test_contract_storage_multiple_accounts));
    ...
    suite.add(TestCase::new("address_from_bytes_invalid_length", types::test_address_from_bytes_invalid_length));
    ...
    suite.add(TestCase::new("transaction_signature_default", types::test_transaction_signature_default));
    suite.add(TestCase::new("transaction_status_pending", types::test_transaction_status_pending));
    suite.add(TestCase::new("transaction_status_included", types::test_transaction_status_included));
    suite.add(TestCase::new("transaction_status_committed", types::test_transaction_status_committed));
    suite.add(TestCase::new("transaction_status_proven", types::test_transaction_status_proven));
    suite.add(TestCase::new("transaction_status_finalized", types::test_transaction_status_finalized));
    ...
    suite.add(TestCase::new("account_state_empty_code_hash", types::test_account_state_empty_code_hash));
    suite.add(TestCase::new("account_state_is_empty_true", types::test_account_state_is_empty_true));
    suite.add(TestCase::new("account_state_is_empty_false_nonce", types::test_account_state_is_empty_false_nonce));
    suite.add(TestCase::new("account_state_is_empty_false_balance", types::test_account_state_is_empty_false_balance));
    suite.add(TestCase::new("account_state_is_empty_false_code", types::test_account_state_is_empty_false_code));
