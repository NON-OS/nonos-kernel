...
pub(crate) fn test_address_from_bytes_valid() -> TestResult {
    ...
    if addr.unwrap().0 != bytes { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_address_as_ref() -> TestResult {
    ...
    if slice != &bytes { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_address_debug_format() -> TestResult {
    ...
    if debug.len() != 42 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_address_equality() -> TestResult {
    ...
    if a1 == a3 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_u256_from_u64() -> TestResult {
    ...
    if u.0[1] != 0 { return TestResult::Fail; }
    if u.0[2] != 0 { return TestResult::Fail; }
    if u.0[3] != 0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_u256_to_bytes_be() -> TestResult {
    ...
    if bytes[31] != 0x08 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_u256_checked_add() -> TestResult {
    ...
    if sum.is_none() { return TestResult::Fail; }
    if sum.unwrap().0[0] != 300 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_u256_checked_sub() -> TestResult {
    ...
    if diff.is_none() { return TestResult::Fail; }
    if diff.unwrap().0[0] != 200 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_nonce_increment() -> TestResult {
    ...
    n.increment();
    if n.0 != 2 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_transaction_signature_default() -> TestResult {
    ...
    if sig.s != [0u8; 32] { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_tx_fail_reason_variants() -> TestResult {
    ...
    for (i, reason) in reasons.iter().enumerate() {
        if *reason != reasons[i] { return TestResult::Fail; }
    }
    TestResult::Pass
}
...
pub(crate) fn test_account_state_empty_code_hash() -> TestResult {
    ...
    if AccountState::EMPTY_CODE_HASH != expected { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_account_state_is_empty_true() -> TestResult {
    ...
    if !state.is_empty() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_l2_block_clone() -> TestResult {
    ...
    if block.number != cloned.number { return TestResult::Fail; }
    if block.timestamp != cloned.timestamp { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_batch_clone() -> TestResult {
    ...
    if batch.number != cloned.number { return TestResult::Fail; }
    if batch.blocks.len() != cloned.blocks.len() { return TestResult::Fail; }
    TestResult::Pass
}
