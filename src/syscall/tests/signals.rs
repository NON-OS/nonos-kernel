...
pub(crate) fn test_sigset_add() -> TestResult {
    ...
    if set.contains(SIGTERM) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_sigset_add_multiple() -> TestResult {
    ...
    if !set.contains(SIGINT) { return TestResult::Fail; }
    if !set.contains(SIGTERM) { return TestResult::Fail; }
    if !set.contains(SIGKILL) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_sigset_bitand() -> TestResult {
    ...
    if !result.contains(SIGINT) { return TestResult::Fail; }
    if result.contains(SIGTERM) { return TestResult::Fail; }
    if result.contains(SIGKILL) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_sigset_clone() -> TestResult {
    ...
    if !cloned.contains(SIGINT) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_sigset_copy() -> TestResult {
    ...
    set.add(SIGINT);
    let copied = set;
    if !copied.contains(SIGINT) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_kernel_sigaction_default() -> TestResult {
    ...
    if action.restorer != 0 { return TestResult::Fail; }
    if !action.mask.is_empty() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_kernel_sigaction_clone() -> TestResult {
    ...
    if cloned.handler != 0x1000 { return TestResult::Fail; }
    if cloned.flags != SA_RESTART { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_process_signal_state_default() -> TestResult {
    ...
    if !state.pending_queue.is_empty() { return TestResult::Fail; }
    if !state.saved_mask.is_none() { return TestResult::Fail; }
    if !state.alt_stack.is_none() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_pending_signal_fields() -> TestResult {
    ...
    if sig.signo != SIGINT { return TestResult::Fail; }
    if sig.pid != 1234 { return TestResult::Fail; }
    if sig.uid != 1000 { return TestResult::Fail; }
    if sig.timestamp != 12345678 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_standard_signals_are_less_than_32() -> TestResult {
    ...
    if SIGTERM >= 32 { return TestResult::Fail; }
    if SIGSYS >= 32 { return TestResult::Fail; }
    TestResult::Pass
}
