...
#[test]
fn test_rlimit_cpu_constant() {
    assert_eq!(RLIMIT_CPU, 0);
}

#[test]
fn test_rlimit_fsize_constant() {
    assert_eq!(RLIMIT_FSIZE, 1);
}

#[test]
fn test_rlimit_data_constant() {
    assert_eq!(RLIMIT_DATA, 2);
}

#[test]
fn test_rlimit_stack_constant() {
    assert_eq!(RLIMIT_STACK, 3);
}

#[test]
fn test_rlimit_core_constant() {
    assert_eq!(RLIMIT_CORE, 4);
}

#[test]
fn test_rlimit_rss_constant() {
    assert_eq!(RLIMIT_RSS, 5);
}

#[test]
fn test_rlimit_nproc_constant() {
    assert_eq!(RLIMIT_NPROC, 6);
}

#[test]
fn test_rlimit_nofile_constant() {
    assert_eq!(RLIMIT_NOFILE, 7);
}

#[test]
fn test_rlim_infinity_constant() {
    assert_eq!(RLIM_INFINITY, 0x7FFFFFFF);
}

#[test]
fn test_getrlimit_null_rlim_returns_efault() {
...
#[test]
fn test_getrlimit_fsize_success() {
    let result = SyscallResult::success(0);
    assert_eq!(result.value, 0);
}

#[test]
fn test_getrlimit_data_success() {
    let result = SyscallResult::success(0);
    assert_eq!(result.value, 0);
}

#[test]
fn test_getrlimit_stack_success() {
    let result = SyscallResult::success(0);
    assert_eq!(result.value, 0);
}

#[test]
fn test_getrlimit_core_success() {
    let result = SyscallResult::success(0);
    assert_eq!(result.value, 0);
}

#[test]
fn test_getrlimit_rss_success() {
    let result = SyscallResult::success(0);
    assert_eq!(result.value, 0);
}

#[test]
fn test_getrlimit_nproc_success() {
    let result = SyscallResult::success(0);
    assert_eq!(result.value, 0);
}

#[test]
fn test_getrlimit_nofile_success() {
    let result = SyscallResult::success(0);
    assert_eq!(result.value, 0);
}

#[test]
fn test_getrlimit_unknown_resource_returns_default() {
    let result = SyscallResult::success(0);
    assert_eq!(result.value, 0);
}

#[test]
fn test_getrlimit_efault_on_write_failure() {
    let result = SyscallResult::error(14);
    assert_eq!(result.errno(), Some(14));
}

#[test]
fn test_setrlimit_null_rlim_returns_efault() {
    let result = SyscallResult::error(14);
    assert_eq!(result.errno(), Some(14));
}

#[test]
fn test_setrlimit_success_audited() {
...
#[test]
fn test_prlimit64_get_only_success() {
    let result = SyscallResult::success(0);
    assert_eq!(result.value, 0);
}

#[test]
fn test_prlimit64_set_only_success() {
    let result = SyscallResult::success(0);
    assert_eq!(result.value, 0);
}

#[test]
fn test_prlimit64_get_and_set_success() {
    let result = SyscallResult::success(0);
    assert_eq!(result.value, 0);
}

#[test]
fn test_prlimit64_get_failure_propagates() {
    let result = SyscallResult::error(14);
    assert_eq!(result.errno(), Some(14));
}

#[test]
fn test_prlimit64_set_failure_propagates() {
    let result = SyscallResult::error(14);
    assert_eq!(result.errno(), Some(14));
}

#[test]
fn test_prlimit64_pid_zero_means_self() {
    let pid: i32 = 0;
    assert_eq!(pid, 0);
}

#[test]
fn test_prlimit64_pid_nonzero() {
    let pid: i32 = 1234;
    assert!(pid > 0);
}
...
#[test]
fn test_rlimit_soft_less_than_hard() {
    let soft: u64 = 1024;
    let hard: u64 = 4096;
    assert!(soft <= hard);
}
...
#[test]
fn test_rlimit_soft_equals_hard() {
    let soft: u64 = 4096;
    let hard: u64 = 4096;
    assert_eq!(soft, hard);
}
...
#[test]
fn test_getrlimit_writes_soft_first() {
...
#[test]
fn test_rlimit_unknown_resource_default_infinity() {
...
#[test]
fn test_prlimit64_both_null_pointers() {
    let old_limit: u64 = 0;
    let new_limit: u64 = 0;
...
#[test]
fn test_rlimit_cpu_soft_value() {
    let soft: u64 = RLIM_INFINITY;
    assert_eq!(soft, 0x7FFFFFFF);
}

#[test]
fn test_rlimit_cpu_hard_value() {
    let hard: u64 = RLIM_INFINITY;
    assert_eq!(hard, 0x7FFFFFFF);
}

#[test]
fn test_rlimit_fsize_soft_value() {
    let soft: u64 = RLIM_INFINITY;
    assert_eq!(soft, 0x7FFFFFFF);
}

#[test]
fn test_rlimit_fsize_hard_value() {
    let hard: u64 = RLIM_INFINITY;
    assert_eq!(hard, 0x7FFFFFFF);
}

#[test]
fn test_rlimit_data_soft_value() {
    let soft: u64 = RLIM_INFINITY;
    assert_eq!(soft, 0x7FFFFFFF);
}

#[test]
fn test_rlimit_data_hard_value() {
    let hard: u64 = RLIM_INFINITY;
    assert_eq!(hard, 0x7FFFFFFF);
}

#[test]
fn test_rlimit_stack_soft_value() {
    let soft: u64 = 8 * 1024 * 1024;
    assert_eq!(soft, 8388608);
}

#[test]
fn test_rlimit_stack_hard_value() {
