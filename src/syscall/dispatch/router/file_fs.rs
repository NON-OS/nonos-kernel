...
pub(super) fn dispatch_file_fs(syscall: SyscallNumber, a0: u64, a1: u64, a2: u64, a3: u64, a4: u64, _a5: u64) -> SyscallResult {
    match syscall {
        ...
        SyscallNumber::Poll => crate::syscall::extended::select::handle_poll(a0, a1, a2 as i32),
        SyscallNumber::Select => crate::syscall::extended::select::handle_select(a0 as i32, a1, a2, a3, a4),
        SyscallNumber::Pselect6 => crate::syscall::extended::select::handle_pselect6(a0 as i32, a1, a2, a3, a4, _a5),
        SyscallNumber::Ppoll => crate::syscall::extended::select::handle_ppoll(a0, a1, a2, a3, a4),
        SyscallNumber::EpollCreate => crate::syscall::extended::epoll::handle_epoll_create(a0 as i32),
        SyscallNumber::EpollCreate1 => crate::syscall::extended::epoll::handle_epoll_create1(a0 as u32),
        SyscallNumber::EpollCtl => crate::syscall::extended::epoll::handle_epoll_ctl(a0 as i32, a1 as u32, a2 as i32, a3 as u32, a4),
        SyscallNumber::EpollWait => crate::syscall::extended::epoll::handle_epoll_wait(a0 as i32, a1, a2 as i32, a3 as i32),
        SyscallNumber::EpollPwait => crate::syscall::extended::epoll::handle_epoll_pwait(a0 as i32, a1, a2 as i32, a3 as i32, a4),
        SyscallNumber::InotifyInit => crate::syscall::extended::inotify::handle_inotify_init(),
        SyscallNumber::InotifyInit1 => crate::syscall::extended::inotify::handle_inotify_init1(a0 as i32),
        SyscallNumber::InotifyAddWatch => crate::syscall::extended::inotify::handle_inotify_add_watch(a0 as i32, a1, a2 as u32),
        SyscallNumber::InotifyRmWatch => crate::syscall::extended::inotify::handle_inotify_rm_watch(a0 as i32, a1 as i32),
        SyscallNumber::Eventfd => crate::syscall::extended::eventfd_ops::handle_eventfd(a0 as u32, 0),
        SyscallNumber::Eventfd2 => crate::syscall::extended::eventfd_ops::handle_eventfd(a0 as u32, a1 as i32),
        ...
        SyscallNumber::FanotifyMark => dispatch_fanotify_mark(a0 as i32, a1 as u32, a2, a3 as i32, a4 as usize),
        SyscallNumber::ProcessVmReadv => dispatch_process_vm_readv(a0 as i32, a1 as usize, a2 as usize, a3 as usize, a4 as usize),
        SyscallNumber::ProcessVmWritev => dispatch_process_vm_writev(a0 as i32, a1 as usize, a2 as usize, a3 as usize, a4 as usize),
        SyscallNumber::SetRobustList => crate::syscall::robust_futex::handle_set_robust_list(a0, a1),
        SyscallNumber::GetRobustList => crate::syscall::robust_futex::handle_get_robust_list(a0 as i32, a1, a2),
        ...
        SyscallNumber::PkeyMprotect => crate::syscall::pkey::handle_pkey_mprotect(a0, a1, a2 as i32, a3 as i32),
        SyscallNumber::Setxattr => crate::syscall::xattr::handle_setxattr(a0, a1, a2, a3, a4 as i32),
        SyscallNumber::Lsetxattr => crate::syscall::xattr::handle_lsetxattr(a0, a1, a2, a3, a4 as i32),
        SyscallNumber::Fsetxattr => crate::syscall::xattr::handle_fsetxattr(a0 as i32, a1, a2, a3, a4 as i32),
        ...
        SyscallNumber::CopyFileRange => crate::syscall::extended::handle_copy_file_range(a0 as i32, a1, a2 as i32, a3, a4, _a5 as u32),
        SyscallNumber::Splice => crate::syscall::extended::handle_splice(a0 as i32, a1, a2 as i32, a3, a4, _a5 as u32),
        SyscallNumber::Tee => crate::syscall::extended::handle_tee(a0 as i32, a1 as i32, a2, a3 as u32),
        SyscallNumber::Vmsplice => crate::syscall::extended::handle_vmsplice(a0 as i32, a1, a2, a3 as u32),
        SyscallNumber::SyncFileRange => crate::syscall::extended::handle_sync_file_range(a0 as i32, a1 as i64, a2 as i64, a3 as u32),
        ...
        SyscallNumber::Faccessat => crate::syscall::extended::handle_faccessat(a0 as i32, a1, a2 as i32, a3 as i32),
...
fn dispatch_fanotify_mark(fd: i32, flags: u32, mask: u64, dirfd: i32, pathname: usize) -> SyscallResult {
    let result = crate::syscall::fanotify::sys_fanotify_mark(fd, flags, mask, dirfd, pathname);
    SyscallResult { value: result, capability_consumed: false, audit_required: true }
}

fn dispatch_process_vm_readv(pid: i32, lvec: usize, liovcnt: usize, rvec: usize, riovcnt: usize) -> SyscallResult {
    let result = crate::syscall::process_vm::sys_process_vm_readv(pid, lvec, liovcnt, rvec, riovcnt, 0);
    SyscallResult { value: result, capability_consumed: false, audit_required: true }
}
