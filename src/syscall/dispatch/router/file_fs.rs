...
pub(super) fn dispatch_file_fs(syscall: SyscallNumber, a0: u64, a1: u64, a2: u64, a3: u64, a4: u64, _a5: u64) -> SyscallResult {
    match syscall {
        ...
        SyscallNumber::Ppoll => crate::syscall::extended::select::handle_ppoll(a0, a1 as u32, a2, a3, a4),
        SyscallNumber::EpollCreate => crate::syscall::extended::epoll::handle_epoll_create(a0 as i32),
        SyscallNumber::EpollCreate1 => crate::syscall::extended::epoll::handle_epoll_create1(a0 as i32),
        SyscallNumber::EpollCtl => crate::syscall::extended::epoll::handle_epoll_ctl(a0 as i32, a1 as i32, a2 as i32, a3),
        SyscallNumber::EpollWait => crate::syscall::extended::epoll::handle_epoll_wait(a0 as i32, a1, a2 as i32, a3 as i32),
        SyscallNumber::EpollPwait => crate::syscall::extended::epoll::handle_epoll_pwait(a0 as i32, a1, a2 as i32, a3 as i32, a4, _a5),
        ...
        SyscallNumber::Eventfd2 => crate::syscall::extended::eventfd_ops::handle_eventfd2(a0 as u32, a1 as i32),
