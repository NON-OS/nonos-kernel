...
pub fn handle_debug_log(msg_ptr: u64, len: u64) -> SyscallResult {
    ...
    if copy_from_user(msg_ptr, &mut message).is_err() { return errno(14); }
...
pub fn handle_debug_trace(flags: u64) -> SyscallResult {
    ...
    match flags {
        ...
        1 => { set_audit_verbose(true); crate::log::debug!("Syscall tracing enabled"); }
        2 => { crate::log::debug!("Memory tracing enabled"); }
        _ => return errno(22),
    }
