...
impl SyscallValidator {
    pub const fn new() -> Self {
        Self { rate_limit_counter: 0, blocked_syscalls: [false; 256], capability_cache: None }
    }
