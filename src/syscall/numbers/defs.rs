...
pub enum SyscallNumber {
    CryptoRandom = tag4(b"CRND"), CryptoHash = tag4(b"CHSH"),
    CryptoSign = tag4(b"CSGN"), CryptoVerify = tag4(b"CVRF"),
    CryptoEncrypt = tag4(b"CENC"), CryptoDecrypt = tag4(b"CDEC"),
    CryptoKeyGen = tag4(b"CKGN"), CryptoZkProve = tag4(b"CZKP"),
    CryptoZkVerify = tag4(b"CZKV"), CryptoEd25519Verify = tag4(b"CEDV"),
    ...
    GraphicsDisplayList = tag4(b"GDLS"), GraphicsCursorPresent = tag4(b"GCUR"),
    MkIpcSend = tag4(b"MISD"), MkIpcRecv = tag4(b"MIRC"),
    MkIpcCall = tag4(b"MICL"), MkIpcRecvFrom = tag4(b"MIRF"),
    MkIpcSendToPid = tag4(b"MISP"), MkServiceLookup = tag4(b"MSVL"),
    ...
    MkMmioMap = tag4(b"MMMP"), MkMmioUnmap = tag4(b"MMUM"),
