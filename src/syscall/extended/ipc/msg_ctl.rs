...
pub fn handle_msgctl(msqid: i32, cmd: i32, buf: u64) -> SyscallResult {
    ...
    match cmd {
        IPC_RMID => {
            if queues.remove(&msqid).is_some() { ok(0) } else { errno(22) }
        }
...
fn handle_msg_stat(queues: &alloc::collections::BTreeMap<i32, super::msg_types::MessageQueue>, msqid: i32, buf: u64) -> SyscallResult {
...
fn handle_msg_set(queues: &mut alloc::collections::BTreeMap<i32, super::msg_types::MessageQueue>, msqid: i32, buf: u64) -> SyscallResult {
    if buf == 0 { return errno(14); }
...
fn handle_msg_info(queues: &alloc::collections::BTreeMap<i32, super::msg_types::MessageQueue>, buf: u64) -> SyscallResult {
    if buf == 0 { return errno(14); }
