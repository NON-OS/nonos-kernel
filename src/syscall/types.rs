...
impl SyscallResult {
    ...
    pub const fn success(value: i64) -> Self {
        Self { value, capability_consumed: false, audit_required: false }
    }

    #[inline]
    pub const fn success_audited(value: i64) -> Self {
        Self { value, capability_consumed: false, audit_required: true }
    }

    #[inline]
    pub const fn error(errno: i32) -> Self {
        Self { value: -(errno as i64), capability_consumed: false, audit_required: true }
    }
