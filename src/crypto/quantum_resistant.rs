//! NONOS QUANTUM-RESISTANT CRYPTOGRAPHY IMPLEMENTATION
//! 
...
// hardware random number generator using CPU instructions
...
// AEAD implementation combining ChaCha20 and Poly1305
