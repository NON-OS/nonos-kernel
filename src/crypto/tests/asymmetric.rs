...
pub fn test_ed25519_keypair_from_seed() -> TestResult {
    ...
    if kp.private.len() != 32 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_ed25519_sign_verify_roundtrip() -> TestResult {
    ...
    let sig = sign(&kp, msg);
    if !verify(&kp.public, msg, &sig) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_ed25519_sign_deterministic() -> TestResult {
    ...
    if sig1.R != sig2.R { return TestResult::Fail; }
    if sig1.S != sig2.S { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_ed25519_verify_wrong_message() -> TestResult {
    ...
    let msg = b"test message";
    let sig = sign(&kp, msg);
    if verify(&kp.public, b"wrong message", &sig) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_ed25519_verify_wrong_key() -> TestResult {
    ...
    if verify(&kp2.public, msg, &sig) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_ed25519_signature_to_bytes() -> TestResult {
    ...
    if &bytes[..32] != &sig.R[..] { return TestResult::Fail; }
    if &bytes[32..] != &sig.S[..] { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_ed25519_signature_from_bytes() -> TestResult {
    ...
    if sig.R != sig2.R { return TestResult::Fail; }
    if sig.S != sig2.S { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_ed25519_signature_roundtrip_bytes() -> TestResult {
    ...
    let bytes = sig.to_bytes();
    let sig2 = Signature::from_bytes(&bytes);
    if !verify(&kp.public, msg, &sig2) { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_ed25519_sign_different_messages_different_sigs() -> TestResult {
    ...
    if sig1.to_bytes() == sig2.to_bytes() { return TestResult::Fail; }
    TestResult::Pass
}
