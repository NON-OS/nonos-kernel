...
pub fn test_chacha_rng_deterministic() -> TestResult {
    ...
    if out1 != out2 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_chacha_rng_next_u64() -> TestResult {
    ...
    if val == 0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_chacha_rng_next_u64_deterministic() -> TestResult {
    ...
    let mut rng1 = ChaChaRng::new(seed);
    let mut rng2 = ChaChaRng::new(seed);
    if rng1.next_u64() != rng2.next_u64() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_chacha_rng_next_u32_deterministic() -> TestResult {
    ...
    let mut rng1 = ChaChaRng::new(seed);
    let mut rng2 = ChaChaRng::new(seed);
    if rng1.next_u32() != rng2.next_u32() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_chacha_rng_multiple_calls() -> TestResult {
    ...
    if val1 == val2 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_chacha_rng_blocks_generated() -> TestResult {
    ...
    let mut output = [0u8; 64];
    rng.fill_bytes(&mut output);
    if rng.blocks_generated() < 1 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_chacha_rng_all_ones_seed() -> TestResult {
    ...
    let mut rng = ChaChaRng::new(seed);
    let val = rng.next_u64();
    if val == u64::MAX { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_chacha_rng_different_sizes_match() -> TestResult {
    ...
    if &buf1_16[..] != &buf2[..16] { return TestResult::Fail; }
    if &buf1_32[..] != &buf2[16..48] { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_chacha_rng_u32_u64_consistency() -> TestResult {
    ...
    if rng2.next_u32() != expected { return TestResult::Fail; }
    TestResult::Pass
}
