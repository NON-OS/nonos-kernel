...
impl ProjectivePoint {
    ...
    /// Point doubling using complete addition formula for a = p − 3
    pub fn double(&self) -> Self {
        ...
        // m = 3*xx + a*zz^2 where a = -3, so m = 3*(xx - zz^2)
        let zzzz = zz.square();
    ...
    /// Constant-time scalar multiplication using Montgomery ladder (384 bits)
