...
pub fn get_mmap_addr() -> u64 { stdlib::mmap::mmap as *const () as usize as u64 }
pub fn get_munmap_addr() -> u64 { stdlib::mmap::munmap as *const () as usize as u64 }
pub fn get_brk_addr() -> u64 { stdlib::mmap::brk as *const () as usize as u64 }
...
pub fn get_stack_chk_fail_addr() -> u64 { crt::crti::__stack_chk_fail as *const () as usize as u64 }
pub fn get_cxa_atexit_addr() -> u64 { crt::crti::__cxa_atexit as *const () as usize as u64 }
