...
pub const SIGKILL: i32 = 9; pub const SIGSEGV: i32 = 11; pub const SIGPIPE: i32 = 13;
pub const SIGALRM: i32 = 14; pub const SIGTERM: i32 = 15; pub const SIGUSR1: i32 = 10;
pub const SIGUSR2: i32 = 12; pub const SIGCHLD: i32 = 17; pub const SIGCONT: i32 = 18;
pub const SIGSTOP: i32 = 19; pub const NSIG: usize = 64;

pub const SIG_DFL: usize = 0; pub const SIG_IGN: usize = 1; pub const SIG_ERR: usize = usize::MAX;
pub const SA_NOCLDSTOP: u64 = 1; pub const SA_NOCLDWAIT: u64 = 2; pub const SA_SIGINFO: u64 = 4;
pub const SA_RESTORER: u64 = 0x04000000; pub const SA_RESTART: u64 = 0x10000000;

pub type SigHandler = extern "C" fn(i32);
pub type SigActionFn = extern "C" fn(i32, *mut SigInfo, *mut u8);

#[repr(C)] #[derive(Clone, Copy)] pub struct Sigset { pub bits: [u64; 1] }
#[repr(C)] pub struct SigInfo { pub si_signo: i32, pub si_errno: i32, pub si_code: i32, pub _pad: [i32; 29] }
#[repr(C)] pub struct SigAction { pub sa_handler: usize, pub sa_flags: u64, pub sa_restorer: usize, pub sa_mask: Sigset }

impl Default for Sigset { fn default() -> Self { Self { bits: [0] } } }
impl Default for SigAction { fn default() -> Self { Self { sa_handler: SIG_DFL, sa_flags: 0, sa_restorer: 0, sa_mask: Sigset::default() } } }
...
pub unsafe extern "C" fn signal(signum: i32, handler: SigHandler) -> usize {
    ...
    if sigaction(signum, &act, &mut old) < 0 { return SIG_ERR; }
    old.sa_handler
}
...
pub unsafe extern "C" fn sigaddset(set: *mut Sigset, signum: i32) -> i32 {
    if set.is_null() || signum < 1 || signum >= NSIG as i32 { return -1; }
...
pub unsafe extern "C" fn sigismember(set: *const Sigset, signum: i32) -> i32 {
    if set.is_null() || signum < 1 || signum >= NSIG as i32 { return -1; }
    if ((*set).bits[0] & (1u64 << (signum - 1))) != 0 { 1 } else { 0 }
}
