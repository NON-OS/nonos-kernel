...
fn next_library_id() -> usize { NEXT_LIBRARY_ID.fetch_add(1, Ordering::Relaxed) }

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum LibraryState { Loading, Relocating, Initializing, Ready, Finalizing, Unloaded }
...
impl LoadedLibrary {
    pub fn new(name: String, image: ElfImage) -> Self {
        Self { id: next_library_id(), name, soname: None, image, state: LibraryState::Loading, ref_count: 1, dependencies: Vec::new(), dependents: Vec::new(), init_called: false, fini_called: false }
    }
