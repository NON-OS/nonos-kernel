...
pub(crate) fn test_symbol_default() -> TestResult {
    ...
    if sym.st_other != 0 { return TestResult::Fail; }
    if sym.st_shndx != 0 { return TestResult::Fail; }
    if sym.st_value != 0 { return TestResult::Fail; }
    if sym.st_size != 0 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_symbol_clone() -> TestResult {
    ...
    sym.st_size = 100;
    let cloned = sym;
    if cloned.st_value != 0x401000 { return TestResult::Fail; }
    if cloned.st_size != 100 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_symbol_copy() -> TestResult {
    ...
    if copied.st_name != 42 { return TestResult::Fail; }
    if sym.st_name != 42 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_sym_type_constants() -> TestResult {
    ...
    if sym_type::STT_SECTION != 3 { return TestResult::Fail; }
    if sym_type::STT_FILE != 4 { return TestResult::Fail; }
    if sym_type::STT_TLS != 6 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_symbol_info_encoding() -> TestResult {
    for bind in 0u8..4 {
        for stype in 0u8..8 {
            ...
            let mut sym = Symbol::default();
            sym.st_info = info;
            if sym.binding() != bind { return TestResult::Fail; }
            if sym.sym_type() != stype { return TestResult::Fail; }
        }
    }
    TestResult::Pass
}
...
pub(crate) fn test_symbol_max_values() -> TestResult {
    ...
    if sym.st_name != u32::MAX { return TestResult::Fail; }
    if sym.binding() != 0x0F { return TestResult::Fail; }
    if sym.sym_type() != 0x0F { return TestResult::Fail; }
    if sym.st_shndx != u16::MAX { return TestResult::Fail; }
    if sym.st_value != u64::MAX { return TestResult::Fail; }
    if sym.st_size != u64::MAX { return TestResult::Fail; }
    TestResult::Pass
}
