...
pub(crate) fn test_lifecycle_state_as_str() -> TestResult {
    ...
    if LifecycleState::Suspended.as_str() != "Suspended" { return TestResult::Fail; }
    if LifecycleState::Stopping.as_str() != "Stopping" { return TestResult::Fail; }
    if LifecycleState::Failed.as_str() != "Failed" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_lifecycle_state_is_active() -> TestResult {
    ...
    if !LifecycleState::Suspended.is_active() { return TestResult::Fail; }
    if LifecycleState::Stopping.is_active() { return TestResult::Fail; }
    if LifecycleState::Failed.is_active() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_lifecycle_state_can_start() -> TestResult {
    ...
    if LifecycleState::Running.can_start() { return TestResult::Fail; }
    if LifecycleState::Suspended.can_start() { return TestResult::Fail; }
    if LifecycleState::Stopping.can_start() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_lifecycle_state_can_stop() -> TestResult {
    ...
    if !LifecycleState::Suspended.can_stop() { return TestResult::Fail; }
    if LifecycleState::Stopping.can_stop() { return TestResult::Fail; }
    if LifecycleState::Failed.can_stop() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_lifecycle_state_can_suspend() -> TestResult {
    ...
    if LifecycleState::Suspended.can_suspend() { return TestResult::Fail; }
    if LifecycleState::Stopping.can_suspend() { return TestResult::Fail; }
    if LifecycleState::Failed.can_suspend() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_lifecycle_state_can_resume() -> TestResult {
    ...
    if !LifecycleState::Suspended.can_resume() { return TestResult::Fail; }
    if LifecycleState::Stopping.can_resume() { return TestResult::Fail; }
    if LifecycleState::Failed.can_resume() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_lifecycle_state_repr() -> TestResult {
    ...
    if (LifecycleState::Suspended as u8) != 3 { return TestResult::Fail; }
    if (LifecycleState::Stopping as u8) != 4 { return TestResult::Fail; }
    if (LifecycleState::Failed as u8) != 5 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_app_event_started_app_id() -> TestResult {
    ...
    if event.app_id().as_u64() != 42 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_app_event_stopped_app_id() -> TestResult {
    ...
    if event.app_id().as_u64() != 43 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_app_event_suspended_app_id() -> TestResult {
    ...
    if event.app_id().as_u64() != 44 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_app_event_resumed_app_id() -> TestResult {
    ...
    if event.app_id().as_u64() != 45 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_app_event_failed_app_id() -> TestResult {
    ...
    if event.app_id().as_u64() != 46 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_app_event_permission_granted_app_id() -> TestResult {
    ...
    if event.app_id().as_u64() != 47 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_app_event_permission_revoked_app_id() -> TestResult {
    ...
    if event.app_id().as_u64() != 48 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_app_event_name_started() -> TestResult {
    ...
    if event.name() != Some("Browser") { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_app_event_name_stopped() -> TestResult {
    ...
    if event.name() != Some("Editor") { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_app_event_name_suspended() -> TestResult {
    ...
    if event.name() != Some("Wallet") { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_app_event_name_resumed() -> TestResult {
    ...
    if event.name() != Some("Terminal") { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_app_event_name_failed() -> TestResult {
    ...
    if event.name() != Some("Settings") { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_app_event_name_permission_granted_is_none() -> TestResult {
    ...
    if event.name().is_some() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_event_queue_emit_and_poll() -> TestResult {
    ...
    if polled.is_none() { return TestResult::Fail; }
    let e = polled.unwrap();
    if e.app_id().as_u64() != 100 { return TestResult::Fail; }
    clear_events();
    TestResult::Pass
}
...
pub(crate) fn test_event_queue_peek() -> TestResult {
    ...
    if peeked1.is_none() { return TestResult::Fail; }
    if peeked2.is_none() { return TestResult::Fail; }
    if peeked1.unwrap().app_id().as_u64() != peeked2.unwrap().app_id().as_u64() { return TestResult::Fail; }
    clear_events();
    TestResult::Pass
}
...
pub(crate) fn test_event_queue_count() -> TestResult {
    ...
    if event_count() != 1 { return TestResult::Fail; }
    emit_event(AppEvent::Stopped {
        app_id: AppId::from_raw(2),
        name: String::from("App2"),
    });
    if event_count() != 2 { return TestResult::Fail; }
    clear_events();
    TestResult::Pass
}
...
pub(crate) fn test_event_fifo_order() -> TestResult {
    ...
    if poll_event().unwrap().app_id().as_u64() != 1 { return TestResult::Fail; }
    if poll_event().unwrap().app_id().as_u64() != 2 { return TestResult::Fail; }
    if poll_event().unwrap().app_id().as_u64() != 3 { return TestResult::Fail; }
    if poll_event().is_some() { return TestResult::Fail; }
    TestResult::Pass
}
...
pub(crate) fn test_app_event_clone() -> TestResult {
    ...
    if event.app_id().as_u64() != cloned.app_id().as_u64() { return TestResult::Fail; }
    TestResult::Pass
}
