...
pub fn test_browser_tab_new() -> TestResult {
    ...
    if tab.id != 1 { return TestResult::Fail; }
    if tab.url != "https://example.com" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_browser_tab_url() -> TestResult {
    ...
    if tab.url != "https://nonos.io/apps" { return TestResult::Fail; }
    if tab.status != TabStatus::Ready { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_browser_tab_security() -> TestResult {
    ...
    if tab.security != SecurityStatus::Secure { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_browser_tab_error() -> TestResult {
    ...
    if tab.status != TabStatus::Error { return TestResult::Fail; }
    if tab.error_message.is_none() { return TestResult::Fail; }
    if tab.error_message.as_ref().unwrap() != "Connection refused" { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_browser_tab_history() -> TestResult {
    ...
    if !tab.can_go_back { return TestResult::Fail; }
    if tab.history.len() != 3 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_browser_tab_favicon() -> TestResult {
    ...
    if tab.favicon.is_none() { return TestResult::Fail; }
    if tab.favicon.as_ref().unwrap().len() != 4 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_browser_tab_scroll() -> TestResult {
    ...
    if tab.scroll_position != 500 { return TestResult::Fail; }
    TestResult::Pass
}
...
pub fn test_browser_tab_clone() -> TestResult {
    ...
    if cloned.id != 8 { return TestResult::Fail; }
