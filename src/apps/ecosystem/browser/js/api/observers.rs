...
pub fn create_mutation_observer() -> JsValue { JsValue::NativeFunc(construct_mutation_observer) }
pub fn create_intersection_observer() -> JsValue { JsValue::NativeFunc(construct_intersection_observer) }
pub fn create_resize_observer() -> JsValue { JsValue::NativeFunc(construct_resize_observer) }
...
fn observe(_args: &[JsValue]) -> JsValue { JsValue::Undefined }
fn disconnect(_args: &[JsValue]) -> JsValue { JsValue::Undefined }
