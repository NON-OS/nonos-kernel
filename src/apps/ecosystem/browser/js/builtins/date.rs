...
pub fn create_date_instance(timestamp: f64) -> JsValue {
    let mut obj = BTreeMap::new();
    obj.insert(String::from("_timestamp"), JsValue::Number(timestamp));
    obj.insert(String::from("getTime"), JsValue::NativeFunc(date_get_time));
    obj.insert(String::from("getFullYear"), JsValue::NativeFunc(date_get_full_year));
    obj.insert(String::from("getMonth"), JsValue::NativeFunc(date_get_month));
    obj.insert(String::from("getDate"), JsValue::NativeFunc(date_get_date));
    obj.insert(String::from("getDay"), JsValue::NativeFunc(date_get_day));
    obj.insert(String::from("getHours"), JsValue::NativeFunc(date_get_hours));
    obj.insert(String::from("getMinutes"), JsValue::NativeFunc(date_get_minutes));
    obj.insert(String::from("getSeconds"), JsValue::NativeFunc(date_get_seconds));
    obj.insert(String::from("getMilliseconds"), JsValue::NativeFunc(date_get_milliseconds));
    obj.insert(String::from("setTime"), JsValue::NativeFunc(date_set_time));
    obj.insert(String::from("setFullYear"), JsValue::NativeFunc(date_set_full_year));
    obj.insert(String::from("setMonth"), JsValue::NativeFunc(date_set_month));
    obj.insert(String::from("setDate"), JsValue::NativeFunc(date_set_date));
    obj.insert(String::from("setHours"), JsValue::NativeFunc(date_set_hours));
    obj.insert(String::from("setMinutes"), JsValue::NativeFunc(date_set_minutes));
    obj.insert(String::from("setSeconds"), JsValue::NativeFunc(date_set_seconds));
    obj.insert(String::from("setMilliseconds"), JsValue::NativeFunc(date_set_milliseconds));
    obj.insert(String::from("toISOString"), JsValue::NativeFunc(date_to_iso_string));
    obj.insert(String::from("toJSON"), JsValue::NativeFunc(date_to_json));
    obj.insert(String::from("toString"), JsValue::NativeFunc(date_to_string));
    obj.insert(String::from("toDateString"), JsValue::NativeFunc(date_to_date_string));
    obj.insert(String::from("toTimeString"), JsValue::NativeFunc(date_to_time_string));
    obj.insert(String::from("toLocaleString"), JsValue::NativeFunc(date_to_locale_string));
    obj.insert(String::from("valueOf"), JsValue::NativeFunc(date_value_of));
    JsValue::Object(Rc::new(RefCell::new(obj)))
}
