...
pub fn align_cross_axis(parent: &mut LayoutBox, is_row: bool) {
    ...
    for child in &mut parent.children {
        ...
        let offset = match align {
            ...
            AlignItems::Stretch => {
                if is_row { child.dimensions.content.height = cross_size - child.dimensions.total_vertical(); }
                else { child.dimensions.content.width = cross_size - child.dimensions.total_horizontal(); }
                0.0
            }
