...
impl CanvasTransform {
    ...
    pub fn translate(&mut self, tx: f64, ty: f64) { self.e += tx; self.f += ty; }

    pub fn scale(&mut self, sx: f64, sy: f64) { self.a *= sx; self.d *= sy; }
    ...
    pub fn reset(&mut self) { *self = Self::identity(); }
