...
pub fn get_reserves(client: &mut EthRpcClient, contract: &LpContract) -> RpcResult<(u128, u128, u64)> {
    ...
    if result.len() < 96 { return Ok((0, 0, 0)); }
...
pub fn get_lp_balance(client: &mut EthRpcClient, contract: &LpContract, account: &[u8; 20]) -> RpcResult<u128> {
...
pub fn get_pending_rewards_amount(client: &mut EthRpcClient, contract: &LpContract, account: &[u8; 20]) -> RpcResult<u128> {
