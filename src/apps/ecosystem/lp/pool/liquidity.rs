...
pub fn calculate_liquidity_tokens(token0_amount: u128, token1_amount: u128,
    reserve0: u128, reserve1: u128, total_supply: u128) -> LiquidityQuote {
    if total_supply == 0 {
        ...
        return LiquidityQuote { token0_amount, token1_amount, lp_tokens_minted: lp_tokens, share_of_pool: 100.0 };
    }
    ...
    LiquidityQuote { token0_amount, token1_amount, lp_tokens_minted: lp_tokens, share_of_pool: share }
}

pub fn calculate_remove_liquidity(lp_tokens: u128, reserve0: u128, reserve1: u128, total_supply: u128) -> (u128, u128) {
