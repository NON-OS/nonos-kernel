...
// Boot-trace markers for the virtio-gpu driver capsule. The smoke
// harness greps for the leading `[gfx.virtio_gpu0]` prefix; the rest
// of the line is descriptive and may evolve as bring-up gains
// detail. Output goes through the MkDebug channel so the trace
// survives without a serial console.

use nonos_libc::mk_debug;

const PREFIX: &[u8] = b"[gfx.virtio_gpu0] ";
const NEWLINE: &[u8] = b"\n";
