...
// Ship a fully-built ethernet frame down to L2. DHCP composes a
// broadcast Eth+IPv4+UDP+BOOTP frame in `frame::compose` and ships
// it verbatim — the L2 capsule does no further header work.
