...
//! Bring-up markers for the xHCI capsule. The boot smoke harness
//! greps for these exact strings; emitting them through the
//! NØNOS-native MkDebug channel keeps the diagnostics auditable
//! and removes any dependency on a POSIX `write` shim.
