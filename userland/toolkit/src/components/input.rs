...
pub fn render_input(
	buf: &mut [u32], stride: usize, w: u32, h: u32, x: u32, y: u32, rw: u32, rh: u32, text: &[u8], caret_col: usize, style: InputStyle,
) {
	...
	fill_rect(buf, stride, w, h, cx, y.saturating_add(3), 1, rh.saturating_sub(6), style.caret.as_u32());
}
