...
pub use queue::{
    QUEUE_SIZE, Q_RX, Q_TX, RX_BUFFER_LEN, RX_DESC_COUNT, TX_BUFFER_LEN, VQ_AVAIL_OFFSET,
...
pub use regs::{
    ...
    LEG_QUEUE_NUM, LEG_QUEUE_PFN, LEG_QUEUE_SEL, LEG_STATUS, VIRTIO_NET_F_MAC, VIRTIO_NET_F_STATUS,
